...
$prefix = 'meningitis-b';
$vaccine_name = bp_field('vaccine_name', 'Meningitis B');
?>
    ...
    <div class="meningitis-b-hero-grid">
      ...
      <div class="meningitis-b-hero-content">
        ...
        <h1 class="meningitis-b-hero-title">
          <span class="gradient-text"><?php echo esc_html(bp_field('vaccine_hero_title_highlight', 'Meningitis B Vaccination')); ?></span>
        ...
        <div class="meningitis-b-hero-actions">
          <a href="#booking-widget" onclick="scrollToBooking(); return false;" class="cta-button primary-cta">
            <?php echo esc_html(bp_field('vaccine_cta_text', 'Book Meningitis B Vaccination')); ?>
      ...
      <div class="meningitis-b-hero-visual">
        <div class="meningitis-b-hero-float-badge">
          <span class="meningitis-b-hero-float-number"><?php echo esc_html(bp_field('vaccine_float_number', '1')); ?></span>
          <span class="meningitis-b-hero-float-label"><?php echo esc_html(bp_field('vaccine_float_label', 'single dose')); ?></span>
        </div>
...
<section class="meningitis-b-protect-section">
  <div class="section-container">
    <div class="meningitis-b-protect-header">
      ...
      <h2 class="meningitis-b-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'The Meningitis B Vaccine')); ?></h2>
      <p class="meningitis-b-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'Protection against a rare but very serious infection')); ?></p>
    </div>
    ...
    <div class="meningitis-b-protect-grid">
      <div class="meningitis-b-protect-image-wrapper">
        <div class="meningitis-b-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'Pharmacist giving a meningitis B vaccination in Wythenshawe')); ?>" class="meningitis-b-protect-image" />
          <?php endif; ?>
      ...
      <div class="meningitis-b-protect-content">
        <div class="meningitis-b-protect-badge-box">
          ...
          <span><?php echo esc_html(bp_field('vaccine_protect_highlight', 'Acts Fast — So Should You')); ?></span>
        </div>

        <h3 class="meningitis-b-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'Bexsero — Cover Against MenB')); ?></h3>
        <p class="meningitis-b-protect-text"><?php echo esc_html(bp_field('vaccine_protect_text', 'Meningitis B is a bacterial infection that can cause meningitis and blood poisoning (septicaemia). It can develop within hours and be life-threatening, and survivors can be left with lasting effects. The Bexsero vaccine protects against meningococcal group B, the most common cause of bacterial meningitis in the UK.')); ?></p>
...
<section class="meningitis-b-about-section">
  <div class="section-container">
    <div class="meningitis-b-about-header">
      ...
      <h2 class="meningitis-b-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'What is Meningitis B?')); ?></h2>
      <p class="meningitis-b-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'A serious infection that can move quickly')); ?></p>
    </div>
    ...
    <div class="meningitis-b-about-content-grid">
      <div class="meningitis-b-about-image-wrapper">
        <div class="meningitis-b-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Baby — meningitis B is most common in young children')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="meningitis-b-about-callout">
      ...
      <h3><?php echo esc_html(bp_field('vaccine_callout_title', 'A Rash That Doesn\'t Fade')); ?></h3>
...
<section class="meningitis-b-needs-section">
  <div class="section-container">
    <div class="meningitis-b-needs-header">
      ...
      <h2 class="meningitis-b-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="meningitis-b-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Recommended across all ages, with two peaks of risk')); ?></p>
    </div>
...
<section class="meningitis-b-details-section">
  <div class="section-container">
    <div class="meningitis-b-details-header">
      ...
      <h2 class="meningitis-b-details-title"><?php echo esc_html(bp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="meningitis-b-details-desc"><?php echo esc_html(bp_field('vaccine_details_desc', 'A simple, friendly visit to our Wythenshawe clinic')); ?></p>
    </div>
...
<section class="meningitis-b-faq-section">
  <div class="section-container">
    <div class="meningitis-b-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(bp_field('vaccine_faq_badge', 'MENINGITIS B FAQs')); ?></span>
      </div>
      <h2 class="meningitis-b-faq-title"><?php echo esc_html(bp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<!-- ============================================
     ...
     Location:       calendarID=8436365       (Bowland Pharmacy) — Bowland uses 8436365
     Override per-page via the ACF field 'vaccine_acuity_url'. -->
<?php
$acuity_url = bp_field( 'vaccine_acuity_url', 'https://app.acuityscheduling.com/schedule.php?owner=29286426&appointmentType=47536578&calendarID=8436365&ref=embedded_csp' );
?>
<section class="meningitis-b-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="meningitis-b-booking-header">
      <h2 class="meningitis-b-booking-title"><?php echo esc_html(bp_field('vaccine_booking_title', 'Book Your Meningitis B Vaccination')); ?></h2>
      <p class="meningitis-b-booking-desc"><?php echo esc_html(bp_field('vaccine_booking_desc', 'Choose a time that suits you at our Wythenshawe clinic')); ?></p>
    </div>

    <div class="meningitis-b-booking-embed">
      <?php if ( $acuity_url ) : ?>
        <iframe src="<?php echo esc_url( $acuity_url ); ?>" title="Book your Meningitis B vaccination appointment in Wythenshawe" width="100%" height="800" frameborder="0" allow="payment"></iframe>
...
<section class="meningitis-b-cta-section">
  ...
  <div class="section-container">
    <div class="meningitis-b-cta-content">
      ...
      <h2 class="meningitis-b-cta-title"><?php echo esc_html(bp_field('vaccine_cta_title', 'Protect against meningitis B')); ?></h2>
      <p class="meningitis-b-cta-desc"><?php echo esc_html(bp_field('vaccine_cta_desc', 'Book your meningitis B vaccination with our friendly team in Wythenshawe today. Quick, convenient and professional.')); ?></p>
