        ...
        <div class="chickenpox-trust-card">
          ...
          <div class="chickenpox-trust-card-inner">
            ...
            <div class="chickenpox-trust-card-price">
              ...
              <span class="chickenpox-trust-card-sub"><?php echo esc_html(bp_field('vaccine_price_unit', 'per dose')); ?></span>
            </div>
...
<section class="chickenpox-pricing-section" id="pricing">
  <div class="section-container">
    <div class="chickenpox-pricing-header">
      ...
      <p class="chickenpox-pricing-desc"><?php echo esc_html(bp_field('vaccine_pricing_desc', 'One simple price per dose — no hidden extras')); ?></p>
    </div>
    ...
    <p class="chickenpox-pricing-note"><?php echo esc_html(bp_field('vaccine_price_note', 'Price shown is per dose. A full course is two doses, given 4 to 8 weeks apart. Please ask our team if you have any questions about suitability.')); ?></p>
  </div>
</section>
