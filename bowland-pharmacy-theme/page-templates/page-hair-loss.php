    ...
    <div class="hairloss-hero-grid">
      ...
      <div class="hairloss-hero-content">
        ...
        <p class="hairloss-hero-description">
          <?php echo esc_html( bp_field( 'hl_hero_description', 'Clinically proven treatments including Finasteride and Minoxidil. Face-to-face consultations with our GPhC-registered pharmacist in Wythenshawe.' ) ); ?>
        </p>
      ...
      <div class="hairloss-hero-visual">
        <div class="hairloss-hero-image-card">
          ...
          if ( $hero_image_url ) : ?>
            <img src="<?php echo esc_url( $hero_image_url ); ?>" alt="<?php echo esc_attr( bp_field( 'hl_hero_image_alt', 'Hair loss treatment at Bowland Pharmacy' ) ); ?>" class="hairloss-hero-image" />
...
<section class="hairloss-treatments-section">
  <div class="section-container">
    <div class="hairloss-treatments-header">
      ...
      <p class="hairloss-treatments-desc"><?php echo esc_html( bp_field( 'hl_treatments_description', 'Clinically proven treatments prescribed and monitored by our GPhC-registered pharmacist at Bowland Pharmacy.' ) ); ?></p>
    </div>
...
<section class="hairloss-team-section">
  <div class="section-container">
    <div class="hairloss-team-header">
      ...
      <h2 class="hairloss-team-title"><?php echo esc_html( bp_field( 'hl_team_title', 'Meet Your Wythenshawe Hair Loss Experts' ) ); ?></h2>
      <p class="hairloss-team-description"><?php echo esc_html( bp_field( 'hl_team_description', 'Our experienced pharmacists provide personalised hair loss consultations with discretion and care. Get expert advice and ongoing support at your local Wythenshawe pharmacy.' ) ); ?></p>
    </div>
      ...
      <?php endwhile; else : ?>
        ...
        <div class="hairloss-team-card">
          <div class="hairloss-team-content">
            ...
            <p class="hairloss-team-bio">As the founder of Bowland Pharmacy, Ahmed brings over 15 years of pharmaceutical experience. He provides confidential hair loss consultations, ensuring every patient receives a personalised treatment plan.</p>
            <div class="hairloss-team-tags">
        ...
        <div class="hairloss-team-card">
          <div class="hairloss-team-content">
            ...
            <p class="hairloss-team-bio">Jignasa combines clinical expertise with compassionate patient care, supporting hair loss treatment plans and ongoing monitoring for patients at our Wythenshawe clinic.</p>
            <div class="hairloss-team-tags">
...
<section class="hairloss-process-section">
  <div class="section-container">
    ...
    <div class="hairloss-process-grid">
      ...
      <?php endwhile; else : ?>
        <div class="hairloss-process-card">
          ...
          <p>Call or book online for a private consultation at our Wythenshawe pharmacy</p>
    ...
    <div class="hairloss-process-cta">
      <a href="<?php echo esc_url( bp_field( 'hl_hero_cta_url', '' ) ?: bp_booking_url() ); ?>" class="cta-button primary-cta">Start Your Journey</a>
    </div>
  </div>
</section>
      ...
      <?php endwhile; else : ?>
        ...
        <div class="hairloss-faq-item">
          <button class="hairloss-faq-btn" onclick="toggleFAQ(this)">
            ...
            <span class="text">Why choose Bowland Pharmacy over online providers?</span>
            <span class="icon"><i class="fas fa-plus"></i></span>
          </button>
...
<section class="hairloss-testimonials-section">
  <div class="section-container">
    <div class="hairloss-testimonials-header">
      ...
      <h2 class="hairloss-testimonials-title"><?php echo esc_html( bp_field( 'hl_testimonials_title', 'Hear From Our Wythenshawe Patients' ) ); ?></h2>
    </div>
    ...
    <div class="hairloss-testimonials-grid">
      ...
      <?php endwhile; else : ?>
        <div class="hairloss-testimonial-card">
          ...
          <p class="hairloss-testimonial-quote">After just 4 months of treatment from Bowland Pharmacy, I can already see new hair growth. Ahmed explained everything clearly and made the whole process easy.</p>
          <div class="hairloss-testimonial-author"><span class="hairloss-testimonial-name">James T.</span></div>
        </div>
        <div class="hairloss-testimonial-card">
          <div class="hairloss-testimonial-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
          <p class="hairloss-testimonial-quote">I was nervous about discussing hair loss but the team at Bowland Pharmacy made it completely comfortable. The consultation was thorough and private.</p>
...
<section class="hairloss-cta-section">
  <div class="section-container">
    <div class="hairloss-cta-content">
      ...
      <p class="hairloss-cta-desc"><?php echo esc_html( bp_field( 'hl_cta_description', 'Book a confidential consultation with our GPhC-registered pharmacist in Wythenshawe' ) ); ?></p>
