    ...
    <div class="thailand-hero-grid">
      ...
      <div class="thailand-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( bp_field( 'td_hero_badge', 'THAILAND TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( bp_field( 'td_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( bp_field( 'td_hero_title_highlight', 'Thailand' ) ); ?></span>
        </h1>
        ...
        <div class="thailand-hero-actions">
          <a href="<?php echo esc_url( bp_field( 'td_hero_cta_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta thailand-hero-btn-primary">
            <?php echo esc_html( bp_field( 'td_hero_cta_text', 'Book Thailand Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta thailand-hero-btn-secondary">
...
<section class="thailand-vaccines-section">
  <div class="section-container">
    <div class="thailand-vaccines-header">
      <h2 class="thailand-vaccines-title"><?php echo esc_html( bp_field( 'td_vaccines_title', 'Protect yourself in Thailand' ) ); ?></h2>
      <div class="thailand-vaccines-divider"></div>
      <p class="thailand-vaccines-description"><?php echo esc_html( bp_field( 'td_vaccines_description', 'These vaccinations are recommended for most travellers to Thailand' ) ); ?></p>
    </div>
    ...
    <div class="thailand-malaria-layout">
      ...
      <div class="thailand-malaria-visual">
        <div class="thailand-malaria-image-card">
          ...
          <div class="thailand-malaria-badge">
            ...
            <span class="thailand-malaria-badge-text"><?php echo esc_html( bp_field( 'td_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="thailand-malaria-content">
        <div class="section-badge">
          <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          <span class="section-badge-text"><?php echo esc_html( bp_field( 'td_malaria_badge', 'MOSQUITO-BORNE DISEASES' ) ); ?></span>
        </div>

        <h2 class="thailand-malaria-title"><?php echo esc_html( bp_field( 'td_malaria_title', 'Malaria & Dengue Risks in Thailand' ) ); ?></h2>
        <p class="thailand-malaria-intro">
          <?php echo esc_html( bp_field( 'td_malaria_intro', 'While malaria risk is low in most tourist areas, Dengue fever is common nationwide. Our pharmacists will check your specific itinerary and advise on prevention.' ) ); ?>
        </p>
...
<section class="thailand-health-section">
  <div class="section-container">
    <div class="thailand-health-header">
      ...
      <h2 class="thailand-health-title"><?php echo esc_html( bp_field( 'td_health_title', 'Stay healthy in Thailand' ) ); ?></h2>
      <p class="thailand-health-subtitle"><?php echo esc_html( bp_field( 'td_health_subtitle', 'Essential tips for a safe tropical adventure' ) ); ?></p>
    </div>
  ...
  <div class="section-container">
    <div class="thailand-cta-content">
      ...
      <p class="thailand-cta-description">
        <?php echo esc_html( bp_field( 'td_cta_description', 'Book your Thailand travel health consultation at our ' . bp_option( 'pharmacy_town', 'Wythenshawe' ) . ' clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
      <div class="thailand-cta-actions">
        <a href="<?php echo esc_url( bp_field( 'td_cta_primary_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta thailand-cta-button-white">
          <?php echo esc_html( bp_field( 'td_cta_primary_text', 'Book Thailand Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta thailand-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( bp_phone() ); ?>
        </a>
      </div>
      <div class="thailand-cta-checks">
        ...
        <div class="thailand-cta-check">
          ...
          <span><?php echo esc_html( bp_field( 'td_cta_check_2', 'Expert Thailand Advice' ) ); ?></span>
        </div>
        <div class="thailand-cta-check">
