    ...
    <div class="earwax-hero-grid">
      ...
      <div class="earwax-hero-content">
        <div class="section-badge">
          ...
          <span class="section-badge-text"><?php echo esc_html( bp_field( 'ew_hero_badge', 'SAME-DAY MICROSUCTION AVAILABLE' ) ); ?></span>
        </div>
        ...
        <div class="earwax-hero-actions">
          <a href="<?php echo esc_url( bp_field( 'ew_hero_cta_url', '' ) ?: bp_booking_url() ); ?>" class="cta-button primary-cta">
            <?php echo esc_html( bp_field( 'ew_hero_cta_text', 'Book Your Appointment' ) ); ?>
      ...
      <div class="earwax-hero-visual">
        <?php
        $hero_image_id  = bp_field( 'ew_hero_image' );
        ...
        <div class="earwax-hero-image-card">
          ...
          <div class="earwax-hero-price-badge">
            <span class="earwax-hero-price-label"><?php echo esc_html( bp_field( 'ew_price_label', 'Both Ears' ) ); ?></span>
            <span class="earwax-hero-price-amount"><?php echo esc_html( bp_field( 'ew_price_amount', '£60' ) ); ?></span>
            <span class="earwax-hero-price-sub"><?php echo esc_html( bp_field( 'ew_price_sub', 'consultation included' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      ?>
        ...
        <div class="earwax-stat-item">
          ...
          <div class="earwax-stat-content">
            <p class="earwax-stat-number"><?php echo esc_html( bp_field( $stat['number'], $stat['def_number'] ) ); ?></p>
            <p class="earwax-stat-label"><?php echo esc_html( bp_field( $stat['label'], $stat['def_label'] ) ); ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section class="earwax-symptoms-section earwax-reveal">
  <div class="section-container">
    <div class="earwax-symptoms-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'ew_symptoms_badge', 'COMMON SYMPTOMS' ) ); ?></span>
      </div>
      <h2 class="earwax-symptoms-title"><?php echo esc_html( bp_field( 'ew_symptoms_title', 'Is Ear Wax Affecting Your Daily Life?' ) ); ?></h2>
      <p class="earwax-symptoms-description"><?php echo esc_html( bp_field( 'ew_symptoms_description', 'Don\'t let blocked ears hold you back. Recognise these common symptoms?' ) ); ?></p>
    </div>
    ...
    <div class="earwax-symptoms-grid">
      <?php if ( have_rows( 'ew_symptoms' ) ) : while ( have_rows( 'ew_symptoms' ) ) : the_row(); ?>
        <div class="earwax-symptom-card">
          <div class="earwax-symptom-icon"><i class="<?php echo esc_attr( bp_fa_class( get_sub_field( 'icon' ) ) ); ?>"></i></div>
  ...
  <div class="section-container">
    ...
    <div class="earwax-team-grid">
      ...
      <?php endwhile; else :
        ...
        $global_pharmacist_image_id  = bp_option( 'pharmacist_image' );
...
<section class="earwax-process-section earwax-reveal">
  <div class="section-container">
    <div class="earwax-process-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'ew_process_badge', 'HOW IT WORKS' ) ); ?></span>
      </div>
      <h2 class="earwax-process-title"><?php echo esc_html( bp_field( 'ew_process_title', 'Our Professional Ear Wax Removal Process' ) ); ?></h2>
      <p class="earwax-process-description"><?php echo esc_html( bp_field( 'ew_process_description', 'Simple, effective treatment in three easy steps' ) ); ?></p>
    </div>
...
<section class="earwax-pricing-section earwax-reveal">
  <div class="section-container">
    <div class="earwax-pricing-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'ew_pricing_badge', 'TRANSPARENT PRICING' ) ); ?></span>
      </div>
      <h2 class="earwax-pricing-title"><?php echo esc_html( bp_field( 'ew_pricing_title', 'Simple, Transparent Pricing' ) ); ?></h2>
      <p class="earwax-pricing-description"><?php echo esc_html( bp_field( 'ew_pricing_description', 'No hidden fees. No surprises. Just clear, professional ear care.' ) ); ?></p>
    </div>
    ...
    <div class="earwax-pricing-grid">
      <?php if ( have_rows( 'ew_pricing' ) ) : while ( have_rows( 'ew_pricing' ) ) : the_row(); ?>
        ...
        <div class="earwax-pricing-card <?php echo $is_featured ? 'earwax-pricing-card-featured' : ''; ?>">
          ...
          <?php endif; ?>
          <a href="<?php echo esc_url( bp_field( 'ew_hero_cta_url', '' ) ?: bp_booking_url() ); ?>" class="cta-button <?php echo $is_featured ? 'primary-cta' : 'secondary-cta'; ?> earwax-pricing-btn">
      ...
      <?php endwhile; else : ?>
        ...
        <div class="earwax-pricing-card earwax-pricing-card-featured">
          ...
          <a href="<?php echo esc_url( bp_booking_url() ); ?>" class="cta-button primary-cta earwax-pricing-btn">Book Treatment</a>
        </div>
        <!-- Default: Single Ear -->
        <div class="earwax-pricing-card">
          ...
          <a href="<?php echo esc_url( bp_booking_url() ); ?>" class="cta-button secondary-cta earwax-pricing-btn">Book Treatment</a>
        </div>
      <?php endif; ?>
    </div>
  </div>
    ...
    <div class="earwax-cta-content">
      <div class="earwax-cta-badges">
        <div class="earwax-cta-badge">
          <span><?php echo esc_html( bp_field( 'ew_cta_badge_1', '£60 both ears' ) ); ?></span>
        </div>
        <div class="earwax-cta-badge">
          <span><?php echo esc_html( bp_field( 'ew_cta_badge_2', 'Same-day available' ) ); ?></span>
        </div>
        <?php $cta_badge_3 = bp_field( 'ew_cta_badge_3', '' ); if ( $cta_badge_3 ) : ?>
        <div class="earwax-cta-badge">
      ...
      <div class="earwax-cta-actions">
        <a href="<?php echo esc_url( bp_field( 'ew_cta_primary_url', '' ) ?: bp_booking_url() ); ?>" class="cta-button primary-cta earwax-cta-button-white">
          <?php echo esc_html( bp_field( 'ew_cta_button_text', 'Book Appointment Online' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta earwax-cta-button-outline">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( bp_phone() ); ?>
        </a>
      </div>
