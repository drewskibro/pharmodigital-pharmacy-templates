    ...
    <div class="earwax-hero-grid">
      ...
      <div class="earwax-hero-content">
        ...
        <div class="earwax-hero-actions">
          <a href="<?php echo esc_url( bp_field( 'ew_hero_cta_url', '' ) ?: '#ear-wax-calendar' ); ?>" class="cta-button primary-cta">
    ...
    <div class="earwax-pricing-grid">
      <?php if ( have_rows( 'ew_pricing' ) ) : while ( have_rows( 'ew_pricing' ) ) : the_row(); ?>
        ...
        <div class="earwax-pricing-card <?php echo $is_featured ? 'earwax-pricing-card-featured' : ''; ?>">
          ...
          <?php endif; ?>
          <a href="<?php echo esc_url( bp_field( 'ew_hero_cta_url', '' ) ?: '#ear-wax-calendar' ); ?>" class="cta-button <?php echo $is_featured ? 'primary-cta' : 'secondary-cta'; ?> earwax-pricing-btn">
  ...
  <div class="section-container">
    <div class="earwax-cta-content">
      ...
      <div class="earwax-cta-actions">
        <a href="<?php echo esc_url( bp_field( 'ew_cta_primary_url', '' ) ?: '#ear-wax-calendar' ); ?>" class="cta-button primary-cta earwax-cta-button-white">
