...
$prefix = 'mmr';
$vaccine_name = bp_field('vaccine_name', 'MMR');
?>
    ...
    <div class="mmr-hero-grid">
      ...
      <div class="mmr-hero-content">
        ...
        <h1 class="mmr-hero-title">
          <span class="gradient-text"><?php echo esc_html(bp_field('vaccine_hero_title_highlight', 'MMR Vaccination')); ?></span>
          <?php echo esc_html(bp_field('vaccine_hero_title_rest', 'in Wythenshawe, Manchester')); ?>
        </h1>

        <p class="mmr-hero-description">
          <?php echo esc_html(bp_field('vaccine_hero_description', 'Protect against measles, mumps and rubella with our private vaccination service in Wythenshawe, Manchester. One combined vaccine, given as a two-dose course, for children and for adults whose vaccination history is incomplete or uncertain.')); ?>
        </p>

        <div class="mmr-hero-actions">
          <a href="#booking-widget" onclick="scrollToBooking(); return false;" class="cta-button primary-cta">
            <?php echo esc_html(bp_field('vaccine_cta_text', 'Book MMR Vaccination')); ?>
      ...
      <div class="mmr-hero-visual">
        <div class="mmr-hero-float-badge">
          <span class="mmr-hero-float-number"><?php echo esc_html(bp_field('vaccine_float_number', '3')); ?></span>
          <span class="mmr-hero-float-label"><?php echo esc_html(bp_field('vaccine_float_label', 'in 1 vaccine')); ?></span>
        </div>
        <div class="mmr-trust-card">
          ...
          <div class="mmr-trust-card-inner">
            <div class="mmr-trust-card-header">
              ...
              <span class="mmr-trust-card-label"><?php echo esc_html(bp_field('vaccine_price_name', 'MMR Vaccine')); ?></span>
            </div>
            <div class="mmr-trust-card-price">
              <span class="mmr-trust-card-amount"><?php echo esc_html(bp_field('vaccine_price_amount', '£50')); ?></span>
              <span class="mmr-trust-card-sub"><?php echo esc_html(bp_field('vaccine_price_unit', 'full 2-dose course')); ?></span>
            </div>
...
<section class="mmr-protect-section">
  <div class="section-container">
    <div class="mmr-protect-header">
      ...
      <h2 class="mmr-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'The MMR Vaccine')); ?></h2>
      <p class="mmr-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'Three serious diseases, prevented in one combined jab')); ?></p>
    </div>
    ...
    <div class="mmr-protect-grid">
      <div class="mmr-protect-image-wrapper">
        <div class="mmr-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'Pharmacist preparing an MMR vaccination in Wythenshawe')); ?>" class="mmr-protect-image" />
          <?php endif; ?>
      ...
      <div class="mmr-protect-content">
        <div class="mmr-protect-badge-box">
          ...
          <span><?php echo esc_html(bp_field('vaccine_protect_highlight', 'Three Diseases, One Vaccine')); ?></span>
        </div>

        <h3 class="mmr-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'Safe, Long-Lasting Protection')); ?></h3>
        <p class="mmr-protect-text"><?php echo esc_html(bp_field('vaccine_protect_text', 'MMR is a combined vaccine that protects against measles, mumps and rubella — three viral infections that can cause serious complications. Measles is highly contagious and can lead to pneumonia or encephalitis, mumps can cause meningitis, and rubella is dangerous in pregnancy. Two doses give long-lasting protection and help prevent outbreaks.')); ?></p>
...
<section class="mmr-about-section">
  <div class="section-container">
    <div class="mmr-about-header">
      ...
      <h2 class="mmr-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'What does MMR protect against?')); ?></h2>
      <p class="mmr-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'Three viral infections that can be serious')); ?></p>
    </div>
    ...
    <div class="mmr-about-content-grid">
      <div class="mmr-about-image-wrapper">
        <div class="mmr-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Parent and child — MMR protects children and families')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="mmr-about-callout">
      ...
      <h3><?php echo esc_html(bp_field('vaccine_callout_title', 'Not Sure If You\'re Covered?')); ?></h3>
      <p><?php echo esc_html(bp_field('vaccine_callout_text', 'Many adults are unsure whether they had both MMR doses as a child. There is no harm in having it again, so if your records are incomplete or uncertain, a catch-up course is a simple way to make sure you are protected.')); ?></p>
    </div>
  </div>
</section>
...
<section class="mmr-needs-section">
  <div class="section-container">
    <div class="mmr-needs-header">
      ...
      <h2 class="mmr-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="mmr-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Recommended for children and for adults who missed out')); ?></p>
    </div>
...
<section class="mmr-pricing-section" id="pricing">
  <div class="section-container">
    <div class="mmr-pricing-header">
      ...
      <h2 class="mmr-pricing-title"><?php echo esc_html(bp_field('vaccine_pricing_title', 'MMR Vaccination Pricing')); ?></h2>
      <p class="mmr-pricing-desc"><?php echo esc_html(bp_field('vaccine_pricing_desc', 'Pay per dose, or save with the full course')); ?></p>
    </div>

    <div class="mmr-pricing-grid">
      <div class="mmr-pricing-card featured">
        <div class="mmr-pricing-ribbon">Best Value</div>
        <h3 class="mmr-pricing-name"><?php echo esc_html(bp_field('vaccine_price_name', 'Full MMR Course')); ?></h3>
        <div class="mmr-pricing-amount">
          <span class="price"><?php echo esc_html(bp_field('vaccine_price_amount', '£50')); ?></span>
          <span class="per"><?php echo esc_html(bp_field('vaccine_price_unit', 'full 2-dose course')); ?></span>
        </div>
    ...
    <p class="mmr-pricing-note"><?php echo esc_html(bp_field('vaccine_price_note', 'A single dose is £25, or £50 for the full two-dose course. For adults the second dose is given at least 4 weeks after the first.')); ?></p>
  </div>
</section>
...
<section class="mmr-details-section">
  <div class="section-container">
    <div class="mmr-details-header">
      ...
      <h2 class="mmr-details-title"><?php echo esc_html(bp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="mmr-details-desc"><?php echo esc_html(bp_field('vaccine_details_desc', 'A simple, friendly visit to our Wythenshawe clinic')); ?></p>
    </div>
...
<section class="mmr-faq-section">
  <div class="section-container">
    <div class="mmr-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(bp_field('vaccine_faq_badge', 'MMR FAQs')); ?></span>
      </div>
      <h2 class="mmr-faq-title"><?php echo esc_html(bp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<!-- ============================================
     ...
     ============================================
     owner=29286426 · appointmentType=47536574 (MMR) · calendarID=8436365 (Wythenshawe; Bowland 8436365)
     Override per-page via ACF field 'vaccine_acuity_url'. -->
<?php
$acuity_url = bp_field( 'vaccine_acuity_url', 'https://app.acuityscheduling.com/schedule.php?owner=29286426&appointmentType=47536574&calendarID=8436365&ref=embedded_csp' );
?>
<section class="mmr-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="mmr-booking-header">
      <h2 class="mmr-booking-title"><?php echo esc_html(bp_field('vaccine_booking_title', 'Book Your MMR Vaccination')); ?></h2>
      <p class="mmr-booking-desc"><?php echo esc_html(bp_field('vaccine_booking_desc', 'Choose a time that suits you at our Wythenshawe clinic')); ?></p>
    </div>

    <div class="mmr-booking-embed">
      <?php if ( $acuity_url ) : ?>
        <iframe src="<?php echo esc_url( $acuity_url ); ?>" title="Book your MMR vaccination appointment in Wythenshawe" width="100%" height="800" frameborder="0" allow="payment"></iframe>
...
<section class="mmr-cta-section">
  ...
  <div class="section-container">
    <div class="mmr-cta-content">
      ...
      <h2 class="mmr-cta-title"><?php echo esc_html(bp_field('vaccine_cta_title', 'Stay protected against measles, mumps & rubella')); ?></h2>
      <p class="mmr-cta-desc"><?php echo esc_html(bp_field('vaccine_cta_desc', 'Book your MMR vaccination with our friendly team in Wythenshawe today. Quick, convenient and professional.')); ?></p>
