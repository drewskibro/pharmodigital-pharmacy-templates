  ...
  <div class="section-container">
    <div class="healthhub-hero-content">
      <div class="section-badge">
        ...
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'hh_badge_text', 'HEALTH HUB' ) ); ?></span>
      </div>
        ...
        ?>
          <div class="healthhub-cta-card">
            <div class="healthhub-cta-card-inner">
              ...
              <h3 class="healthhub-cta-card-title"><?php echo esc_html( bp_field( 'hh_grid_cta_title', 'Ready to Book Your Consultation?' ) ); ?></h3>
              <p class="healthhub-cta-card-text"><?php echo esc_html( bp_field( 'hh_grid_cta_text', 'Same-day appointments available · No GP referral needed' ) ); ?></p>
              <a href="<?php echo esc_url( bp_field( 'hh_grid_cta_url', bp_booking_url() ) ); ?>" class="healthhub-cta-card-button">
                <?php echo esc_html( bp_field( 'hh_grid_cta_button', 'Check Availability' ) ); ?>
