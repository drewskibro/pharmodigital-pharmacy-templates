    ...
    <div class="india-hero-grid">
      ...
      <div class="india-hero-content">
        ...
        <p class="india-hero-description">
          <?php echo esc_html( bp_field( 'in_hero_description', 'Expert advice and vaccinations for your India journey. Get protected before you travel with ' . bp_pharmacy_name() . '\'s trusted travel health specialists.' ) ); ?>
        </p>
    ...
    <div class="india-malaria-layout">
      ...
      <div class="india-malaria-content">
        ...
        <div class="india-malaria-actions">
          <a href="<?php echo esc_url( bp_field( 'in_malaria_cta_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta">
            <?php echo esc_html( bp_field( 'in_malaria_cta_text', 'Check Your Risk' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
      </div>
