    ...
    <div class="india-hero-grid">
      ...
      <div class="india-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( bp_field( 'in_hero_badge', 'INDIA TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( bp_field( 'in_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( bp_field( 'in_hero_title_highlight', 'India' ) ); ?></span>
        </h1>

        <p class="india-hero-description">
          <?php echo esc_html( bp_field( 'in_hero_description', 'Expert advice and vaccinations for your India journey. Get protected before you travel with Wythenshawe\'s trusted travel health specialists.' ) ); ?>
        </p>

        <div class="india-hero-actions">
          <a href="<?php echo esc_url( bp_field( 'in_hero_cta_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta india-hero-btn-primary">
            <?php echo esc_html( bp_field( 'in_hero_cta_text', 'Book India Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta india-hero-btn-secondary">
...
<section class="india-vaccines-section">
  <div class="section-container">
    <div class="india-vaccines-header">
      <h2 class="india-vaccines-title"><?php echo esc_html( bp_field( 'in_vaccines_title', 'Protect yourself in India' ) ); ?></h2>
      <div class="india-vaccines-divider"></div>
      <p class="india-vaccines-description"><?php echo esc_html( bp_field( 'in_vaccines_description', 'These vaccinations are recommended for most travellers to India' ) ); ?></p>
    </div>
    ...
    <div class="india-malaria-layout">
      ...
      <div class="india-malaria-visual">
        <div class="india-malaria-image-card">
          <?php
          $malaria_image_id = bp_field( 'in_malaria_image' );
          ...
          <div class="india-malaria-badge">
            ...
            <span class="india-malaria-badge-text"><?php echo esc_html( bp_field( 'in_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="india-malaria-content">
        <div class="section-badge">
          <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          <span class="section-badge-text"><?php echo esc_html( bp_field( 'in_malaria_badge', 'MOSQUITO-BORNE DISEASES' ) ); ?></span>
        </div>

        <h2 class="india-malaria-title"><?php echo esc_html( bp_field( 'in_malaria_title', 'Malaria & Dengue Risks in India' ) ); ?></h2>
        <p class="india-malaria-intro">
          <?php echo esc_html( bp_field( 'in_malaria_intro', 'Malaria risk varies across India. Dengue fever is also a significant risk nationwide. Our pharmacists will check your specific itinerary and advise on prevention.' ) ); ?>
        </p>
        ...
        <div class="india-malaria-actions">
          <a href="<?php echo esc_url( bp_field( 'in_hero_cta_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta">
            Check Your Risk
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
...
<section class="india-health-section">
  <div class="section-container">
    <div class="india-health-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'in_health_badge', 'HEALTH ADVICE' ) ); ?></span>
      </div>
      <h2 class="india-health-title"><?php echo esc_html( bp_field( 'in_health_title', 'Stay healthy in India' ) ); ?></h2>
      <p class="india-health-subtitle"><?php echo esc_html( bp_field( 'in_health_subtitle', 'Essential tips for a safe journey' ) ); ?></p>
    </div>
  ...
  <div class="section-container">
    <div class="india-cta-content">
      ...
      <p class="india-cta-description">
        <?php echo esc_html( bp_field( 'in_cta_description', 'Book your India travel health consultation at our Wythenshawe clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
      <div class="india-cta-actions">
        <a href="<?php echo esc_url( bp_field( 'in_cta_primary_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta india-cta-button-white">
          <?php echo esc_html( bp_field( 'in_cta_primary_text', 'Book India Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta india-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( bp_phone() ); ?>
        </a>
      </div>
      <div class="india-cta-checks">
        <div class="india-cta-check">
          ...
          <span><?php echo esc_html( bp_field( 'in_cta_check_1', 'Travel Ready' ) ); ?></span>
        </div>
        <div class="india-cta-check">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( bp_field( 'in_cta_check_2', 'Expert India Advice' ) ); ?></span>
        </div>
        <div class="india-cta-check">
          <i class="fas fa-shield-virus"></i>
          <span><?php echo esc_html( bp_field( 'in_cta_check_3', 'All Vaccines Available' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
