    ...
    <div class="kenya-hero-grid">
      ...
      <div class="kenya-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( bp_field( 'ke_hero_badge', 'KENYA TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( bp_field( 'ke_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( bp_field( 'ke_hero_title_highlight', 'Kenya' ) ); ?></span>
        </h1>
        ...
        <div class="kenya-hero-actions">
          <a href="<?php echo esc_url( bp_field( 'ke_hero_cta_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta kenya-hero-btn-primary">
            <?php echo esc_html( bp_field( 'ke_hero_cta_text', 'Book Kenya Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta kenya-hero-btn-secondary">
...
<section class="kenya-vaccines-section">
  <div class="section-container">
    <div class="kenya-vaccines-header">
      <h2 class="kenya-vaccines-title"><?php echo esc_html( bp_field( 'ke_vaccines_title', 'Protect yourself in Kenya' ) ); ?></h2>
      <div class="kenya-vaccines-divider"></div>
      <p class="kenya-vaccines-description"><?php echo esc_html( bp_field( 'ke_vaccines_description', 'These vaccinations are recommended for most travellers to Kenya' ) ); ?></p>
    </div>
    ...
    <div class="kenya-malaria-layout">
      ...
      <div class="kenya-malaria-visual">
        <div class="kenya-malaria-image-card">
          ...
          <div class="kenya-malaria-badge">
            ...
            <span class="kenya-malaria-badge-text"><?php echo esc_html( bp_field( 'ke_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="kenya-malaria-content">
        <div class="section-badge">
          <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          <span class="section-badge-text"><?php echo esc_html( bp_field( 'ke_malaria_badge', 'HIGH RISK AREA' ) ); ?></span>
        </div>

        <h2 class="kenya-malaria-title"><?php echo esc_html( bp_field( 'ke_malaria_title', 'Malaria Risk in Kenya' ) ); ?></h2>
        <p class="kenya-malaria-intro">
          <?php echo esc_html( bp_field( 'ke_malaria_intro', 'Malaria risk is high throughout most of Kenya, including safari parks. Antimalarials are usually recommended.' ) ); ?>
        </p>
...
<section class="kenya-health-section">
  <div class="section-container">
    <div class="kenya-health-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( bp_field( 'ke_health_badge', 'HEALTH ADVICE' ) ); ?></span>
      </div>
      <h2 class="kenya-health-title"><?php echo esc_html( bp_field( 'ke_health_title', 'Stay healthy in Kenya' ) ); ?></h2>
      <p class="kenya-health-subtitle"><?php echo esc_html( bp_field( 'ke_health_subtitle', 'Essential tips for a safe safari' ) ); ?></p>
    </div>
    ...
    <div class="kenya-cta-content">
      ...
      <div class="kenya-cta-actions">
        <a href="<?php echo esc_url( bp_field( 'ke_cta_primary_url', bp_booking_url() ) ); ?>" class="cta-button primary-cta kenya-cta-button-white">
          <?php echo esc_html( bp_field( 'ke_cta_primary_text', 'Book Kenya Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( bp_phone_link() ); ?>" class="cta-button secondary-cta kenya-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( bp_phone() ); ?>
        </a>
      </div>
      <div class="kenya-cta-checks">
        <div class="kenya-cta-check">
          ...
          <span><?php echo esc_html( bp_field( 'ke_cta_check_1', 'Travel Ready' ) ); ?></span>
        </div>
        <div class="kenya-cta-check">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( bp_field( 'ke_cta_check_2', 'Expert Advice' ) ); ?></span>
        </div>
        <div class="kenya-cta-check">
          <i class="fas fa-shield-virus"></i>
          <span><?php echo esc_html( bp_field( 'ke_cta_check_3', 'All Vaccines' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
