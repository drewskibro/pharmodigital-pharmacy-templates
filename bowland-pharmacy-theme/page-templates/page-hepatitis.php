...
<section class="hepatitis-protect-section">
  <div class="section-container">
    <div class="hepatitis-protect-header">
      ...
      <h2 class="hepatitis-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'Understanding Your Options')); ?></h2>
      <p class="hepatitis-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'Flexible vaccination schedules to suit your travel plans')); ?></p>
    </div>
    ...
    <div class="hepatitis-protect-grid">
      <div class="hepatitis-protect-image-wrapper">
        <div class="hepatitis-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'Pharmacist explaining vaccination options')); ?>" class="hepatitis-protect-image" />
          <?php endif; ?>
          <div class="hepatitis-protect-name-tag">
            <span class="name"><?php echo esc_html(bp_field('vaccine_protect_nametag_name', 'Ahmed Al-Liabi')); ?></span>
      ...
      <div class="hepatitis-protect-content">
        <div class="hepatitis-protect-badge-box">
          ...
          <span><?php echo esc_html(bp_field('vaccine_protect_highlight', 'Combined Protection Available')); ?></span>
        </div>

        <h3 class="hepatitis-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'Separate or Combined Vaccinations')); ?></h3>
        <p class="hepatitis-protect-text"><?php echo esc_html(bp_field('vaccine_protect_text', 'Hepatitis A and B are viral infections that affect the liver. Depending on your destination and risk factors, you may need protection against one or both. We offer individual vaccines as well as a combined option (Twinrix) for convenience.')); ?></p>
...
<section class="hepatitis-about-section">
  <div class="section-container">
    <div class="hepatitis-about-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(bp_field('vaccine_about_badge', 'KNOW THE DIFFERENCE')); ?></span>
      </div>
      <h2 class="hepatitis-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'Hepatitis A vs Hepatitis B')); ?></h2>
      <p class="hepatitis-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'Understanding the risks and transmission methods')); ?></p>
    </div>
    ...
    <div class="hepatitis-about-content-grid">
      <div class="hepatitis-about-image-wrapper">
        <div class="hepatitis-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Travel food safety')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="hepatitis-about-callout">
      <div class="badge"><?php echo esc_html(bp_field('vaccine_callout_badge', 'CRITICAL INSIGHT')); ?></div>
      <h3><?php echo esc_html(bp_field('vaccine_callout_title', 'Hepatitis B is Highly Infectious')); ?></h3>
      <p><?php echo esc_html(bp_field('vaccine_callout_text', 'Hepatitis B is 50-100 times more infectious than HIV. It can survive outside the body for at least 7 days. Vaccination provides the most reliable defence against this silent but serious virus.')); ?></p>
    </div>
  </div>
</section>
...
<section class="hepatitis-needs-section">
  <div class="section-container">
    <div class="hepatitis-needs-header">
      ...
      <h2 class="hepatitis-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="hepatitis-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Recommended for many travellers and at-risk groups')); ?></p>
    </div>
...
<section class="hepatitis-risk-section">
  <div class="section-container">
    <div class="hepatitis-risk-header">
      ...
      <h2 class="hepatitis-risk-title"><?php echo esc_html(bp_field('vaccine_risk_title', 'Where are Hepatitis A & B found?')); ?></h2>
      <p class="hepatitis-risk-desc"><?php echo esc_html(bp_field('vaccine_risk_desc', 'Risk varies by region, but vaccination is often recommended for travel outside Western Europe, North America, and Australia.')); ?></p>
    </div>
...
<section class="hepatitis-faq-section">
  <div class="section-container">
    <div class="hepatitis-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(bp_field('vaccine_faq_badge', 'HEPATITIS FAQs')); ?></span>
      </div>
      <h2 class="hepatitis-faq-title"><?php echo esc_html(bp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
