  ...
  <div class="section-container">
    <div class="vietnam-cta-content">
      ...
      <p class="vietnam-cta-description">
        <?php echo esc_html( bp_field( 'td_cta_description', 'Book your Vietnam travel health consultation at our Wythenshawe clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
