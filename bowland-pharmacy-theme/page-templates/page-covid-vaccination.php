 ...
 * (ACF-overridable via bp_field where simple) so it renders without seeding.
...
$hero_badge        = bp_field( 'covid_hero_badge', 'NHS & PRIVATE COVID VACCINATION' );
$hero_title_accent = bp_field( 'covid_hero_title_accent', 'COVID Vaccination' );
$hero_title_rest   = bp_field( 'covid_hero_title_rest', 'when you need it' );
$hero_description  = bp_field( 'covid_hero_description', 'NHS COVID-19 vaccinations for eligible patients in line with the latest NHS guidance, plus private vaccinations available by appointment or walk-in.' );
...
<section id="covid-calendar" class="bpack-booking-section">
  <div class="section-container">
    <div class="bpack-booking-header">
      ...
      <p class="bpack-booking-subtitle">Choose a time below for your COVID jab at <?php echo esc_html( bp_pharmacy_name() ); ?>. Both the free NHS vaccination, if you are eligible, and the private one can be booked right here.</p>
    <p class="bpack-booking-subtitle">Prefer to book your NHS vaccination through the NHS? <a href="https://www.nhs.uk/nbs/start/covid" target="_blank" rel="noopener">Check your eligibility and book on the NHS website</a>. When it asks where you want your vaccination, enter <strong>M23 1JX</strong> and choose Bowland Pharmacy. Already booked with the NHS? <a href="https://www.nhs.uk/nbs/start/covid/manage-booking" target="_blank" rel="noopener">Change or cancel that appointment</a>.</p>
    </div>
    <div class="booking-calendar-wrapper">
      <iframe
        src="https://app.acuityscheduling.com/schedule.php?owner=29286426&amp;calendarID=8436365&amp;appointmentType[]=83760516&amp;appointmentType[]=60972562&amp;ref=embedded_csp"
