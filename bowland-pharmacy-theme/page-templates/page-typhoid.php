...
<section class="typhoid-protect-section">
  <div class="section-container">
    <div class="typhoid-protect-header">
      ...
      <h2 class="typhoid-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'Safe & Effective Typhoid Prevention')); ?></h2>
      <p class="typhoid-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'Choose the vaccination method that suits you best')); ?></p>
    </div>
    ...
    <div class="typhoid-protect-grid">
      <div class="typhoid-protect-image-wrapper">
        <div class="typhoid-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'Travel health consultation')); ?>" class="typhoid-protect-image" />
          <?php endif; ?>
          <div class="typhoid-protect-name-tag">
            <span class="name"><?php echo esc_html(bp_field('vaccine_protect_nametag_name', 'Expert Advice')); ?></span>
      ...
      <div class="typhoid-protect-content">
        ...
        <h3 class="typhoid-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'Two Ways to Protect Yourself')); ?></h3>
        <p class="typhoid-protect-text"><?php echo esc_html(bp_field('vaccine_protect_text', 'Typhoid fever is a serious bacterial infection spread through contaminated food and water. We offer both the single-dose injection and the oral capsule course, giving you flexibility in how you get protected.')); ?></p>
...
<section class="typhoid-about-section">
  <div class="section-container">
    <div class="typhoid-about-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(bp_field('vaccine_about_badge', 'ABOUT THE DISEASE')); ?></span>
      </div>
      <h2 class="typhoid-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'What is Typhoid Fever?')); ?></h2>
      <p class="typhoid-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'A bacterial infection that can be serious if not treated')); ?></p>
    </div>
    ...
    <div class="typhoid-about-content-grid">
      <div class="typhoid-about-image-wrapper">
        <div class="typhoid-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Street food market in Asia')); ?>" />
          <?php endif; ?>
        </div>
      </div>
...
<section class="typhoid-needs-section">
  <div class="section-container">
    <div class="typhoid-needs-header">
      ...
      <h2 class="typhoid-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="typhoid-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Vaccination is recommended for travellers visiting high-risk areas')); ?></p>
    </div>
...
<section class="typhoid-risk-section">
  <div class="section-container">
    <div class="typhoid-risk-header">
      ...
      <h2 class="typhoid-risk-title"><?php echo esc_html(bp_field('vaccine_risk_title', 'Where is Typhoid found?')); ?></h2>
      <p class="typhoid-risk-desc"><?php echo esc_html(bp_field('vaccine_risk_desc', 'Typhoid is found worldwide but is most common in areas with poor sanitation and hygiene.')); ?></p>
    </div>
