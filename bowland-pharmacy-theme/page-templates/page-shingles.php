    ...
    <div class="shingles-hero-grid">
      ...
      <div class="shingles-hero-content">
        ...
        <p class="shingles-hero-description">
          <?php echo esc_html(bp_field('vaccine_hero_description', 'Protect yourself against shingles with our private vaccination service in Wythenshawe, Manchester. A single-dose vaccination, recommended for adults from the age of 50, that reduces the risk of shingles and the painful nerve problems it can cause.')); ?>
        </p>
      ...
      <div class="shingles-hero-visual">
        <div class="shingles-hero-float-badge">
          <span class="shingles-hero-float-number"><?php echo esc_html(bp_field('vaccine_float_number', '1')); ?></span>
          <span class="shingles-hero-float-label"><?php echo esc_html(bp_field('vaccine_float_label', 'single dose')); ?></span>
        </div>
        <div class="shingles-trust-card">
          ...
          <div class="shingles-trust-card-inner">
            ...
            <div class="shingles-trust-card-price">
              ...
              <span class="shingles-trust-card-sub"><?php echo esc_html(bp_field('vaccine_price_unit', 'single dose')); ?></span>
            </div>
  ...
  <div class="section-container">
    ...
    <div class="shingles-protect-grid">
      ...
      <div class="shingles-protect-content">
        ...
        <h3 class="shingles-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'A Single Dose Against Shingles')); ?></h3>
        <p class="shingles-protect-text"><?php echo esc_html(bp_field('vaccine_protect_text', 'Shingles (herpes zoster) is caused by the same virus as chickenpox. It stays dormant in the nervous system and can reactivate years later as immunity weakens — causing a painful, blistering rash on one side of the body, often with lasting nerve pain (postherpetic neuralgia). A single-dose vaccination reduces the risk of shingles and the chance of long-term nerve pain.')); ?></p>
...
<section class="shingles-pricing-section" id="pricing">
  <div class="section-container">
    ...
    <p class="shingles-pricing-note"><?php echo esc_html(bp_field('vaccine_price_note', 'Price is £199 for a single dose. Protection lasts several years and boosters are not currently needed. Please ask our team if you have any questions about suitability.')); ?></p>
  </div>
</section>
