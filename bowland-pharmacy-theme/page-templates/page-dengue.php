    ...
    <div class="dengue-hero-grid">
      ...
      <div class="dengue-hero-content">
        ...
        <p class="dengue-hero-description">
          <?php echo esc_html(bp_field('vaccine_hero_description', "Protect yourself before travelling with our dengue fever vaccination service in Wythenshawe, Manchester. A course covering all four dengue serotypes, recommended for trips to Southeast Asia, the Caribbean, Central and South America, and parts of Africa.")); ?>
        </p>
...
<section class="dengue-protect-section">
  <div class="section-container">
    <div class="dengue-protect-header">
      ...
      <h2 class="dengue-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'The Dengue Fever Vaccine')); ?></h2>
      <p class="dengue-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'A course covering all four dengue serotypes for travellers to higher-risk regions')); ?></p>
    </div>
    ...
    <div class="dengue-protect-grid">
      <div class="dengue-protect-image-wrapper">
        <div class="dengue-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'The dengue fever vaccine is given as an injection')); ?>" class="dengue-protect-image" />
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="dengue-protect-content">
        ...
        <h3 class="dengue-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'Longer-Term Protection for Frequent or Extended Travel')); ?></h3>
...
<section class="dengue-about-section">
  <div class="section-container">
    <div class="dengue-about-header">
      ...
      <h2 class="dengue-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'What is Dengue Fever?')); ?></h2>
      <p class="dengue-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'A mosquito-borne infection common across many tropical travel destinations')); ?></p>
    </div>
    ...
    <div class="dengue-about-content-grid">
      <div class="dengue-about-image-wrapper">
        <div class="dengue-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Mosquito on skin — dengue spreads through mosquito bites')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="dengue-about-callout">
      ...
      <h3><?php echo esc_html(bp_field('vaccine_callout_title', 'Higher-Risk Groups')); ?></h3>
      <p><?php echo esc_html(bp_field('vaccine_callout_text', "Dengue can be more serious for children, older travellers, people who are immunocompromised, and anyone who has had dengue before — vaccination and mosquito bite avoidance both matter for these groups.")); ?></p>
    </div>
  </div>
</section>
...
<section class="dengue-needs-section">
  <div class="section-container">
    <div class="dengue-needs-header">
      ...
      <h2 class="dengue-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Do you need this vaccine?')); ?></h2>
      <p class="dengue-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Recommended for travellers heading to dengue-affected regions')); ?></p>
    </div>
...
<section class="dengue-pricing-section" id="pricing">
  <div class="section-container">
    <div class="dengue-pricing-header">
      ...
      <h2 class="dengue-pricing-title"><?php echo esc_html(bp_field('vaccine_pricing_title', 'Dengue Fever Vaccination Pricing')); ?></h2>
      <p class="dengue-pricing-desc"><?php echo esc_html(bp_field('vaccine_pricing_desc', 'Priced per dose — we will confirm your full course cost at your first appointment')); ?></p>
    </div>
    ...
    <p class="dengue-pricing-note"><?php echo esc_html(bp_field('vaccine_price_note', 'Price shown is per dose. Qdenga is given as a course — we will confirm your full schedule and total cost at your first appointment. Not recommended during pregnancy.')); ?></p>
  </div>
</section>
...
<section class="dengue-details-section">
  <div class="section-container">
    <div class="dengue-details-header">
      ...
      <h2 class="dengue-details-title"><?php echo esc_html(bp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="dengue-details-desc"><?php echo esc_html(bp_field('vaccine_details_desc', 'A simple, friendly visit to our Bowland clinic')); ?></p>
    </div>
...
<section class="dengue-cta-section">
  ...
  <div class="section-container">
    <div class="dengue-cta-content">
      ...
      <h2 class="dengue-cta-title"><?php echo esc_html(bp_field('vaccine_cta_title', 'Protect yourself before you travel')); ?></h2>
      <p class="dengue-cta-desc"><?php echo esc_html(bp_field('vaccine_cta_desc', 'Book your dengue fever vaccination with our friendly team in Bowland today. Quick, convenient and professional.')); ?></p>
