 ...
 * via bp_field where simple) so it renders without seeding. Reuses the bpack-*
...
$hero_badge        = bp_field( 'flu_hero_badge', 'NHS FLU VACCINATION' );
$hero_title_accent = bp_field( 'flu_hero_title_accent', 'Flu Vaccination' );
$hero_title_rest   = bp_field( 'flu_hero_title_rest', 'this winter' );
$hero_description  = bp_field( 'flu_hero_description', 'Protect yourself and those around you this winter. Free NHS flu jabs for eligible patients, with private vaccinations also available — by appointment or walk-in.' );
...
<section id="flu-calendar" class="bpack-booking-section">
  <div class="section-container">
    <div class="bpack-booking-header">
      ...
      <p class="bpack-booking-subtitle">Choose a time below for your flu jab at <?php echo esc_html( bp_pharmacy_name() ); ?>.</p>
    </div>
    <div class="booking-calendar-wrapper">
      <iframe
        src="https://app.acuityscheduling.com/schedule.php?owner=29286426&amp;calendarID=8436365&amp;appointmentType[]=60972607&amp;appointmentType[]=60972591&amp;ref=embedded_csp"
