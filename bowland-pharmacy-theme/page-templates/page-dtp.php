    ...
    <div class="dtp-hero-grid">
      ...
      <div class="dtp-hero-content">
        ...
        <p class="dtp-hero-description">
          <?php echo esc_html(bp_field('vaccine_hero_description', "Top up your Diphtheria, Tetanus and Polio protection before travelling with our DTP booster service in Wythenshawe, Manchester. A single combined injection recommended if it's been more than 10 years since your last dose.")); ?>
        </p>
...
<section class="dtp-protect-section">
  <div class="section-container">
    <div class="dtp-protect-header">
      ...
      <h2 class="dtp-protect-title"><?php echo esc_html(bp_field('vaccine_protect_title', 'The DTP Vaccine')); ?></h2>
      <p class="dtp-protect-desc"><?php echo esc_html(bp_field('vaccine_protect_desc', 'One combined booster covering diphtheria, tetanus and polio')); ?></p>
    </div>
    ...
    <div class="dtp-protect-grid">
      <div class="dtp-protect-image-wrapper">
        <div class="dtp-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_protect_image_alt', 'The DTP booster is given as a single injection')); ?>" class="dtp-protect-image" />
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="dtp-protect-content">
        ...
        <h3 class="dtp-protect-subtitle"><?php echo esc_html(bp_field('vaccine_protect_subtitle', 'A Quick Top-Up Before You Travel')); ?></h3>
...
<section class="dtp-about-section">
  <div class="section-container">
    <div class="dtp-about-header">
      ...
      <h2 class="dtp-about-title"><?php echo esc_html(bp_field('vaccine_about_title', 'What Do DTP Vaccines Protect Against?')); ?></h2>
      <p class="dtp-about-desc"><?php echo esc_html(bp_field('vaccine_about_desc', 'Three serious diseases, all covered by one combined vaccine')); ?></p>
    </div>
    ...
    <div class="dtp-about-content-grid">
      <div class="dtp-about-image-wrapper">
        <div class="dtp-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(bp_field('vaccine_about_image_alt', 'Close-up of a syringe used for the combined DTP booster')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="dtp-about-callout">
      ...
      <h3><?php echo esc_html(bp_field('vaccine_callout_title', 'Immunity Fades Over Time')); ?></h3>
      <p><?php echo esc_html(bp_field('vaccine_callout_text', "Childhood DTP vaccination doesn't last forever — protection gradually wanes, which is why a booster is recommended roughly every 10 years, especially before travel to higher-risk regions.")); ?></p>
    </div>
  </div>
</section>
...
<section class="dtp-needs-section">
  <div class="section-container">
    <div class="dtp-needs-header">
      ...
      <h2 class="dtp-needs-title"><?php echo esc_html(bp_field('vaccine_needs_title', 'Do you need a booster?')); ?></h2>
      <p class="dtp-needs-desc"><?php echo esc_html(bp_field('vaccine_needs_desc', 'Recommended if your last DTP dose was over 10 years ago')); ?></p>
    </div>
...
<section class="dtp-pricing-section" id="pricing">
  <div class="section-container">
    <div class="dtp-pricing-header">
      ...
      <h2 class="dtp-pricing-title"><?php echo esc_html(bp_field('vaccine_pricing_title', 'DTP Vaccination Pricing')); ?></h2>
      <p class="dtp-pricing-desc"><?php echo esc_html(bp_field('vaccine_pricing_desc', 'One simple price for the single booster — no hidden extras')); ?></p>
    </div>
    ...
    <p class="dtp-pricing-note"><?php echo esc_html(bp_field('vaccine_price_note', 'Some patients may be eligible for this booster free on the NHS — ask our team and we\'ll check for you before booking privately.')); ?></p>
  </div>
</section>
...
<section class="dtp-details-section">
  <div class="section-container">
    <div class="dtp-details-header">
      ...
      <h2 class="dtp-details-title"><?php echo esc_html(bp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="dtp-details-desc"><?php echo esc_html(bp_field('vaccine_details_desc', 'A quick, friendly visit to our Bowland clinic')); ?></p>
    </div>
...
<section class="dtp-cta-section">
  ...
  <div class="section-container">
    <div class="dtp-cta-content">
      ...
      <h2 class="dtp-cta-title"><?php echo esc_html(bp_field('vaccine_cta_title', 'Top up your protection before you travel')); ?></h2>
      <p class="dtp-cta-desc"><?php echo esc_html(bp_field('vaccine_cta_desc', 'Book your DTP vaccination with our friendly team in Bowland today. Quick, convenient and professional.')); ?></p>
