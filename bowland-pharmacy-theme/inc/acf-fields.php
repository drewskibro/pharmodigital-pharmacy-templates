 ...
 *
 * Registers all Advanced Custom Fields field groups for the Bowland Pharmacy
 * WordPress theme, including options page fields, home page fields,
 * blog post fields, and the flexible content page builder.
 *
 * Field names match EXACTLY what the template-parts expect via bp_field().
 *
 * @package BowlandPharmacy
 */
 ...
 */
function bp_register_acf_field_groups() {
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_branding',
        'title'    => 'Pharmacy Branding',
        'fields'   => array(
            array(
                'key'           => 'field_bp_brand_name',
                'label'         => 'Pharmacy Name',
                'name'          => 'pharmacy_name',
                'type'          => 'text',
                'default_value' => 'Bowland Pharmacy',
            ),
            array(
                'key'           => 'field_bp_brand_logo',
                'label'         => 'Pharmacy Logo',
                'name'          => 'pharmacy_logo',
                'type'          => 'image',
                'return_format' => 'id',
            ...
            array(
                'key'           => 'field_bp_brand_trust_bar_item_2',
            ...
            array(
                'key'           => 'field_bp_brand_google_rating',
                'label'         => 'Google Rating',
                'name'          => 'google_rating',
                'type'          => 'number',
                'default_value' => 4.9,
            ...
            array(
                'key'           => 'field_bp_brand_google_review_count',
            ...
            array(
                'key'          => 'field_bp_brand_google_review_url',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_contact',
        'title'    => 'Contact Details',
        'fields'   => array(
            array(
                'key'           => 'field_bp_contact_phone',
                'label'         => 'Pharmacy Phone',
                'name'          => 'pharmacy_phone',
                'type'          => 'text',
                'default_value' => '0161 998 7114',
            ),
            array(
                'key'           => 'field_bp_contact_email',
                'label'         => 'Pharmacy Email',
                'name'          => 'pharmacy_email',
                'type'          => 'email',
                'default_value' => 'info@bowlandpharmacy.co.uk',
            ),
            array(
                'key'           => 'field_bp_contact_address_line_1',
                'label'         => 'Address Line 1',
                'name'          => 'pharmacy_address_line_1',
                'type'          => 'text',
                'default_value' => '52 Bowland Road',
            ),
            array(
                'key'           => 'field_bp_contact_address_line_2',
                'label'         => 'Address Line 2',
                'name'          => 'pharmacy_address_line_2',
                'type'          => 'text',
                'default_value' => 'Wythenshawe, Manchester',
            ),
            array(
                'key'           => 'field_bp_contact_address_line_3',
                'label'         => 'Postcode',
                'name'          => 'pharmacy_address_line_3',
                'type'          => 'text',
                'default_value' => 'M23 1JX',
            ),
            array(
                'key'           => 'field_bp_contact_town',
            ...
            array(
                'key'           => 'field_bp_contact_patients_treated',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_compliance',
        'title'    => 'Registration & Compliance',
        'fields'   => array(
            array(
                'key'           => 'field_bp_compliance_gphc',
            ...
            array(
                'key'           => 'field_bp_compliance_superintendent',
            ...
            array(
                'key'           => 'field_bp_compliance_superintendent_gphc',
            ...
            array(
                'key'   => 'field_bp_compliance_gphc_verify_url',
                'label' => 'GPhC Verify URL',
                'name'  => 'gphc_verify_url',
                'type'  => 'url',
            ),
            array(
                'key'           => 'field_bp_compliance_reviewer_profile_url',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array(
                'key'   => 'field_bp_social_facebook',
                'label' => 'Facebook URL',
                'name'  => 'social_facebook',
                'type'  => 'url',
            ),
            array(
                'key'   => 'field_bp_social_instagram',
                'label' => 'Instagram URL',
                'name'  => 'social_instagram',
                'type'  => 'url',
            ),
            array(
                'key'   => 'field_bp_social_twitter',
                'label' => 'Twitter URL',
                'name'  => 'social_twitter',
                'type'  => 'url',
            ),
            array(
                'key'   => 'field_bp_social_linkedin',
                'label' => 'LinkedIn URL',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_booking',
        'title'    => 'Booking Settings',
        'fields'   => array(
            array(
                'key'           => 'field_bp_booking_page',
                'label'         => 'Booking Page',
                'name'          => 'booking_page',
                'type'          => 'post_object',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'      => 'group_bp_nav_items',
        'title'    => 'Navigation Menu Items',
        'fields'   => array(
            // ── Home ──
            array(
                'key'           => 'field_bp_nav_home_show',
                'label'         => 'Show Home',
                'name'          => 'nav_home_show',
                'type'          => 'true_false',
                'default_value' => 1,
            ...
            array(
                'key'           => 'field_bp_nav_home_label',
                'label'         => 'Home Label',
                'name'          => 'nav_home_label',
                'type'          => 'text',
                'default_value' => 'Home',
                'conditional_logic' => array( array( array( 'field' => 'field_bp_nav_home_show', 'operator' => '==', 'value' => '1' ) ) ),
            ),
            array(
                'key'          => 'field_bp_nav_home_url',
                'label'        => 'Home Page',
                'name'         => 'nav_home_url',
                'type'         => 'page_link',
                'post_type'    => array( 'page' ),
            ...
            array(
                'key'           => 'field_bp_nav_wl_label',
                'label'         => 'Weight Loss Label',
                'name'          => 'nav_weight_loss_label',
                'type'          => 'text',
                'default_value' => 'Weight Loss',
                'conditional_logic' => array( array( array( 'field' => 'field_bp_nav_wl_show', 'operator' => '==', 'value' => '1' ) ) ),
            ),
            array(
                'key'        => 'field_bp_nav_wl_url',
            ...
            array(
                'key'           => 'field_bp_nav_th_label',
                'label'         => 'Travel Health Label',
                'name'          => 'nav_travel_health_label',
                'type'          => 'text',
                'default_value' => 'Travel',
                'conditional_logic' => array( array( array( 'field' => 'field_bp_nav_th_show', 'operator' => '==', 'value' => '1' ) ) ),
            ),
            array(
                'key'        => 'field_bp_nav_th_url',
            ...
            array(
                'key'           => 'field_bp_nav_sv_label',
                'label'         => 'Services Label',
                'name'          => 'nav_services_label',
                'type'          => 'text',
                'default_value' => 'Services',
                'conditional_logic' => array( array( array( 'field' => 'field_bp_nav_sv_show', 'operator' => '==', 'value' => '1' ) ) ),
            ),
            array(
                'key'        => 'field_bp_nav_sv_url',
                'label'      => 'Services Page',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_nav_dd_wl_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_nav_dd_wl_desc',  'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_nav_dd_wl_icon',  'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'e.g. fas fa-syringe', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_nav_dd_wl_url',   'label' => 'Page', 'name' => 'url', 'type' => 'page_link', 'post_type' => array( 'page' ), 'allow_null' => 1, 'wrapper' => array( 'width' => '25' ) ),
                ),
            ),
            // ── Travel Services Dropdown ──
            array(
                'key'          => 'field_bp_nav_dd_th_services',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_nav_dd_th_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_nav_dd_th_desc',  'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_nav_dd_th_icon',  'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'e.g. fas fa-shield-virus', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_nav_dd_th_url',   'label' => 'Page', 'name' => 'url', 'type' => 'page_link', 'post_type' => array( 'page' ), 'allow_null' => 1, 'wrapper' => array( 'width' => '25' ) ),
                ),
            ),
            // ── Travel Destinations ──
            array(
                'key'          => 'field_bp_nav_dd_th_dests',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_nav_dd_th_dest_name', 'label' => 'Country', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_nav_dd_th_dest_flag', 'label' => 'Flag URL', 'name' => 'flag_url', 'type' => 'url', 'instructions' => 'e.g. https://flagcdn.com/w40/th.png', 'wrapper' => array( 'width' => '40' ) ),
                    array( 'key' => 'field_bp_nav_dd_th_dest_url',  'label' => 'Page', 'name' => 'url', 'type' => 'page_link', 'post_type' => array( 'page' ), 'allow_null' => 1, 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
            // ── Services Dropdown ──
            array(
                'key'          => 'field_bp_nav_dd_sv_links',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_nav_dd_sv_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_nav_dd_sv_desc',  'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_nav_dd_sv_icon',  'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'e.g. fas fa-stethoscope', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_nav_dd_sv_url',   'label' => 'Page', 'name' => 'url', 'type' => 'page_link', 'post_type' => array( 'page' ), 'allow_null' => 1, 'wrapper' => array( 'width' => '25' ) ),
                ),
            ),
        ),
        'location' => array(
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_options_clinical_team',
        'title'    => 'Clinical Team',
        'fields'   => array(
            array(
                'key'          => 'field_bp_pharmacy_team_members',
                'label'        => 'Team Members',
                ...
                'sub_fields'   => array(
                    ...
                    array(
                        ...
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_pt_tag_label', 'label' => 'Tag', 'name' => 'tag_label', 'type' => 'text', 'required' => 1 ),
                        ),
                    ),
                ),
            ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_hero',
        'title'    => 'Home — Hero Section',
        'fields'   => array(
            array(
                'key'           => 'field_bp_hero_badge_text',
            ...
            array(
                'key'           => 'field_bp_hero_testimonial_quote',
            ...
            array(
                'key'           => 'field_bp_hero_testimonial_author',
            ...
            array(
                'key'           => 'field_bp_hero_testimonial_result',
            ...
            array(
                'key'           => 'field_bp_hero_caption_title',
            ...
            // --- Google Rating Card ---
            array(
                'key'           => 'field_bp_hero_rating_label',
            ...
            array(
                'key'           => 'field_bp_hero_rating_stars',
                'label'         => 'Rating Stars',
            ...
            array(
                'key'           => 'field_bp_hero_rating_count_label',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_stats',
        'title'    => 'Home — Stats Bar',
        'fields'   => array(
            // Stat 1
            array(
                'key'           => 'field_bp_stats_1_icon',
                'label'         => 'Stat 1 Icon',
                'name'          => 'stats_1_icon',
                'type'          => 'text',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                'key'           => 'field_bp_nhs_bottom_description',
            ...
            array(
                'key'           => 'field_bp_nhs_bottom_cta_text',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_treatments',
        'title'    => 'Home — Treatments',
        'fields'   => array(
            array(
                'key'           => 'field_bp_treatments_badge_text',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_treatments_description',
                'label'         => 'Description',
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'   => 'field_bp_treatment_title',
                        'label' => 'Treatment Title',
                        'name'  => 'treatment_title',
                        'type'  => 'text',
                    ),
                    array(
                        'key'          => 'field_bp_treatment_subtitle',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_pharmacist',
        'title'    => 'Home — Pharmacist',
        'fields'   => array(
            array(
                'key'           => 'field_bp_pharmacist_section_title',
                'label'         => 'Section Title',
            ...
            array(
                'key'           => 'field_bp_pharmacist_section_subtitle',
            ...
            array(
                'key'           => 'field_bp_pharmacist_eyebrow_text',
                'label'         => 'Eyebrow Text',
            ...
            array(
                'key'           => 'field_bp_pharmacist_badge_text',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_pharmacist_experience_label',
            ...
            array(
                'key'           => 'field_bp_pharmacist_cta_text',
            ...
            array(
                'key'          => 'field_bp_pharmacist_cta_url',
            ...
            array(
                'key'          => 'field_bp_pharmacist_video_url',
                'label'        => 'Video URL',
            ...
            array(
                'key'           => 'field_bp_pharmacist_video_label',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_hiw',
        'title'    => 'Home — How It Works',
        'fields'   => array(
            array(
                'key'           => 'field_bp_hiw_badge_text',
                'label'         => 'Badge Text',
                'name'          => 'hiw_badge_text',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_hiw_description',
                'label'         => 'Description',
                'name'          => 'hiw_description',
                'type'          => 'textarea',
                'rows'          => 3,
                'default_value' => 'Getting started with Bowland Pharmacy is simple. From consultation to delivery, we\'ve made healthcare accessible.',
            ),
            array(
                'key'           => 'field_bp_hiw_cta_text',
                'label'         => 'CTA Button Text',
                'name'          => 'hiw_cta_text',
                'type'          => 'text',
            ...
            array(
                ...
                'sub_fields'   => array(
                    ...
                    array(
                        'key'   => 'field_bp_hiw_step_title',
                        'label' => 'Step Title',
                        'name'  => 'step_title',
                        'type'  => 'text',
                    ),
                    array(
                        'key'   => 'field_bp_hiw_step_description',
                    ...
                    array(
                        'key'           => 'field_bp_hiw_step_time_icon',
                        'label'         => 'Time Icon',
                        'name'          => 'step_time_icon',
                        'type'          => 'text',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_switching',
        'title'    => 'Home — Switching Provider',
        'fields'   => array(
            array(
                'key'           => 'field_bp_switching_badge_text',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_switching_description',
                'label'         => 'Description',
                'name'          => 'switching_description',
                'type'          => 'textarea',
                'rows'          => 3,
                'default_value' => 'Tired of waiting weeks for prescriptions? Fed up with impersonal online-only services? At Bowland Pharmacy, you get real pharmacist support, same-day prescriptions, and premium discreet delivery — all from a trusted local pharmacy.',
            ),
            array(
                'key'           => 'field_bp_switching_cta_text',
                'label'         => 'CTA Button Text',
            ...
            // Feature 1
            array(
                'key'           => 'field_bp_switching_f1_icon',
            ...
            array(
                'key'           => 'field_bp_switching_f1_title',
            ...
            array(
                'key'           => 'field_bp_switching_f1_desc',
            ...
            // Feature 2
            array(
                'key'           => 'field_bp_switching_f2_icon',
            ...
            array(
                'key'           => 'field_bp_switching_f2_title',
            ...
            array(
                'key'           => 'field_bp_switching_f2_desc',
            ...
            // Feature 3
            array(
                'key'           => 'field_bp_switching_f3_icon',
            ...
            array(
                'key'           => 'field_bp_switching_f3_title',
            ...
            array(
                'key'           => 'field_bp_switching_f3_desc',
            ...
            // Trust Stat 1
            array(
                'key'           => 'field_bp_switching_t1_icon',
            ...
            array(
                'key'           => 'field_bp_switching_t1_value',
            ...
            array(
                'key'           => 'field_bp_switching_t1_label',
            ...
            // Trust Stat 2
            array(
                'key'           => 'field_bp_switching_t2_icon',
            ...
            array(
                'key'           => 'field_bp_switching_t2_value',
            ...
            // Trust Stat 3
            array(
                'key'           => 'field_bp_switching_t3_icon',
            ...
            array(
                'key'           => 'field_bp_switching_t3_value',
            ...
            array(
                'key'           => 'field_bp_switching_t3_label',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_revslider',
        'title'    => 'Home — Travel Banner',
        'fields'   => array(
            array(
                'key'           => 'field_bp_revslider_alias',
            ...
            array(
                'key'           => 'field_bp_revslider_placeholder_image',
            ...
            array(
                'key'           => 'field_bp_revslider_placeholder_badge',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_revslider_placeholder_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_revslider_placeholder_subtitle',
                'label'         => 'Subtitle',
                'name'          => 'revslider_placeholder_subtitle',
                'type'          => 'textarea',
                'rows'          => 2,
                'default_value' => 'From yellow fever to malaria prevention, get expert travel vaccinations at Bowland Pharmacy',
            ),
            array(
                'key'           => 'field_bp_revslider_placeholder_cta_text',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_home_safe',
        'title'    => 'Home — Safe & Secure',
        'fields'   => array(
            array(
                'key'           => 'field_bp_safe_badge_text',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_safe_title_highlight',
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_safe_feature_icon',
                        'label'         => 'Icon',
                        'name'          => 'feature_icon',
                        'type'          => 'text',
                        'default_value' => 'fa-shield-halved',
                    ...
                    array(
                        'key'   => 'field_bp_safe_feature_title',
                        'label' => 'Title',
                        'name'  => 'feature_title',
                        'type'  => 'text',
                    ),
                    array(
                        'key'   => 'field_bp_safe_feature_desc',
                        'label' => 'Description',
                        'name'  => 'feature_desc',
                        'type'  => 'textarea',
                        'rows'  => 2,
     ...
     *  ─────────────────────────────────────────────── */
    acf_add_local_field_group( array(
        'key'    => 'group_bp_home_healthhub',
        'title'  => 'Home — Health Hub Section',
        'fields' => array(
            // Badge text
            array(
                'key'           => 'field_bp_home_healthhub_badge',
                'label'         => 'Badge Text',
            ...
            // Title start
            array(
                'key'           => 'field_bp_home_healthhub_title_start',
                'label'         => 'Title Start',
            ...
            // Title highlight
            array(
                'key'           => 'field_bp_home_healthhub_title_highlight',
            ...
            // View all URL
            array(
                'key'           => 'field_bp_home_healthhub_view_all_url',
                'label'         => 'View All URL',
     ...
     *  ─────────────────────────────────────────────── */
    acf_add_local_field_group( array(
        'key'    => 'group_bp_home_location',
        'title'  => 'Home — Location Section',
        'fields' => array(
            // Badge text
            array(
                'key'           => 'field_bp_home_location_badge',
                'label'         => 'Badge Text',
            ...
            // Title start
            array(
                'key'           => 'field_bp_home_location_title_start',
                'label'         => 'Title Start',
            ...
            // Title highlight
            array(
                'key'           => 'field_bp_home_location_title_highlight',
                'label'         => 'Title Highlight',
            ...
            array(
                'key'           => 'field_bp_home_location_map_image',
                'label'         => 'Map Image',
            ...
            array(
                'key'           => 'field_bp_home_location_pharmacy_image',
     ...
     *  ─────────────────────────────────────────────── */
    acf_add_local_field_group( array(
        'key'    => 'group_bp_home_testimonials',
        'title'  => 'Home — Testimonials Section',
        'fields' => array(
            // Badge text
            array(
                'key'           => 'field_bp_home_testimonials_badge',
                'label'         => 'Badge Text',
            ...
            // Title start
            array(
                'key'           => 'field_bp_home_testimonials_title_start',
                'label'         => 'Title Start',
            ...
            // Title highlight
            array(
                'key'           => 'field_bp_home_testimonials_title_highlight',
                'label'         => 'Title Highlight',
            ...
            // Description
            array(
                'key'           => 'field_bp_home_testimonials_description',
                'label'         => 'Description',
            ...
            // Disclaimer
            array(
                'key'           => 'field_bp_home_testimonials_disclaimer',
                'label'         => 'Disclaimer',
            ...
            // CTA text
            array(
                'key'           => 'field_bp_home_testimonials_cta_text',
                'label'         => 'CTA Card Text',
            ...
            array(
                'key'        => 'field_bp_home_testimonials_repeater',
                'label'      => 'Testimonials',
                'name'       => 'testimonials',
                'type'       => 'repeater',
                'layout'     => 'block',
                ...
                'sub_fields' => array(
                    // Name
                    array(
                        'key'   => 'field_bp_home_testimonials_name',
                        'label' => 'Patient Name',
                    ...
                    // Service
                    array(
                        'key'   => 'field_bp_home_testimonials_service',
                        'label' => 'Service',
                    ...
                    // Quote
                    array(
                        'key'   => 'field_bp_home_testimonials_quote',
                        'label' => 'Quote',
                    ...
                    array(
                        'key'          => 'field_bp_home_testimonials_highlights',
                        'label'        => 'Highlights',
                        ...
                        'sub_fields'   => array(
                            array(
                                'key'           => 'field_bp_home_testimonials_highlight_icon',
                                'label'         => 'Icon',
                                'name'          => 'highlight_icon',
                                'type'          => 'text',
                            ...
                            array(
                                'key'   => 'field_bp_home_testimonials_highlight_text',
                                'label' => 'Text',
                                'name'  => 'highlight_text',
                                'type'  => 'text',
                            ),
                    ...
                    array(
                        'key'          => 'field_bp_home_testimonials_checklist',
                        'label'        => 'Checklist',
                        ...
                        'sub_fields'   => array(
                            array(
                                'key'   => 'field_bp_home_testimonials_checklist_text',
                                'label' => 'Text',
                                'name'  => 'checklist_text',
                                'type'  => 'text',
                            ),
     ...
     *  ─────────────────────────────────────────────── */
    acf_add_local_field_group( array(
        'key'    => 'group_bp_home_sticky_cta',
        'title'  => 'Home — Sticky CTA Section',
        'fields' => array(
            // Title
            array(
                'key'           => 'field_bp_home_sticky_cta_title',
                'label'         => 'Title',
            ...
            // Subtitle
            array(
                'key'           => 'field_bp_home_sticky_cta_subtitle',
                'label'         => 'Subtitle',
            ...
            // Book button text
            array(
                'key'           => 'field_bp_home_sticky_cta_button_text',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'    => 'group_bp_blog_post',
        'title'  => 'Blog — Post Fields',
        'fields' => array(
            array(
                'key'           => 'field_bp_blog_reading_time',
            ...
            array(
                'key'           => 'field_bp_blog_article_author',
            ...
            array(
                'key'           => 'field_bp_blog_author_photo',
                'label'         => 'Author Photo',
                'name'          => 'author_photo',
                'type'          => 'image',
                'return_format' => 'id',
            ...
            array(
                'key'           => 'field_bp_blog_reviewer_photo',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'    => 'group_bp_post_toc',
        'title'  => 'Table of Contents',
        'fields' => array(
            array(
                'key'           => 'field_bp_post_show_toc',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'    => 'group_bp_pillar_cluster',
        'title'  => 'Blog — Pillar / Cluster',
        'fields' => array(
            array(
                'key'           => 'field_bp_blog_is_pillar',
            ...
            array(
                'key'               => 'field_bp_blog_cluster_posts',
                'label'             => 'Cluster Posts',
                'name'              => 'cluster_posts',
                'type'              => 'relationship',
            ...
            array(
                'key'               => 'field_bp_blog_cluster_title',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'    => 'group_bp_post_faq',
        'title'  => 'Blog — FAQs',
        'fields' => array(
            array(
                'key'           => 'field_bp_post_faq_title',
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'   => 'field_bp_post_faq_question',
                        'label' => 'Question',
                        'name'  => 'question',
                        'type'  => 'text',
                    ),
                    array(
                        'key'   => 'field_bp_post_faq_answer',
                        'label' => 'Answer',
                        'name'  => 'answer',
                        'type'  => 'wysiwyg',
                        'tabs'  => 'all',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_wl_hero',
        'title'    => 'Weight Loss — Hero Section',
        'fields'   => array(
            array( 'key' => 'field_bp_wl_hero_badge', 'label' => 'Badge Text', 'name' => 'wl_hero_badge', 'type' => 'text', 'default_value' => 'MEDICAL WEIGHT LOSS' ),
            ...
            array( 'key' => 'field_bp_wl_hero_description', 'label' => 'Description', 'name' => 'wl_hero_description', 'type' => 'textarea', 'rows' => 3, 'default_value' => 'Prescription weight management with expert guidance and face-to-face support right here in Wythenshawe. No remote consultations — real care from someone who knows your name.' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_wl_stat_1_number', 'label' => 'Stat 1 — Number', 'name' => 'wl_stat_1_number', 'type' => 'text', 'default_value' => '4.9', 'wrapper' => array( 'width' => '50' ) ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_wl_social_subtext', 'label' => 'Subtext', 'name' => 'wl_social_subtext', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Real people, real care. Every patient gets a face-to-face consultation and monthly reviews with their own pharmacist.' ),
        ),
        'location'              => $wl_location,
        'menu_order'            => 401,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_wl_results_featured_number', 'label' => 'Featured Card — Number', 'name' => 'wl_results_featured_number', 'type' => 'text', 'default_value' => 'Monthly' ),
            array( 'key' => 'field_bp_wl_results_featured_label', 'label' => 'Featured Card — Label', 'name' => 'wl_results_featured_label', 'type' => 'text', 'default_value' => 'Face-to-face reviews' ),
            array( 'key' => 'field_bp_wl_results_featured_sublabel', 'label' => 'Featured Card — Sublabel', 'name' => 'wl_results_featured_sublabel', 'type' => 'text', 'default_value' => 'With your own pharmacist' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Feature',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_wl_features_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class, e.g. fas fa-check', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_wl_features_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '70' ) ),
                    array( 'key' => 'field_bp_wl_features_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $wl_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Step',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_wl_journey_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '50' ) ),
                    array( 'key' => 'field_bp_wl_journey_step_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 3, 'wrapper' => array( 'width' => '50' ) ),
                    array(
                        'key'           => 'field_bp_wl_journey_step_image',
                        'label'         => 'Step Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_wl_faq_badge', 'label' => 'Badge Text', 'name' => 'wl_faq_badge', 'type' => 'text', 'default_value' => 'FREQUENTLY ASKED QUESTIONS' ),
            array( 'key' => 'field_bp_wl_faq_title', 'label' => 'Title', 'name' => 'wl_faq_title', 'type' => 'text', 'default_value' => 'Your questions answered' ),
            array( 'key' => 'field_bp_wl_faq_description', 'label' => 'Description', 'name' => 'wl_faq_description', 'type' => 'text', 'default_value' => 'Get answers to the most common weight loss questions' ),
            array(
                'key'          => 'field_bp_wl_faqs',
                'label'        => 'FAQ Items',
                'name'         => 'wl_faqs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add FAQ',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_wl_faq_question', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_wl_faq_answer', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 4 ),
                ),
            ),
        ),
        'location'              => $wl_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Testimonial',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_wl_testimonial_weight', 'label' => 'Weight Lost (short)', 'name' => 'weight_lost_short', 'type' => 'text', 'instructions' => 'e.g. 6st', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_wl_testimonial_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'instructions' => 'e.g. 6 Stone Lost', 'wrapper' => array( 'width' => '40' ) ),
                    array( 'key' => 'field_bp_wl_testimonial_author', 'label' => 'Author', 'name' => 'author', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                    array( 'key' => 'field_bp_wl_testimonial_quote', 'label' => 'Quote', 'name' => 'quote', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $wl_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_th_stats',
        'title'    => 'Travel Health — Stats Bar',
        'fields'   => array(
            array( 'key' => 'field_bp_th_stat_1_icon', 'label' => 'Stat 1 — Icon', 'name' => 'th_stat_1_icon', 'type' => 'text', 'default_value' => 'fas fa-shield-virus', 'instructions' => 'Font Awesome class.', 'wrapper' => array( 'width' => '30' ) ),
            array( 'key' => 'field_bp_th_stat_1_number', 'label' => 'Stat 1 — Number', 'name' => 'th_stat_1_number', 'type' => 'text', 'default_value' => 'Official', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_1_label', 'label' => 'Stat 1 — Label', 'name' => 'th_stat_1_label', 'type' => 'text', 'default_value' => 'Yellow Fever Centre', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_2_icon', 'label' => 'Stat 2 — Icon', 'name' => 'th_stat_2_icon', 'type' => 'text', 'default_value' => 'fas fa-passport', 'wrapper' => array( 'width' => '30' ) ),
            array( 'key' => 'field_bp_th_stat_2_number', 'label' => 'Stat 2 — Number', 'name' => 'th_stat_2_number', 'type' => 'text', 'default_value' => '1,000+', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_2_label', 'label' => 'Stat 2 — Label', 'name' => 'th_stat_2_label', 'type' => 'text', 'default_value' => 'Travellers Protected', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_3_icon', 'label' => 'Stat 3 — Icon', 'name' => 'th_stat_3_icon', 'type' => 'text', 'default_value' => 'fas fa-award', 'wrapper' => array( 'width' => '30' ) ),
            array( 'key' => 'field_bp_th_stat_3_number', 'label' => 'Stat 3 — Number', 'name' => 'th_stat_3_number', 'type' => 'text', 'default_value' => '15+', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_3_label', 'label' => 'Stat 3 — Label', 'name' => 'th_stat_3_label', 'type' => 'text', 'default_value' => 'Years Experience', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_4_icon', 'label' => 'Stat 4 — Icon', 'name' => 'th_stat_4_icon', 'type' => 'text', 'default_value' => 'fas fa-shield-halved', 'wrapper' => array( 'width' => '30' ) ),
            array( 'key' => 'field_bp_th_stat_4_number', 'label' => 'Stat 4 — Number', 'name' => 'th_stat_4_number', 'type' => 'text', 'default_value' => 'GPhC', 'wrapper' => array( 'width' => '35' ) ),
            array( 'key' => 'field_bp_th_stat_4_label', 'label' => 'Stat 4 — Label', 'name' => 'th_stat_4_label', 'type' => 'text', 'default_value' => 'Registered', 'wrapper' => array( 'width' => '35' ) ),
        ),
        'location'              => $th_location,
        'menu_order'            => 501,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_th_services',
        'title'    => 'Travel Health — Services Section',
        'fields'   => array(
            array( 'key' => 'field_bp_th_services_badge', 'label' => 'Badge Text', 'name' => 'th_services_badge', 'type' => 'text', 'default_value' => 'COMPREHENSIVE TRAVEL HEALTH' ),
            array( 'key' => 'field_bp_th_services_title_highlight', 'label' => 'Title Highlight (gradient)', 'name' => 'th_services_title_highlight', 'type' => 'text', 'default_value' => 'Everything you need' ),
            array( 'key' => 'field_bp_th_services_title_rest', 'label' => 'Title (after highlight)', 'name' => 'th_services_title_rest', 'type' => 'text', 'default_value' => 'for safe travel' ),
            array( 'key' => 'field_bp_th_services_description', 'label' => 'Description', 'name' => 'th_services_description', 'type' => 'text', 'default_value' => 'From expert consultations to all vaccinations and official certificates' ),
            array(
                'key'          => 'field_bp_th_services',
                'label'        => 'Service Cards',
                'name'         => 'th_services',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_svc_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class, e.g. fas fa-syringe', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_th_svc_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '70' ) ),
                    array( 'key' => 'field_bp_th_svc_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array(
                        'key'           => 'field_bp_th_svc_image',
                        'label'         => 'Card Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_th_vaccinations',
        'title'    => 'Travel Health — Vaccinations Grid',
        'fields'   => array(
            array( 'key' => 'field_bp_th_vaccines_badge', 'label' => 'Badge Text', 'name' => 'th_vaccines_badge', 'type' => 'text', 'default_value' => 'ALL VACCINATIONS' ),
            array( 'key' => 'field_bp_th_vaccines_title_highlight', 'label' => 'Title Highlight (gradient)', 'name' => 'th_vaccines_title_highlight', 'type' => 'text', 'default_value' => 'Available' ),
            array( 'key' => 'field_bp_th_vaccines_title_rest', 'label' => 'Title (after highlight)', 'name' => 'th_vaccines_title_rest', 'type' => 'text', 'default_value' => 'Vaccinations' ),
            array(
                'key'          => 'field_bp_th_vaccinations',
                'label'        => 'Vaccinations',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_vax_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class.', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_th_vax_name', 'label' => 'Vaccination Name', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                    array(
                        'key'           => 'field_bp_th_vax_featured',
                        'label'         => 'Featured?',
                        'name'          => 'is_featured',
                        'type'          => 'true_false',
                        'default_value' => 0,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_th_why_image_alt', 'label' => 'Image Alt Text', 'name' => 'th_why_image_alt', 'type' => 'text', 'default_value' => 'Expert pharmacist at Bowland Pharmacy' ),
            array( 'key' => 'field_bp_th_why_badge_number', 'label' => 'Experience Badge — Number', 'name' => 'th_why_badge_number', 'type' => 'text', 'default_value' => '15+ Years' ),
            array( 'key' => 'field_bp_th_why_badge_label', 'label' => 'Experience Badge — Label', 'name' => 'th_why_badge_label', 'type' => 'text', 'default_value' => 'Experience' ),
            array(
                'key'          => 'field_bp_th_why_cards',
                'label'        => 'Feature Cards',
                'name'         => 'th_why_cards',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Feature',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_why_card_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class.', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_th_why_card_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '70' ) ),
                    array( 'key' => 'field_bp_th_why_card_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $th_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Step',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '50' ) ),
                    array( 'key' => 'field_bp_th_step_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 3, 'wrapper' => array( 'width' => '50' ) ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_th_destinations',
        'title'    => 'Travel Health — Popular Destinations',
        'fields'   => array(
            array( 'key' => 'field_bp_th_destinations_badge', 'label' => 'Badge Text', 'name' => 'th_destinations_badge', 'type' => 'text', 'default_value' => 'POPULAR DESTINATIONS' ),
            array( 'key' => 'field_bp_th_destinations_title_highlight', 'label' => 'Title Highlight (gradient)', 'name' => 'th_destinations_title_highlight', 'type' => 'text', 'default_value' => 'Travelling to' ),
            array( 'key' => 'field_bp_th_destinations_title_rest', 'label' => 'Title (after highlight)', 'name' => 'th_destinations_title_rest', 'type' => 'text', 'default_value' => 'these destinations?' ),
            array(
                'key'          => 'field_bp_th_destinations',
                'label'        => 'Destinations',
                ...
                'button_label' => 'Add Destination',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_dest_name', 'label' => 'Destination Name', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array(
                        'key'           => 'field_bp_th_dest_image',
                        'label'         => 'Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array( 'key' => 'field_bp_th_dest_url', 'label' => 'Link URL', 'name' => 'url', 'type' => 'url', 'instructions' => 'Link to destination-specific travel page.', 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
        ),
        'location'              => $th_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_th_faq_badge', 'label' => 'Badge Text', 'name' => 'th_faq_badge', 'type' => 'text', 'default_value' => 'FREQUENTLY ASKED QUESTIONS' ),
            array( 'key' => 'field_bp_th_faq_title_highlight', 'label' => 'Title Highlight (gradient)', 'name' => 'th_faq_title_highlight', 'type' => 'text', 'default_value' => 'Travel health' ),
            array( 'key' => 'field_bp_th_faq_title_rest', 'label' => 'Title (after highlight)', 'name' => 'th_faq_title_rest', 'type' => 'text', 'default_value' => 'questions answered' ),
            array(
                'key'          => 'field_bp_th_faqs',
                'label'        => 'FAQs',
                'name'         => 'th_faqs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add FAQ',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_th_faq_question', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_th_faq_answer', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 4 ),
                ),
            ),
        ),
        'location'              => $th_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_th_final_cta',
        'title'    => 'Travel Health — Final CTA Section',
        'fields'   => array(
            array( 'key' => 'field_bp_th_cta_badge_1', 'label' => 'Badge 1', 'name' => 'th_cta_badge_1', 'type' => 'text', 'default_value' => 'Yellow Fever Centre' ),
            array( 'key' => 'field_bp_th_cta_badge_2', 'label' => 'Badge 2', 'name' => 'th_cta_badge_2', 'type' => 'text', 'default_value' => 'Expert Advice' ),
            array( 'key' => 'field_bp_th_cta_badge_3', 'label' => 'Badge 3', 'name' => 'th_cta_badge_3', 'type' => 'text', 'default_value' => 'Same Day Service' ),
            array( 'key' => 'field_bp_th_cta_title', 'label' => 'Title', 'name' => 'th_cta_title', 'type' => 'text', 'default_value' => 'Ready to protect your travels?' ),
            array( 'key' => 'field_bp_th_cta_description', 'label' => 'Description', 'name' => 'th_cta_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Don\'t let health worries spoil your adventure. Book your comprehensive travel health consultation with Bowland Pharmacy today.' ),
            array( 'key' => 'field_bp_th_cta_primary_text', 'label' => 'Primary CTA Text', 'name' => 'th_cta_primary_text', 'type' => 'text', 'default_value' => 'Book Travel Health Appointment' ),
            array( 'key' => 'field_bp_th_cta_primary_url', 'label' => 'Primary CTA URL', 'name' => 'th_cta_primary_url', 'type' => 'url', 'instructions' => 'Leave blank to use the booking page.' ),
            array( 'key' => 'field_bp_th_cta_check_1', 'label' => 'Check Item 1', 'name' => 'th_cta_check_1', 'type' => 'text', 'default_value' => 'Flexible appointments' ),
            array( 'key' => 'field_bp_th_cta_check_2', 'label' => 'Check Item 2', 'name' => 'th_cta_check_2', 'type' => 'text', 'default_value' => 'Expert advice' ),
            array( 'key' => 'field_bp_th_cta_check_3', 'label' => 'Check Item 3', 'name' => 'th_cta_check_3', 'type' => 'text', 'default_value' => 'Official certificates' ),
        ),
        'location'              => $th_location,
        'menu_order'            => 508,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_ew_hero',
        'title'    => 'Ear Wax — Hero Section',
        'fields'   => array(
            array( 'key' => 'field_bp_ew_hero_badge', 'label' => 'Badge Text', 'name' => 'ew_hero_badge', 'type' => 'text', 'default_value' => 'SAME-DAY MICROSUCTION AVAILABLE' ),
            array( 'key' => 'field_bp_ew_hero_title_highlight', 'label' => 'Title — Highlighted Line', 'name' => 'ew_hero_title_highlight', 'type' => 'text', 'default_value' => 'Professional Ear Wax Removal', 'instructions' => 'Displayed in gradient text.' ),
            array( 'key' => 'field_bp_ew_hero_title_rest', 'label' => 'Title — Second Line', 'name' => 'ew_hero_title_rest', 'type' => 'text', 'default_value' => 'in Wythenshawe' ),
            array( 'key' => 'field_bp_ew_hero_subtitle', 'label' => 'Subtitle', 'name' => 'ew_hero_subtitle', 'type' => 'text', 'default_value' => 'Expert microsuction by Ahmed and our specialist team at Bowland Pharmacy' ),
            array( 'key' => 'field_bp_ew_hero_description', 'label' => 'Description', 'name' => 'ew_hero_description', 'type' => 'textarea', 'rows' => 3, 'default_value' => 'Safe, effective ear wax removal using advanced microsuction technology. Same-day appointments available. Guaranteed results with complimentary follow-up within 7 days if needed.' ),
            array( 'key' => 'field_bp_ew_hero_cta_text', 'label' => 'CTA Button Text', 'name' => 'ew_hero_cta_text', 'type' => 'text', 'default_value' => 'Book Your Appointment' ),
            array( 'key' => 'field_bp_ew_hero_cta_url', 'label' => 'CTA Button URL', 'name' => 'ew_hero_cta_url', 'type' => 'url', 'instructions' => 'Leave blank to use the default booking page.' ),
            array(
                'key'           => 'field_bp_ew_hero_image',
                'label'         => 'Hero Image',
                'name'          => 'ew_hero_image',
                'type'          => 'image',
                'return_format' => 'id',
            ...
            array( 'key' => 'field_bp_ew_hero_image_alt', 'label' => 'Hero Image Alt Text', 'name' => 'ew_hero_image_alt', 'type' => 'text', 'default_value' => 'Professional ear wax removal at Bowland Pharmacy' ),
            array( 'key' => 'field_bp_ew_price_label', 'label' => 'Price Badge — Label', 'name' => 'ew_price_label', 'type' => 'text', 'default_value' => 'Starting From' ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_ew_stats',
        'title'    => 'Ear Wax — Stats Bar',
        'fields'   => array(
            array( 'key' => 'field_bp_ew_stat_1_icon', 'label' => 'Stat 1 — Icon', 'name' => 'ew_stat_1_icon', 'type' => 'text', 'default_value' => 'fas fa-tag', 'instructions' => 'Full Font Awesome class.' ),
            array( 'key' => 'field_bp_ew_stat_1_number', 'label' => 'Stat 1 — Number', 'name' => 'ew_stat_1_number', 'type' => 'text', 'default_value' => '£40' ),
            array( 'key' => 'field_bp_ew_stat_1_label', 'label' => 'Stat 1 — Label', 'name' => 'ew_stat_1_label', 'type' => 'text', 'default_value' => 'Per Ear' ),
            array( 'key' => 'field_bp_ew_stat_2_icon', 'label' => 'Stat 2 — Icon', 'name' => 'ew_stat_2_icon', 'type' => 'text', 'default_value' => 'fas fa-clock' ),
            array( 'key' => 'field_bp_ew_stat_2_number', 'label' => 'Stat 2 — Number', 'name' => 'ew_stat_2_number', 'type' => 'text', 'default_value' => '30 mins' ),
            array( 'key' => 'field_bp_ew_stat_2_label', 'label' => 'Stat 2 — Label', 'name' => 'ew_stat_2_label', 'type' => 'text', 'default_value' => 'Treatment Time' ),
            array( 'key' => 'field_bp_ew_stat_3_icon', 'label' => 'Stat 3 — Icon', 'name' => 'ew_stat_3_icon', 'type' => 'text', 'default_value' => 'fas fa-check-circle' ),
            array( 'key' => 'field_bp_ew_stat_3_number', 'label' => 'Stat 3 — Number', 'name' => 'ew_stat_3_number', 'type' => 'text', 'default_value' => '95%+' ),
            array( 'key' => 'field_bp_ew_stat_3_label', 'label' => 'Stat 3 — Label', 'name' => 'ew_stat_3_label', 'type' => 'text', 'default_value' => 'Success Rate' ),
            array( 'key' => 'field_bp_ew_stat_4_icon', 'label' => 'Stat 4 — Icon', 'name' => 'ew_stat_4_icon', 'type' => 'text', 'default_value' => 'fas fa-calendar-check' ),
            array( 'key' => 'field_bp_ew_stat_4_number', 'label' => 'Stat 4 — Number', 'name' => 'ew_stat_4_number', 'type' => 'text', 'default_value' => 'Same Day' ),
            array( 'key' => 'field_bp_ew_stat_4_label', 'label' => 'Stat 4 — Label', 'name' => 'ew_stat_4_label', 'type' => 'text', 'default_value' => 'Appointments' ),
        ),
        'location'              => $ew_location,
        'menu_order'            => 601,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_ew_symptoms',
        'title'    => 'Ear Wax — Symptoms Section',
        'fields'   => array(
            array( 'key' => 'field_bp_ew_symptoms_badge', 'label' => 'Badge Text', 'name' => 'ew_symptoms_badge', 'type' => 'text', 'default_value' => 'COMMON SYMPTOMS' ),
            array( 'key' => 'field_bp_ew_symptoms_title', 'label' => 'Title', 'name' => 'ew_symptoms_title', 'type' => 'text', 'default_value' => 'Is Ear Wax Affecting Your Daily Life?' ),
            array( 'key' => 'field_bp_ew_symptoms_description', 'label' => 'Description', 'name' => 'ew_symptoms_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Don\'t let blocked ears hold you back. Recognise these common symptoms?' ),
            array(
                'key'          => 'field_bp_ew_symptoms',
                'label'        => 'Symptoms',
                'name'         => 'ew_symptoms',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_symptom_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-ear-listen', 'instructions' => 'Full Font Awesome class.' ),
                    array( 'key' => 'field_bp_ew_symptom_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_symptom_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $ew_location,
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    ...
                    array( 'key' => 'field_bp_ew_team_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_team_role', 'label' => 'Role', 'name' => 'role', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_team_bio', 'label' => 'Bio', 'name' => 'bio', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_ew_team_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'instructions' => 'e.g. "Since 2019" or "Level 3 Technician"' ),
                    array(
                        'key'           => 'field_bp_ew_team_badge_style',
                        'label'         => 'Badge Style',
                        'name'          => 'badge_style',
                        'type'          => 'select',
                    ...
                    array(
                        ...
                        'button_label' => 'Add Tag',
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_ew_team_tag', 'label' => 'Tag', 'name' => 'tag', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                'key'          => 'field_bp_ew_comparison_rows',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_compare_feature', 'label' => 'Feature', 'name' => 'feature', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_compare_microsuction', 'label' => 'Microsuction', 'name' => 'microsuction', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_compare_syringing', 'label' => 'Syringing', 'name' => 'syringing', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_compare_home_remedies', 'label' => 'Home Remedies', 'name' => 'home_remedies', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $ew_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_ew_process',
        'title'    => 'Ear Wax — Process (How It Works)',
        'fields'   => array(
            array( 'key' => 'field_bp_ew_process_badge', 'label' => 'Badge Text', 'name' => 'ew_process_badge', 'type' => 'text', 'default_value' => 'HOW IT WORKS' ),
            array( 'key' => 'field_bp_ew_process_title', 'label' => 'Title', 'name' => 'ew_process_title', 'type' => 'text', 'default_value' => 'Our Professional Ear Wax Removal Process' ),
            array( 'key' => 'field_bp_ew_process_description', 'label' => 'Description', 'name' => 'ew_process_description', 'type' => 'text', 'default_value' => 'Simple, effective treatment in three easy steps' ),
            array(
                'key'          => 'field_bp_ew_process_steps',
                'label'        => 'Steps',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_step_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-clipboard-check', 'instructions' => 'Full Font Awesome class.' ),
                    array( 'key' => 'field_bp_ew_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_step_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_ew_step_time', 'label' => 'Time Label', 'name' => 'time', 'type' => 'text', 'instructions' => 'e.g. "10 minutes". Leave blank to hide.' ),
                    array( 'key' => 'field_bp_ew_step_badge', 'label' => 'Badge Text', 'name' => 'badge', 'type' => 'text', 'instructions' => 'e.g. "Free 7-day follow-up". Leave blank to hide.' ),
                    array(
                        'key'           => 'field_bp_ew_step_image',
                        'label'         => 'Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_ew_pricing',
        'title'    => 'Ear Wax — Pricing Section',
        'fields'   => array(
            array( 'key' => 'field_bp_ew_pricing_badge', 'label' => 'Badge Text', 'name' => 'ew_pricing_badge', 'type' => 'text', 'default_value' => 'TRANSPARENT PRICING' ),
            array( 'key' => 'field_bp_ew_pricing_title', 'label' => 'Title', 'name' => 'ew_pricing_title', 'type' => 'text', 'default_value' => 'Simple, Transparent Pricing' ),
            array( 'key' => 'field_bp_ew_pricing_description', 'label' => 'Description', 'name' => 'ew_pricing_description', 'type' => 'text', 'default_value' => 'No hidden fees. No surprises. Just clear, professional ear care.' ),
            array(
                'key'          => 'field_bp_ew_pricing',
                'label'        => 'Pricing Cards',
                'name'         => 'ew_pricing',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_price_is_featured', 'label' => 'Featured?', 'name' => 'is_featured', 'type' => 'true_false', 'default_value' => 0, 'ui' => 1, 'instructions' => 'Featured card gets a highlighted border and "Most Popular" badge.' ),
                    array( 'key' => 'field_bp_ew_price_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'default_value' => 'MOST POPULAR', 'instructions' => 'Only shown on featured cards.' ),
                    array( 'key' => 'field_bp_ew_price_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-clipboard-list', 'instructions' => 'Full Font Awesome class.' ),
                    array( 'key' => 'field_bp_ew_price_amount_val', 'label' => 'Price', 'name' => 'price', 'type' => 'text', 'instructions' => 'Just the number, e.g. "40". The £ sign is added automatically.' ),
                    array( 'key' => 'field_bp_ew_price_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_price_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array( 'key' => 'field_bp_ew_price_callout', 'label' => 'Callout Text', 'name' => 'callout', 'type' => 'text', 'instructions' => 'e.g. "Free follow-up within 7 days if needed". Leave blank to hide.' ),
                    array( 'key' => 'field_bp_ew_price_button_text', 'label' => 'Button Text', 'name' => 'button_text', 'type' => 'text', 'default_value' => 'Book Now' ),
                ),
            ),
        ),
        'location'              => $ew_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_testimonial_quote', 'label' => 'Quote', 'name' => 'quote', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_ew_testimonial_author', 'label' => 'Author Name', 'name' => 'author', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $ew_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ew_faq_question', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_ew_faq_answer', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $ew_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_ew_cta_badge_1', 'label' => 'Badge 1', 'name' => 'ew_cta_badge_1', 'type' => 'text', 'default_value' => 'From £40 per ear' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_hairloss_hero_cta_text', 'label' => 'CTA Button Text', 'name' => 'hl_hero_cta_text', 'type' => 'text', 'default_value' => 'Book Consultation' ),
            array( 'key' => 'field_bp_hairloss_hero_cta_url', 'label' => 'CTA Button URL', 'name' => 'hl_hero_cta_url', 'type' => 'url', 'instructions' => 'Leave blank to use the default booking page.' ),
            array(
                'key'           => 'field_bp_hairloss_hero_image',
                'label'         => 'Hero Image',
                'name'          => 'hl_hero_image',
                'type'          => 'image',
                'return_format' => 'id',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_hairloss_stat_3_icon', 'label' => 'Stat 3 — Icon', 'name' => 'hl_stat_3_icon', 'type' => 'text', 'default_value' => 'fas fa-calendar-check' ),
            array( 'key' => 'field_bp_hairloss_stat_3_number', 'label' => 'Stat 3 — Number', 'name' => 'hl_stat_3_number', 'type' => 'text', 'default_value' => '6-12 Months' ),
            array( 'key' => 'field_bp_hairloss_stat_3_label', 'label' => 'Stat 3 — Label', 'name' => 'hl_stat_3_label', 'type' => 'text', 'default_value' => 'Typical Results' ),
            array( 'key' => 'field_bp_hairloss_stat_4_icon', 'label' => 'Stat 4 — Icon', 'name' => 'hl_stat_4_icon', 'type' => 'text', 'default_value' => 'fas fa-star' ),
            array( 'key' => 'field_bp_hairloss_stat_4_number', 'label' => 'Stat 4 — Number', 'name' => 'hl_stat_4_number', 'type' => 'text', 'default_value' => '4.9&#9733;' ),
            array( 'key' => 'field_bp_hairloss_stat_4_label', 'label' => 'Stat 4 — Label', 'name' => 'hl_stat_4_label', 'type' => 'text', 'default_value' => 'Average Rating' ),
        ),
        'location'              => $hl_location,
        'menu_order'            => 701,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_hl_treatments',
        'title'    => 'Hair Loss — Treatment Options',
        'fields'   => array(
            array( 'key' => 'field_bp_hairloss_treatments_badge', 'label' => 'Badge Text', 'name' => 'hl_treatments_badge', 'type' => 'text', 'default_value' => 'PRESCRIPTION & OTC' ),
            array( 'key' => 'field_bp_hairloss_treatments_title_line1', 'label' => 'Title — First Part', 'name' => 'hl_treatments_title_line1', 'type' => 'text', 'default_value' => 'Our' ),
            array( 'key' => 'field_bp_hairloss_treatments_title_highlight', 'label' => 'Title — Highlighted', 'name' => 'hl_treatments_title_highlight', 'type' => 'text', 'default_value' => 'Hair Loss Treatments' ),
            array( 'key' => 'field_bp_hairloss_treatments_description', 'label' => 'Description', 'name' => 'hl_treatments_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Clinically proven treatments prescribed and monitored by our GPhC-registered pharmacist at Bowland Pharmacy.' ),
            array(
                'key'          => 'field_bp_hairloss_treatments',
                'label'        => 'Treatment Cards',
                'name'         => 'hl_treatments',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_hairloss_treat_is_featured', 'label' => 'Featured?', 'name' => 'is_featured', 'type' => 'true_false', 'default_value' => 0, 'ui' => 1 ),
                    array( 'key' => 'field_bp_hairloss_treat_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text' ),
                    array(
                        'key'           => 'field_bp_hairloss_treat_badge_type',
                        'label'         => 'Badge Type',
                        'name'          => 'badge_type',
                        'type'          => 'select',
                    ...
                    array(
                        'key'           => 'field_bp_hairloss_treat_image',
                        'label'         => 'Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array( 'key' => 'field_bp_hairloss_treat_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_treat_subtitle', 'label' => 'Subtitle', 'name' => 'subtitle', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_treat_how', 'label' => 'How It Works', 'name' => 'how_it_works', 'type' => 'textarea', 'rows' => 2 ),
                    array(
                        'key'          => 'field_bp_hairloss_treat_results',
                        'label'        => 'Results',
                        'name'         => 'results',
                        'type'         => 'repeater',
                        'layout'       => 'table',
                        ...
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_hairloss_treat_result_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                        ),
                    ),
                    array( 'key' => 'field_bp_hairloss_treat_duration', 'label' => 'Duration', 'name' => 'duration', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_treat_price', 'label' => 'Price', 'name' => 'price', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_treat_button', 'label' => 'Button Text', 'name' => 'button_text', 'type' => 'text', 'default_value' => 'Book Now' ),
                ),
            ),
        ),
        'location'              => $hl_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_hairloss_team_image',
                        'label'         => 'Photo',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array( 'key' => 'field_bp_hairloss_team_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_team_role', 'label' => 'Role', 'name' => 'role', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_team_bio', 'label' => 'Bio', 'name' => 'bio', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_hairloss_team_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'instructions' => 'e.g. "Since 2019" or "Hair Loss Specialist"' ),
                    array(
                        'key'           => 'field_bp_hairloss_team_badge_style',
                        'label'         => 'Badge Style',
                        'name'          => 'badge_style',
                        'type'          => 'select',
                        'choices'       => array( 'green' => 'Green', 'purple' => 'Purple', 'blue' => 'Blue' ),
                    ...
                    array(
                        'key'          => 'field_bp_hairloss_team_tags',
                        'label'        => 'Skill Tags',
                        'name'         => 'tags',
                        'type'         => 'repeater',
                        'layout'       => 'table',
                        'button_label' => 'Add Tag',
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_hairloss_team_tag', 'label' => 'Tag', 'name' => 'tag', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_hl_process',
        'title'    => 'Hair Loss — Process / Journey',
        'fields'   => array(
            array( 'key' => 'field_bp_hairloss_process_badge', 'label' => 'Badge Text', 'name' => 'hl_process_badge', 'type' => 'text', 'default_value' => 'HOW IT WORKS' ),
            array( 'key' => 'field_bp_hairloss_process_title_line1', 'label' => 'Title — First Part', 'name' => 'hl_process_title_line1', 'type' => 'text', 'default_value' => 'Your Hair Loss Treatment' ),
            array( 'key' => 'field_bp_hairloss_process_title_highlight', 'label' => 'Title — Highlighted', 'name' => 'hl_process_title_highlight', 'type' => 'text', 'default_value' => 'Journey' ),
            array(
                'key'          => 'field_bp_hairloss_process_steps',
                'label'        => 'Steps',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_hairloss_step_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-calendar-check', 'instructions' => 'Full Font Awesome class.' ),
                    array( 'key' => 'field_bp_hairloss_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_step_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_hairloss_faq_badge', 'label' => 'Badge Text', 'name' => 'hl_faq_badge', 'type' => 'text', 'default_value' => 'COMMON QUESTIONS' ),
            array( 'key' => 'field_bp_hairloss_faq_title_line1', 'label' => 'Title — First Part', 'name' => 'hl_faq_title_line1', 'type' => 'text', 'default_value' => 'Hair Loss Treatment' ),
            array( 'key' => 'field_bp_hairloss_faq_title_highlight', 'label' => 'Title — Highlighted', 'name' => 'hl_faq_title_highlight', 'type' => 'text', 'default_value' => 'FAQs' ),
            array(
                'key'          => 'field_bp_hairloss_faqs',
                'label'        => 'FAQs',
                'name'         => 'hl_faqs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'instructions' => 'Leave empty to use 6 default FAQs.',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_hairloss_faq_question', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_hairloss_faq_answer', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $hl_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'instructions' => 'Leave empty to use 3 default testimonials.',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_hairloss_testimonial_quote', 'label' => 'Quote', 'name' => 'quote', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_hairloss_testimonial_author', 'label' => 'Author Name', 'name' => 'author', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $hl_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_sp_hero',
        'title'    => 'Switch Provider — Hero Section',
        'fields'   => array(
            array(
                'key'           => 'field_bp_switch_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'sp_hero_badge',
                'type'          => 'text',
                'default_value' => 'SWITCH TO BOWLAND PHARMACY',
            ...
            array(
                'key'           => 'field_bp_switch_hero_title_line2',
            ...
            array(
                'key'           => 'field_bp_switch_hero_title_line3',
            ...
            array(
                'key'           => 'field_bp_switch_hero_subtitle',
                'label'         => 'Subtitle',
                'name'          => 'sp_hero_subtitle',
                'type'          => 'textarea',
                'rows'          => 3,
                'default_value' => 'Switch to Bowland Pharmacy for expert care, transparent pricing, and ongoing pharmacist support. No waiting lists.',
            ),
            ...
            array( 'key' => 'field_bp_switch_hero_price_amount', 'label' => 'Price Badge Amount', 'name' => 'sp_hero_price_amount', 'type' => 'text', 'default_value' => '£50/mo' ),
            ...
            array(
                'key'           => 'field_bp_switch_hero_testimonial_text',
                'label'         => 'Testimonial Quote',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_sp_stats',
        'title'    => 'Switch Provider — Stats Bar',
        'fields'   => array(
            // Stat 1
            array( 'key' => 'field_bp_switch_stat_1_icon', 'label' => 'Stat 1 Icon', 'name' => 'sp_stat_1_icon', 'type' => 'text', 'default_value' => 'fa-weight-scale', 'instructions' => 'Font Awesome class, e.g. fa-weight-scale' ),
            array( 'key' => 'field_bp_switch_stat_1_number', 'label' => 'Stat 1 Number', 'name' => 'sp_stat_1_number', 'type' => 'text', 'default_value' => '2.5st' ),
            array( 'key' => 'field_bp_switch_stat_1_label', 'label' => 'Stat 1 Label', 'name' => 'sp_stat_1_label', 'type' => 'text', 'default_value' => 'Avg Loss' ),
            // Stat 2
            array( 'key' => 'field_bp_switch_stat_2_icon', 'label' => 'Stat 2 Icon', 'name' => 'sp_stat_2_icon', 'type' => 'text', 'default_value' => 'fa-users' ),
            array( 'key' => 'field_bp_switch_stat_2_number', 'label' => 'Stat 2 Number', 'name' => 'sp_stat_2_number', 'type' => 'text', 'default_value' => 'Hundreds' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            // Card 1: Problem
            array( 'key' => 'field_bp_switch_card1_tab', 'label' => 'Card 1: National Providers', 'type' => 'tab' ),
            array( 'key' => 'field_bp_switch_card1_icon', 'label' => 'Icon Class', 'name' => 'sp_card1_icon', 'type' => 'text', 'default_value' => 'fas fa-laptop' ),
            array( 'key' => 'field_bp_switch_card1_badge', 'label' => 'Badge', 'name' => 'sp_card1_badge', 'type' => 'text', 'default_value' => 'ONLINE ONLY' ),
            array( 'key' => 'field_bp_switch_card1_title', 'label' => 'Title', 'name' => 'sp_card1_title', 'type' => 'text', 'default_value' => 'National Providers' ),
            array( 'key' => 'field_bp_switch_card1_subtitle', 'label' => 'Subtitle', 'name' => 'sp_card1_subtitle', 'type' => 'text', 'default_value' => 'Remote-only weight loss services' ),
            array( 'key' => 'field_bp_switch_card1_price', 'label' => 'Price', 'name' => 'sp_card1_price', 'type' => 'text', 'default_value' => '£250+' ),
            array( 'key' => 'field_bp_switch_card1_price_period', 'label' => 'Price Period', 'name' => 'sp_card1_price_period', 'type' => 'text', 'default_value' => '/month' ),
            array( 'key' => 'field_bp_switch_card1_price_note', 'label' => 'Price Note', 'name' => 'sp_card1_price_note', 'type' => 'text', 'default_value' => 'Plus hidden consultation fees' ),
            array( 'key' => 'field_bp_switch_card1_footer', 'label' => 'Footer Text', 'name' => 'sp_card1_footer', 'type' => 'text', 'default_value' => 'What you\'re leaving behind' ),
            array(
                'key'           => 'field_bp_switch_card1_features',
                ...
                'button_label'  => 'Add Feature',
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_card1_f_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
            // Card 2: Bowland Pharmacy
            ...
            array( 'key' => 'field_bp_switch_card2_price', 'label' => 'Price', 'name' => 'sp_card2_price', 'type' => 'text', 'default_value' => 'From £50' ),
            array( 'key' => 'field_bp_switch_card2_price_period', 'label' => 'Price Period', 'name' => 'sp_card2_price_period', 'type' => 'text', 'default_value' => '/month' ),
            array( 'key' => 'field_bp_switch_card2_price_note', 'label' => 'Price Note', 'name' => 'sp_card2_price_note', 'type' => 'text', 'default_value' => 'All-inclusive with face-to-face support' ),
            array( 'key' => 'field_bp_switch_card2_cta_text', 'label' => 'CTA Button Text', 'name' => 'sp_card2_cta_text', 'type' => 'text', 'default_value' => 'Make The Switch' ),
            array(
                'key'           => 'field_bp_switch_card2_features',
                ...
                'button_label'  => 'Add Feature',
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_card2_f_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
            // Card 3: Benefits
            array( 'key' => 'field_bp_switch_card3_tab', 'label' => 'Card 3: Benefits', 'type' => 'tab' ),
            array( 'key' => 'field_bp_switch_card3_icon', 'label' => 'Icon Class', 'name' => 'sp_card3_icon', 'type' => 'text', 'default_value' => 'fas fa-trophy' ),
            array( 'key' => 'field_bp_switch_card3_badge', 'label' => 'Badge', 'name' => 'sp_card3_badge', 'type' => 'text', 'default_value' => 'YOUR BENEFITS' ),
            array( 'key' => 'field_bp_switch_card3_title', 'label' => 'Title', 'name' => 'sp_card3_title', 'type' => 'text', 'default_value' => 'What You Gain' ),
            array( 'key' => 'field_bp_switch_card3_subtitle', 'label' => 'Subtitle', 'name' => 'sp_card3_subtitle', 'type' => 'text', 'default_value' => 'The Bowland Pharmacy advantage' ),
            array( 'key' => 'field_bp_switch_card3_value_title', 'label' => 'Value Title', 'name' => 'sp_card3_value_title', 'type' => 'text', 'default_value' => 'Better Value' ),
            array( 'key' => 'field_bp_switch_card3_value_subtitle', 'label' => 'Value Subtitle', 'name' => 'sp_card3_value_subtitle', 'type' => 'text', 'default_value' => 'Competitive pricing' ),
            array( 'key' => 'field_bp_switch_card3_cta_text', 'label' => 'CTA Button Text', 'name' => 'sp_card3_cta_text', 'type' => 'text', 'default_value' => 'Meet the Team' ),
            array(
                'key'           => 'field_bp_switch_card3_features',
                ...
                'button_label'  => 'Add Feature',
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_card3_f_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $sp_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_ev_number', 'label' => 'Stat Number', 'name' => 'number', 'type' => 'text' ),
                    array( 'key' => 'field_bp_switch_ev_label', 'label' => 'Stat Label', 'name' => 'label', 'type' => 'text' ),
                    array( 'key' => 'field_bp_switch_ev_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $sp_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_sp_benefits',
        'title'    => 'Switch Provider — Benefits Section',
        'fields'   => array(
            array( 'key' => 'field_bp_switch_benefits_badge', 'label' => 'Badge Text', 'name' => 'sp_benefits_badge', 'type' => 'text', 'default_value' => 'WHY SWITCH' ),
            array( 'key' => 'field_bp_switch_benefits_title_line1', 'label' => 'Title Line 1 (gradient)', 'name' => 'sp_benefits_title_line1', 'type' => 'text', 'default_value' => 'The Benefits of' ),
            array( 'key' => 'field_bp_switch_benefits_title_line2', 'label' => 'Title Line 2 (accent)', 'name' => 'sp_benefits_title_line2', 'type' => 'text', 'default_value' => ' Switching' ),
            array( 'key' => 'field_bp_switch_benefits_description', 'label' => 'Description', 'name' => 'sp_benefits_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Discover why patients across Greater Manchester are choosing Bowland Pharmacy for their weight loss care' ),
            array(
                'key'           => 'field_bp_switch_benefits',
                'label'         => 'Benefit Cards',
                'name'          => 'sp_benefits',
                'type'          => 'repeater',
                'min'           => 0,
                ...
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_benefit_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-check-circle', 'instructions' => 'Font Awesome class, e.g. fas fa-user-doctor' ),
                    array( 'key' => 'field_bp_switch_benefit_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_switch_benefit_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $sp_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_sp_process',
        'title'    => 'Switch Provider — How To Switch',
        'fields'   => array(
            array( 'key' => 'field_bp_switch_process_badge', 'label' => 'Badge Text', 'name' => 'sp_process_badge', 'type' => 'text', 'default_value' => 'HOW TO SWITCH' ),
            array( 'key' => 'field_bp_switch_process_title_line1', 'label' => 'Title Line 1 (gradient)', 'name' => 'sp_process_title_line1', 'type' => 'text', 'default_value' => 'Make The Switch' ),
            array( 'key' => 'field_bp_switch_process_title_line2', 'label' => 'Title Line 2 (accent)', 'name' => 'sp_process_title_line2', 'type' => 'text', 'default_value' => ' Today' ),
            array( 'key' => 'field_bp_switch_process_description', 'label' => 'Description', 'name' => 'sp_process_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Switch to Bowland Pharmacy in under 5 minutes. Better support, better value, better results.' ),
            array(
                'key'           => 'field_bp_switch_process_steps',
                'label'         => 'Process Steps',
                ...
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_ps_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_switch_ps_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array( 'key' => 'field_bp_switch_ps_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'library' => 'all' ),
                ),
            ),
            // What's Included box
            array( 'key' => 'field_bp_switch_included_tab', 'label' => 'What\'s Included Box', 'type' => 'tab' ),
            array( 'key' => 'field_bp_switch_included_eyebrow', 'label' => 'Eyebrow Text', 'name' => 'sp_included_eyebrow', 'type' => 'text', 'default_value' => 'Your complete switching package' ),
            array( 'key' => 'field_bp_switch_included_title', 'label' => 'Title', 'name' => 'sp_included_title', 'type' => 'text', 'default_value' => 'What\'s Included' ),
            array(
                'key'           => 'field_bp_switch_included_items',
                ...
                'sub_fields'    => array(
                    array( 'key' => 'field_bp_switch_ii_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
            array( 'key' => 'field_bp_switch_included_cta_text', 'label' => 'CTA Button Text', 'name' => 'sp_included_cta_text', 'type' => 'text', 'default_value' => 'Start Your Switch' ),
            array( 'key' => 'field_bp_switch_included_cta_url', 'label' => 'CTA Button URL', 'name' => 'sp_included_cta_url', 'type' => 'text', 'instructions' => 'Leave blank to use booking page URL.' ),
        ),
        'location'              => $sp_location,
        'menu_order'            => 805,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_switch_cta_title_line1', 'label' => 'Title Line 1', 'name' => 'sp_cta_title_line1', 'type' => 'text', 'default_value' => 'Ready to Make' ),
            array( 'key' => 'field_bp_switch_cta_title_line2', 'label' => 'Title Line 2', 'name' => 'sp_cta_title_line2', 'type' => 'text', 'default_value' => ' the Switch?' ),
            array( 'key' => 'field_bp_switch_cta_description', 'label' => 'Description', 'name' => 'sp_cta_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Join hundreds of patients who\'ve chosen local, expert care over faceless online providers.' ),
            array( 'key' => 'field_bp_switch_cta_button_text', 'label' => 'CTA Button Text', 'name' => 'sp_cta_button_text', 'type' => 'text', 'default_value' => 'Start Your Switch Today' ),
            array( 'key' => 'field_bp_switch_cta_check_1', 'label' => 'Check 1', 'name' => 'sp_cta_check_1', 'type' => 'text', 'default_value' => 'No waiting list' ),
            array( 'key' => 'field_bp_switch_cta_check_2', 'label' => 'Check 2', 'name' => 'sp_cta_check_2', 'type' => 'text', 'default_value' => 'Same-day approval' ),
            array( 'key' => 'field_bp_switch_cta_check_3', 'label' => 'Check 3', 'name' => 'sp_cta_check_3', 'type' => 'text', 'default_value' => 'Transparent pricing' ),
        ),
        'location'              => $sp_location,
        'menu_order'            => 806,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_bp_book_hero_quote_name', 'label' => 'Testimonial Name', 'name' => 'book_hero_quote_name', 'type' => 'text', 'default_value' => 'Sarah J.' ),
            array( 'key' => 'field_bp_book_hero_quote_badge', 'label' => 'Testimonial Badge', 'name' => 'book_hero_quote_badge', 'type' => 'text', 'default_value' => 'Verified Patient' ),
            array(
                'key'        => 'field_bp_book_hero_trust',
                'label'      => 'Trust Pills',
                ...
                'max'        => 5,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_hero_trust_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-check-circle' ),
                    array( 'key' => 'field_bp_book_hero_trust_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
        ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_process',
        'title'    => 'Book Appointment — How It Works',
        'fields'   => array(
            array( 'key' => 'field_bp_book_process_title', 'label' => 'Title', 'name' => 'book_process_title', 'type' => 'text', 'default_value' => 'How It Works' ),
            array(
                'key'        => 'field_bp_book_process_steps',
                'label'      => 'Steps',
                ...
                'max'        => 5,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_process_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-hand-pointer' ),
                    array( 'key' => 'field_bp_book_process_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_process_step_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $book_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_stats',
        'title'    => 'Book Appointment — Stats Bar',
        'fields'   => array(
            array(
                'key'        => 'field_bp_book_stats',
                'label'      => 'Stats',
                'name'       => 'book_stats',
                'type'       => 'repeater',
                'layout'     => 'table',
                ...
                'max'        => 6,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_stat_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-clock' ),
                    array( 'key' => 'field_bp_book_stat_number', 'label' => 'Number', 'name' => 'number', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $book_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_services',
        'title'    => 'Book Appointment — Priority Services',
        'fields'   => array(
            array( 'key' => 'field_bp_book_services_badge', 'label' => 'Badge Text', 'name' => 'book_services_badge', 'type' => 'text', 'default_value' => 'MOST POPULAR' ),
            array( 'key' => 'field_bp_book_services_title', 'label' => 'Title', 'name' => 'book_services_title', 'type' => 'text', 'default_value' => 'Featured Services' ),
            array(
                'key'        => 'field_bp_book_priority_services',
                'label'      => 'Services',
                ...
                'max'        => 6,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_ps_badge', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'instructions' => 'e.g. Most Popular. Leave blank to hide badge.' ),
                    array( 'key' => 'field_bp_book_ps_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-weight-scale' ),
                    array( 'key' => 'field_bp_book_ps_icon_color', 'label' => 'Icon Color', 'name' => 'icon_color', 'type' => 'select', 'choices' => array( '' => 'Default (Blue)', 'teal' => 'Teal', 'purple' => 'Purple' ), 'default_value' => '' ),
                    array( 'key' => 'field_bp_book_ps_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_ps_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_additional',
        'title'    => 'Book Appointment — Additional Services',
        'fields'   => array(
            array( 'key' => 'field_bp_book_add_badge', 'label' => 'Badge Text', 'name' => 'book_additional_badge', 'type' => 'text', 'default_value' => 'ESSENTIAL HEALTHCARE' ),
            array( 'key' => 'field_bp_book_add_title', 'label' => 'Title', 'name' => 'book_additional_title', 'type' => 'text', 'default_value' => 'Everyday Health Services' ),
            array(
                'key'        => 'field_bp_book_additional_services',
                'label'      => 'Services',
                ...
                'max'        => 6,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_as_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-syringe' ),
                    array( 'key' => 'field_bp_book_as_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_as_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array( 'key' => 'field_bp_book_as_price', 'label' => 'Price', 'name' => 'price', 'type' => 'text', 'instructions' => 'e.g. £15 or VARIES' ),
                    array( 'key' => 'field_bp_book_as_btn', 'label' => 'Button Text', 'name' => 'button_text', 'type' => 'text', 'default_value' => 'Book Service' ),
                ),
            ),
        ),
        'location'              => $book_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_testimonials',
        'title'    => 'Book Appointment — Testimonials',
        'fields'   => array(
            array( 'key' => 'field_bp_book_testi_title', 'label' => 'Title', 'name' => 'book_testimonials_title', 'type' => 'text', 'default_value' => 'What Our Patients Say' ),
            array(
                'key'        => 'field_bp_book_testimonials',
                'label'      => 'Testimonials',
                ...
                'max'        => 6,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_testi_quote', 'label' => 'Quote', 'name' => 'quote', 'type' => 'textarea', 'rows' => 3 ),
                    array( 'key' => 'field_bp_book_testi_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_testi_service', 'label' => 'Service', 'name' => 'service', 'type' => 'text', 'instructions' => 'e.g. Travel Health Patient' ),
                    array( 'key' => 'field_bp_book_testi_avatar', 'label' => 'Avatar', 'name' => 'avatar', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'thumbnail' ),
                ),
            ),
        ),
        'location'              => $book_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_book_faq',
        'title'    => 'Book Appointment — FAQ',
        'fields'   => array(
            array( 'key' => 'field_bp_book_faq_badge', 'label' => 'Badge Text', 'name' => 'book_faq_badge', 'type' => 'text', 'default_value' => 'EVERYTHING YOU NEED TO KNOW' ),
            array( 'key' => 'field_bp_book_faq_title', 'label' => 'Title', 'name' => 'book_faq_title', 'type' => 'text', 'default_value' => 'Common Questions' ),
            array( 'key' => 'field_bp_book_faq_desc', 'label' => 'Description', 'name' => 'book_faq_description', 'type' => 'text', 'default_value' => 'Clear answers about our services, location, and team to help you book with confidence.' ),
            array(
                'key'        => 'field_bp_book_faqs',
                'label'      => 'FAQs',
                'name'       => 'book_faqs',
                'type'       => 'repeater',
                'layout'     => 'block',
                ...
                'max'        => 10,
                'sub_fields' => array(
                    array( 'key' => 'field_bp_book_faq_question', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_book_faq_answer', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $book_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_team_stats',
        'title'    => 'Team — Stats Bar',
        'fields'   => array(
            array(
                'key'        => 'field_bp_team_stats',
                'label'      => 'Stats',
                'name'       => 'team_stats',
                'type'       => 'repeater',
                'layout'     => 'table',
                ...
                'sub_fields' => array(
                    array( 'key' => 'field_bp_team_stat_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class, e.g. fa-calendar-check', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_team_stat_number', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_team_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'              => $team_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_team_members',
        'title'    => 'Team — Team Members',
        'fields'   => array(
            array(
                'key'        => 'field_bp_team_members',
                'label'      => 'Team Members',
                'name'       => 'team_members',
                'type'       => 'repeater',
                'layout'     => 'block',
                ...
                'sub_fields' => array(
                    ...
                    array( 'key' => 'field_bp_team_member_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'instructions' => 'Overlay badge on photo, e.g. Superintendent Pharmacist' ),
                    array(
                    ...
                    array(
                        'key'        => 'field_bp_team_member_creds',
                        'label'      => 'Credentials',
                        'name'       => 'credentials',
                        'type'       => 'repeater',
                        'layout'     => 'table',
                        ...
                        'button_label' => 'Add Credential',
                        'sub_fields' => array(
                            array( 'key' => 'field_bp_team_member_cred', 'label' => 'Credential', 'name' => 'credential', 'type' => 'text' ),
                        ),
                    ),
                    array( 'key' => 'field_bp_team_member_bio', 'label' => 'Bio', 'name' => 'bio', 'type' => 'textarea', 'rows' => 3 ),
                    array(
                        'key'        => 'field_bp_team_member_specs',
                        'label'      => 'Specialties',
                        'name'       => 'specialties',
                        'type'       => 'repeater',
                        'layout'     => 'table',
                        ...
                        'sub_fields' => array(
                            array( 'key' => 'field_bp_team_member_spec', 'label' => 'Specialty', 'name' => 'specialty', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_team_values',
        'title'    => 'Team — Values',
        'fields'   => array(
            array( 'key' => 'field_bp_team_values_badge', 'label' => 'Badge Text', 'name' => 'team_values_badge', 'type' => 'text', 'default_value' => 'OUR PHILOSOPHY' ),
            array( 'key' => 'field_bp_team_values_title', 'label' => 'Title', 'name' => 'team_values_title', 'type' => 'text', 'default_value' => 'What Drives Us' ),
            array( 'key' => 'field_bp_team_values_desc', 'label' => 'Description', 'name' => 'team_values_description', 'type' => 'text', 'default_value' => 'The principles that guide every consultation' ),
            array(
                'key'        => 'field_bp_team_values',
                'label'      => 'Values',
                'name'       => 'team_values',
                'type'       => 'repeater',
                'layout'     => 'block',
                ...
                'sub_fields' => array(
                    array( 'key' => 'field_bp_team_value_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class, e.g. fa-heart' ),
                    array( 'key' => 'field_bp_team_value_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_team_value_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $team_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_team_cta',
        'title'    => 'Team — Final CTA',
        'fields'   => array(
            array( 'key' => 'field_bp_team_cta_badge1', 'label' => 'Badge 1', 'name' => 'team_cta_badge_1', 'type' => 'text', 'default_value' => '15+ Years Experience' ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_hero',
        'title'    => 'Vaccination — Hero',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_name', 'label' => 'Vaccine Name', 'name' => 'vaccine_name', 'type' => 'text', 'instructions' => 'e.g. Rabies, Hepatitis, Typhoid' ),
            array( 'key' => 'field_bp_vaccine_parent_url', 'label' => 'Parent Page URL', 'name' => 'vaccine_parent_url', 'type' => 'url', 'default_value' => '/travel-health/' ),
            array( 'key' => 'field_bp_vaccine_hero_image', 'label' => 'Hero Background Image', 'name' => 'vaccine_hero_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_vaccine_hero_label', 'label' => 'Hero Label', 'name' => 'vaccine_hero_label', 'type' => 'text', 'default_value' => 'TRAVEL HEALTH PROTECTION' ),
            array( 'key' => 'field_bp_vaccine_hero_title', 'label' => 'Hero Title', 'name' => 'vaccine_hero_title', 'type' => 'text' ),
            ...
            array(
                ...
                'button_label' => 'Add Badge',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_hero_badge_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
        ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_protect',
        'title'    => 'Vaccination — Protection',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_protect_badge', 'label' => 'Badge Text', 'name' => 'vaccine_protect_badge', 'type' => 'text', 'default_value' => 'ESSENTIAL PROTECTION' ),
            array( 'key' => 'field_bp_vaccine_protect_title', 'label' => 'Title', 'name' => 'vaccine_protect_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_protect_desc', 'label' => 'Description', 'name' => 'vaccine_protect_desc', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_protect_image', 'label' => 'Image', 'name' => 'vaccine_protect_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_vaccine_protect_image_alt', 'label' => 'Image Alt', 'name' => 'vaccine_protect_image_alt', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_protect_nametag_name', 'label' => 'Nametag Name', 'name' => 'vaccine_protect_nametag_name', 'type' => 'text', 'default_value' => 'Expert Care' ),
            array( 'key' => 'field_bp_vaccine_protect_nametag_role', 'label' => 'Nametag Role', 'name' => 'vaccine_protect_nametag_role', 'type' => 'text', 'default_value' => 'Travel Health Team' ),
            array( 'key' => 'field_bp_vaccine_protect_highlight', 'label' => 'Highlight Text', 'name' => 'vaccine_protect_highlight', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_protect_subtitle', 'label' => 'Subtitle', 'name' => 'vaccine_protect_subtitle', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_protect_text', 'label' => 'Body Text', 'name' => 'vaccine_protect_text', 'type' => 'textarea', 'rows' => 4 ),
            array(
                'key'          => 'field_bp_vaccine_protect_features',
                'label'        => 'Features',
                ...
                'button_label' => 'Add Feature',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_pf_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class' ),
                    array( 'key' => 'field_bp_vaccine_pf_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_pf_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $vaccine_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_stats',
        'title'    => 'Vaccination — Stats Bar',
        'fields'   => array(
            array(
                'key'          => 'field_bp_vaccine_stats',
                'label'        => 'Stats',
                'name'         => 'vaccine_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'button_label' => 'Add Stat',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_stat_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_vaccine_stat_num', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_vaccine_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'              => $vaccine_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_about',
        'title'    => 'Vaccination — About',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_about_badge', 'label' => 'Badge Text', 'name' => 'vaccine_about_badge', 'type' => 'text', 'default_value' => 'KNOW THE RISKS' ),
            array( 'key' => 'field_bp_vaccine_about_title', 'label' => 'Title', 'name' => 'vaccine_about_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_about_desc', 'label' => 'Description', 'name' => 'vaccine_about_desc', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_about_image', 'label' => 'Image', 'name' => 'vaccine_about_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_vaccine_about_image_alt', 'label' => 'Image Alt', 'name' => 'vaccine_about_image_alt', 'type' => 'text' ),
            array(
                'key'          => 'field_bp_vaccine_about_cards',
                'label'        => 'Info Cards',
                ...
                'button_label' => 'Add Card',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_ac_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_ac_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_ac_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
            array( 'key' => 'field_bp_vaccine_callout_badge', 'label' => 'Callout Badge', 'name' => 'vaccine_callout_badge', 'type' => 'text', 'default_value' => 'CRITICAL WARNING' ),
            array( 'key' => 'field_bp_vaccine_callout_title', 'label' => 'Callout Title', 'name' => 'vaccine_callout_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_callout_text', 'label' => 'Callout Text', 'name' => 'vaccine_callout_text', 'type' => 'textarea', 'rows' => 3 ),
        ),
        'location'              => $vaccine_location,
        'menu_order'            => 1103,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_needs',
        'title'    => 'Vaccination — Who Needs It',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_needs_badge', 'label' => 'Badge Text', 'name' => 'vaccine_needs_badge', 'type' => 'text', 'default_value' => 'WHO NEEDS VACCINATION' ),
            array( 'key' => 'field_bp_vaccine_needs_title', 'label' => 'Title', 'name' => 'vaccine_needs_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_needs_desc', 'label' => 'Description', 'name' => 'vaccine_needs_desc', 'type' => 'text' ),
            array(
                'key'          => 'field_bp_vaccine_needs_cards',
                'label'        => 'Needs Cards',
                ...
                'button_label' => 'Add Card',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_nc_type', 'label' => 'Type', 'name' => 'type', 'type' => 'select', 'choices' => array( 'recommended' => 'Recommended (green)', 'consider' => 'Consider (amber)', 'required' => 'Required (red)' ), 'default_value' => 'recommended' ),
                    array( 'key' => 'field_bp_vaccine_nc_badge', 'label' => 'Badge', 'name' => 'badge', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_nc_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_nc_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array(
                        'key'          => 'field_bp_vaccine_nc_items',
                        ...
                        'button_label' => 'Add Item',
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_vaccine_nc_item_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_risk',
        'title'    => 'Vaccination — Risk Zones',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_risk_badge', 'label' => 'Badge Text', 'name' => 'vaccine_risk_badge', 'type' => 'text', 'default_value' => 'GLOBAL RISK ZONES' ),
            array( 'key' => 'field_bp_vaccine_risk_title', 'label' => 'Title', 'name' => 'vaccine_risk_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_risk_desc', 'label' => 'Description', 'name' => 'vaccine_risk_desc', 'type' => 'textarea', 'rows' => 2 ),
            array(
                'key'          => 'field_bp_vaccine_risk_zones',
                'label'        => 'Risk Zones',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_rz_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
                    array( 'key' => 'field_bp_vaccine_rz_level', 'label' => 'Risk Level', 'name' => 'level', 'type' => 'select', 'choices' => array( 'high' => 'High (red)', 'moderate' => 'Moderate (amber)', 'asia' => 'Asia (amber)', 'africa' => 'Africa (blue)' ), 'default_value' => 'high' ),
                    array( 'key' => 'field_bp_vaccine_rz_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_rz_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_rz_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array(
                        'key'          => 'field_bp_vaccine_rz_countries',
                        'label'        => 'Countries',
                        'name'         => 'countries',
                        'type'         => 'repeater',
                        'layout'       => 'table',
                        ...
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_vaccine_rz_country', 'label' => 'Name', 'name' => 'name', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
            array( 'key' => 'field_bp_vaccine_risk_footer', 'label' => 'Footer Text', 'name' => 'vaccine_risk_footer', 'type' => 'text' ),
        ),
        'location'              => $vaccine_location,
        'menu_order'            => 1105,
        'position'              => 'normal',
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_details',
        'title'    => 'Vaccination — Details',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_details_badge', 'label' => 'Badge Text', 'name' => 'vaccine_details_badge', 'type' => 'text', 'default_value' => 'VACCINATION DETAILS' ),
            array( 'key' => 'field_bp_vaccine_details_title', 'label' => 'Title', 'name' => 'vaccine_details_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_details_desc', 'label' => 'Description', 'name' => 'vaccine_details_desc', 'type' => 'text' ),
            array(
                'key'          => 'field_bp_vaccine_details',
                'label'        => 'Detail Cards',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_det_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_det_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_det_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $vaccine_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_faq',
        'title'    => 'Vaccination — FAQ',
        'fields'   => array(
            array( 'key' => 'field_bp_vaccine_faq_badge', 'label' => 'Badge Text', 'name' => 'vaccine_faq_badge', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_faq_title', 'label' => 'Title', 'name' => 'vaccine_faq_title', 'type' => 'text', 'default_value' => 'Common Questions' ),
            array(
                'key'          => 'field_bp_vaccine_faqs',
                'label'        => 'FAQs',
                'name'         => 'vaccine_faqs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add FAQ',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_faq_q', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_vaccine_faq_a', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $vaccine_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_vaccine_cta',
        'title'    => 'Vaccination — Final CTA',
        'fields'   => array(
            array(
                'key'          => 'field_bp_vaccine_cta_badges',
                'label'        => 'CTA Badges',
                ...
                'button_label' => 'Add Badge',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_vaccine_cta_badge_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
            array( 'key' => 'field_bp_vaccine_cta_title', 'label' => 'Title', 'name' => 'vaccine_cta_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_vaccine_cta_desc', 'label' => 'Description', 'name' => 'vaccine_cta_desc', 'type' => 'textarea', 'rows' => 2 ),
        ),
        'location'              => $vaccine_location,
        'menu_order'            => 1108,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Badge',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_hero_badge_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
        ),
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_cert',
        'title'    => 'Yellow Fever — Certification',
        'fields'   => array(
            array( 'key' => 'field_bp_yf_cert_badge', 'label' => 'Badge Text', 'name' => 'yf_cert_badge', 'type' => 'text', 'default_value' => 'OFFICIAL CENTRE' ),
            array( 'key' => 'field_bp_yf_cert_title', 'label' => 'Title', 'name' => 'yf_cert_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_cert_desc', 'label' => 'Description', 'name' => 'yf_cert_desc', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_cert_image', 'label' => 'Image', 'name' => 'yf_cert_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_yf_cert_nametag_name', 'label' => 'Nametag Name', 'name' => 'yf_cert_nametag_name', 'type' => 'text', 'default_value' => 'Ahmed Al-Liabi' ),
            array( 'key' => 'field_bp_yf_cert_nametag_role', 'label' => 'Nametag Role', 'name' => 'yf_cert_nametag_role', 'type' => 'text', 'default_value' => 'Superintendent Pharmacist & Yellow Fever Specialist' ),
            array( 'key' => 'field_bp_yf_cert_highlight', 'label' => 'Highlight Text', 'name' => 'yf_cert_highlight', 'type' => 'text', 'default_value' => 'NHS Designated Yellow Fever Centre' ),
            array( 'key' => 'field_bp_yf_cert_subtitle', 'label' => 'Subtitle', 'name' => 'yf_cert_subtitle', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_cert_text', 'label' => 'Body Text', 'name' => 'yf_cert_text', 'type' => 'textarea', 'rows' => 4 ),
            array(
                'key'          => 'field_bp_yf_cert_features',
                'label'        => 'Features',
                ...
                'button_label' => 'Add Feature',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_cf_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_cf_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_cf_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
            ...
            array( 'key' => 'field_bp_yf_cert_callout_note', 'label' => 'Callout Note', 'name' => 'yf_cert_callout_note', 'type' => 'text' ),
        ),
        'location'              => $yf_location,
        'menu_order'            => 1201,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_stats',
        'title'    => 'Yellow Fever — Stats Bar',
        'fields'   => array(
            array(
                'key'          => 'field_bp_yf_stats',
                'label'        => 'Stats',
                'name'         => 'yf_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'button_label' => 'Add Stat',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_stat_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_yf_stat_num', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_yf_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'              => $yf_location,
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_about',
        'title'    => 'Yellow Fever — About',
        'fields'   => array(
            array( 'key' => 'field_bp_yf_about_badge', 'label' => 'Badge Text', 'name' => 'yf_about_badge', 'type' => 'text', 'default_value' => 'ABOUT THE DISEASE' ),
            array( 'key' => 'field_bp_yf_about_title', 'label' => 'Title', 'name' => 'yf_about_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_about_desc', 'label' => 'Description', 'name' => 'yf_about_desc', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_about_image', 'label' => 'Image', 'name' => 'yf_about_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array(
                'key'          => 'field_bp_yf_about_cards',
                'label'        => 'Info Cards',
                'name'         => 'yf_about_cards',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Card',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_ac_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_ac_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_ac_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
            array( 'key' => 'field_bp_yf_about_callout_badge', 'label' => 'Callout Badge', 'name' => 'yf_about_callout_badge', 'type' => 'text', 'default_value' => 'SERIOUS RISK' ),
            array( 'key' => 'field_bp_yf_about_callout_title', 'label' => 'Callout Title', 'name' => 'yf_about_callout_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_about_callout_text', 'label' => 'Callout Text', 'name' => 'yf_about_callout_text', 'type' => 'textarea', 'rows' => 3 ),
        ),
        'location'              => $yf_location,
        'menu_order'            => 1203,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_needs',
        'title'    => 'Yellow Fever — Who Needs It',
        'fields'   => array(
            array( 'key' => 'field_bp_yf_needs_badge', 'label' => 'Badge Text', 'name' => 'yf_needs_badge', 'type' => 'text', 'default_value' => 'WHO NEEDS VACCINATION' ),
            array( 'key' => 'field_bp_yf_needs_title', 'label' => 'Title', 'name' => 'yf_needs_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_needs_desc', 'label' => 'Description', 'name' => 'yf_needs_desc', 'type' => 'text' ),
            array(
                'key'          => 'field_bp_yf_needs_cards',
                'label'        => 'Needs Cards',
                'name'         => 'yf_needs_cards',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Card',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_nc_type', 'label' => 'Type', 'name' => 'type', 'type' => 'select', 'choices' => array( 'required' => 'Required (red)', 'recommended' => 'Recommended (amber)' ), 'default_value' => 'required' ),
                    array( 'key' => 'field_bp_yf_nc_badge', 'label' => 'Badge', 'name' => 'badge', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_nc_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_nc_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array(
                        'key'          => 'field_bp_yf_nc_items',
                        'label'        => 'Checklist Items',
                        'name'         => 'items',
                        'type'         => 'repeater',
                        'layout'       => 'table',
                        ...
                        'button_label' => 'Add Item',
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_yf_nc_item_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
            array( 'key' => 'field_bp_yf_needs_info', 'label' => 'Info Text', 'name' => 'yf_needs_info', 'type' => 'text' ),
        ),
        'location'              => $yf_location,
        'menu_order'            => 1204,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_risk',
        'title'    => 'Yellow Fever — Risk Countries',
        'fields'   => array(
            array( 'key' => 'field_bp_yf_risk_badge', 'label' => 'Badge Text', 'name' => 'yf_risk_badge', 'type' => 'text', 'default_value' => 'RISK COUNTRIES' ),
            array( 'key' => 'field_bp_yf_risk_title', 'label' => 'Title', 'name' => 'yf_risk_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_risk_desc', 'label' => 'Description', 'name' => 'yf_risk_desc', 'type' => 'textarea', 'rows' => 2 ),
            array(
                'key'          => 'field_bp_yf_risk_stats',
                'label'        => 'Risk Stats',
                'name'         => 'yf_risk_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'button_label' => 'Add Stat',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_rs_num', 'label' => 'Number', 'name' => 'num', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_rs_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_rs_sub', 'label' => 'Subtitle', 'name' => 'sub', 'type' => 'text' ),
                ),
            ),
            array(
                'key'          => 'field_bp_yf_risk_zones',
                'label'        => 'Risk Zones',
                'name'         => 'yf_risk_zones',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Zone',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_rz_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
                    array( 'key' => 'field_bp_yf_rz_level', 'label' => 'Region', 'name' => 'level', 'type' => 'select', 'choices' => array( 'africa' => 'Africa (amber)', 'america' => 'Americas (blue)' ), 'default_value' => 'africa' ),
                    array( 'key' => 'field_bp_yf_rz_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_rz_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_rz_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                    array( 'key' => 'field_bp_yf_rz_note', 'label' => 'Note', 'name' => 'note', 'type' => 'text' ),
                    array(
                        'key'          => 'field_bp_yf_rz_countries',
                        'label'        => 'Countries',
                        'name'         => 'countries',
                        'type'         => 'repeater',
                        'layout'       => 'table',
                        ...
                        'button_label' => 'Add Country',
                        'sub_fields'   => array(
                            array( 'key' => 'field_bp_yf_rz_country', 'label' => 'Name', 'name' => 'name', 'type' => 'text' ),
                        ),
                    ),
                ),
            ),
            array( 'key' => 'field_bp_yf_risk_callout_title', 'label' => 'Callout Title', 'name' => 'yf_risk_callout_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_risk_callout_text', 'label' => 'Callout Text', 'name' => 'yf_risk_callout_text', 'type' => 'textarea', 'rows' => 2 ),
            array(
                'key'          => 'field_bp_yf_risk_callout_badges',
                ...
                'button_label' => 'Add Badge',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_rcb_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
    ...
    acf_add_local_field_group( array(
        'key'      => 'group_bp_yf_details',
        'title'    => 'Yellow Fever — Details',
        'fields'   => array(
            array( 'key' => 'field_bp_yf_details_badge', 'label' => 'Badge Text', 'name' => 'yf_details_badge', 'type' => 'text', 'default_value' => 'YOUR APPOINTMENT' ),
            array( 'key' => 'field_bp_yf_details_title', 'label' => 'Title', 'name' => 'yf_details_title', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_details_desc', 'label' => 'Description', 'name' => 'yf_details_desc', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_details_hero_image', 'label' => 'Hero Image', 'name' => 'yf_details_hero_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array(
                'key'          => 'field_bp_yf_details',
                'label'        => 'Detail Cards',
                'name'         => 'yf_details',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Detail',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_det_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_det_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_det_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'              => $yf_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_bp_yf_faq_badge', 'label' => 'Badge Text', 'name' => 'yf_faq_badge', 'type' => 'text' ),
            array( 'key' => 'field_bp_yf_faq_title', 'label' => 'Title', 'name' => 'yf_faq_title', 'type' => 'text', 'default_value' => 'Common Questions' ),
            array( 'key' => 'field_bp_yf_faq_desc', 'label' => 'Description', 'name' => 'yf_faq_desc', 'type' => 'text' ),
            array(
                'key'          => 'field_bp_yf_faqs',
                'label'        => 'FAQs',
                'name'         => 'yf_faqs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add FAQ',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_faq_q', 'label' => 'Question', 'name' => 'question', 'type' => 'text' ),
                    array( 'key' => 'field_bp_yf_faq_a', 'label' => 'Answer', 'name' => 'answer', 'type' => 'textarea', 'rows' => 3 ),
                ),
            ),
        ),
        'location'              => $yf_location,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array(
                ...
                'button_label' => 'Add Badge',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_cta_badge_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
            ...
            array(
                ...
                'button_label' => 'Add Check',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_yf_cta_check_text', 'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
                ),
            ),
        ),
        'location'              => $yf_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_td_stats',
        'title'      => 'Travel Destination — Quick Info Bar',
        'fields'     => array(
            array(
                'key'          => 'field_bp_td_stats',
                'label'        => 'Stats',
                'name'         => 'td_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'button_label' => 'Add Stat',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_td_stat_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Font Awesome class, e.g. fas fa-syringe. The "fas" prefix is added automatically if omitted.', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_td_stat_number', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_td_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                ),
            ),
        ),
        'location'   => $td_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_td_vaccines',
        'title'      => 'Travel Destination — Recommended Vaccinations',
        'fields'     => array(
            array( 'key' => 'field_bp_td_vaccines_title', 'label' => 'Title', 'name' => 'td_vaccines_title', 'type' => 'text', 'default_value' => 'Protect yourself in Thailand' ),
            array( 'key' => 'field_bp_td_vaccines_desc', 'label' => 'Description', 'name' => 'td_vaccines_description', 'type' => 'text', 'default_value' => 'These vaccinations are recommended for most travellers to Thailand' ),
            array(
                'key'          => 'field_bp_td_vaccinations',
                'label'        => 'Vaccinations',
                ...
                'button_label' => 'Add Vaccination',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_td_vax_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'instructions' => 'The "fas" prefix is added automatically if omitted.', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_td_vax_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_td_vax_badge_color', 'label' => 'Badge Colour', 'name' => 'badge_color', 'type' => 'select', 'choices' => array( 'blue' => 'Blue (Essential/Recommended)', 'gray' => 'Grey (Consider/Rural)' ), 'default_value' => 'blue', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_td_vax_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'default_value' => 'Recommended', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_td_vax_short', 'label' => 'Short Description', 'name' => 'short_desc', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_td_vax_desc', 'label' => 'Full Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'   => $td_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_td_malaria',
        'title'      => 'Travel Destination — Malaria Information',
        'fields'     => array(
            array( 'key' => 'field_bp_td_malaria_image', 'label' => 'Image', 'name' => 'td_malaria_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_td_malaria_badge_text', 'label' => 'Image Badge Text', 'name' => 'td_malaria_badge_text', 'type' => 'text', 'default_value' => 'Expert Advice' ),
            array( 'key' => 'field_bp_td_malaria_badge', 'label' => 'Section Badge', 'name' => 'td_malaria_badge', 'type' => 'text', 'default_value' => 'MOSQUITO-BORNE DISEASES' ),
            array( 'key' => 'field_bp_td_malaria_title', 'label' => 'Title', 'name' => 'td_malaria_title', 'type' => 'text', 'default_value' => 'Malaria & Dengue Risks in Thailand' ),
            array( 'key' => 'field_bp_td_malaria_intro', 'label' => 'Intro Text', 'name' => 'td_malaria_intro', 'type' => 'textarea', 'rows' => 3, 'default_value' => 'While malaria risk is low in most tourist areas, Dengue fever is common nationwide. Our pharmacists will check your specific itinerary and advise on prevention.' ),
            array(
                'key'          => 'field_bp_td_malaria_risks',
                'label'        => 'Risk Items',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_td_risk_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'The "fas" prefix is added automatically if omitted.', 'default_value' => 'fas fa-check-circle', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_td_risk_level', 'label' => 'Risk Level', 'name' => 'risk_level', 'type' => 'select', 'choices' => array( 'low-risk' => 'Low Risk (Green)', 'high-risk' => 'High Risk (Red)' ), 'default_value' => 'low-risk', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_td_risk_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_td_risk_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2, 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'   => $td_location,
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_td_health',
        'title'      => 'Travel Destination — Health Advice',
        'fields'     => array(
            array( 'key' => 'field_bp_td_health_badge', 'label' => 'Badge Text', 'name' => 'td_health_badge', 'type' => 'text', 'default_value' => 'HEALTH ADVICE' ),
            array( 'key' => 'field_bp_td_health_title', 'label' => 'Title', 'name' => 'td_health_title', 'type' => 'text', 'default_value' => 'Stay healthy in Thailand' ),
            array( 'key' => 'field_bp_td_health_subtitle', 'label' => 'Subtitle', 'name' => 'td_health_subtitle', 'type' => 'text', 'default_value' => 'Essential tips for a safe tropical adventure' ),
            array(
                'key'          => 'field_bp_td_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'td_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_td_tip_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'The "fas" prefix is added automatically if omitted.', 'default_value' => 'fas fa-glass-water', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_td_tip_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_td_tip_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_td_tip_image', 'label' => 'Background Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
        ),
        'location'   => $td_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        ...
        'fields'     => array(
            ...
            array( 'key' => 'field_bp_td_cta_check_2', 'label' => 'Check 2', 'name' => 'td_cta_check_2', 'type' => 'text', 'default_value' => 'Expert Thailand Advice' ),
            array( 'key' => 'field_bp_td_cta_check_3', 'label' => 'Check 3', 'name' => 'td_cta_check_3', 'type' => 'text', 'default_value' => 'All Vaccines Available' ),
        ),
        'location'   => $td_location,
        'menu_order' => 1340,
    ) ) );
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_ke_stats',
        'title'      => 'Kenya — Quick Info Bar',
        'fields'     => array(
            array(
                'key'          => 'field_bp_ke_stats',
                'label'        => 'Stats',
                'name'         => 'ke_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'button_label' => 'Add Stat',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ke_stat_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_ke_stat_number', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_ke_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                ),
            ),
        ),
        'location'   => $ke_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_ke_vaccines',
        'title'      => 'Kenya — Recommended Vaccinations',
        'fields'     => array(
            array( 'key' => 'field_bp_ke_vaccines_title', 'label' => 'Title', 'name' => 'ke_vaccines_title', 'type' => 'text', 'default_value' => 'Protect yourself in Kenya' ),
            array( 'key' => 'field_bp_ke_vaccines_desc', 'label' => 'Description', 'name' => 'ke_vaccines_description', 'type' => 'text', 'default_value' => 'These vaccinations are recommended for most travellers to Kenya' ),
            array(
                'key'          => 'field_bp_ke_vaccinations',
                'label'        => 'Vaccinations',
                ...
                'button_label' => 'Add Vaccination',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ke_vax_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_ke_vax_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_ke_vax_badge_color', 'label' => 'Badge Colour', 'name' => 'badge_color', 'type' => 'select', 'choices' => array( 'blue' => 'Blue (Essential/Recommended)', 'gray' => 'Grey (Consider/Rural)' ), 'default_value' => 'blue', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_ke_vax_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'default_value' => 'Recommended', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_ke_vax_short', 'label' => 'Short Description', 'name' => 'short_desc', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_ke_vax_desc', 'label' => 'Full Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'   => $ke_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_ke_malaria',
        'title'      => 'Kenya — Malaria Information',
        'fields'     => array(
            array( 'key' => 'field_bp_ke_malaria_image', 'label' => 'Image', 'name' => 'ke_malaria_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_ke_malaria_badge_text', 'label' => 'Image Badge Text', 'name' => 'ke_malaria_badge_text', 'type' => 'text', 'default_value' => 'Expert Advice' ),
            ...
            array(
                ...
                'button_label' => 'Add Risk Item',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ke_risk_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-check-circle', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_ke_risk_level', 'label' => 'Risk Level', 'name' => 'risk_level', 'type' => 'select', 'choices' => array( 'low-risk' => 'Low Risk (Green)', 'high-risk' => 'High Risk (Red)' ), 'default_value' => 'low-risk', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_ke_risk_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_ke_risk_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2, 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'   => $ke_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_ke_health',
        'title'      => 'Kenya — Health Advice',
        'fields'     => array(
            array( 'key' => 'field_bp_ke_health_badge', 'label' => 'Badge Text', 'name' => 'ke_health_badge', 'type' => 'text', 'default_value' => 'HEALTH ADVICE' ),
            array( 'key' => 'field_bp_ke_health_title', 'label' => 'Title', 'name' => 'ke_health_title', 'type' => 'text', 'default_value' => 'Stay healthy in Kenya' ),
            array( 'key' => 'field_bp_ke_health_subtitle', 'label' => 'Subtitle', 'name' => 'ke_health_subtitle', 'type' => 'text', 'default_value' => 'Essential tips for a safe safari' ),
            array(
                'key'          => 'field_bp_ke_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'ke_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'button_label' => 'Add Tip',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_ke_tip_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-glass-water', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_ke_tip_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_ke_tip_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_ke_tip_image', 'label' => 'Background Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
        ),
        'location'   => $ke_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        ...
        'fields'     => array(
            ...
            array( 'key' => 'field_bp_ke_cta_check_2', 'label' => 'Check 2', 'name' => 'ke_cta_check_2', 'type' => 'text', 'default_value' => 'Expert Advice' ),
            array( 'key' => 'field_bp_ke_cta_check_3', 'label' => 'Check 3', 'name' => 'ke_cta_check_3', 'type' => 'text', 'default_value' => 'All Vaccines' ),
        ),
        'location'   => $ke_location,
        'menu_order' => 1440,
    ) ) );
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_in_stats',
        'title'      => 'India — Quick Info Bar',
        'fields'     => array(
            array(
                'key' => 'field_bp_in_stats', 'label' => 'Stats', 'name' => 'in_stats', 'type' => 'repeater', 'layout' => 'table', 'min' => 0, 'max' => 4, 'button_label' => 'Add Stat',
                'sub_fields' => array(
                    array( 'key' => 'field_bp_in_stat_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_in_stat_number', 'label' => 'Number', 'name' => 'number', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_in_stat_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                ),
            ),
        ),
        'location'   => $in_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_in_vaccines',
        'title'      => 'India — Recommended Vaccinations',
        'fields'     => array(
            array( 'key' => 'field_bp_in_vaccines_title', 'label' => 'Title', 'name' => 'in_vaccines_title', 'type' => 'text', 'default_value' => 'Protect yourself in India' ),
            array( 'key' => 'field_bp_in_vaccines_desc', 'label' => 'Description', 'name' => 'in_vaccines_description', 'type' => 'text', 'default_value' => 'These vaccinations are recommended for most travellers to India' ),
            array(
                'key' => 'field_bp_in_vaccinations', 'label' => 'Vaccinations', 'name' => 'in_vaccinations', 'type' => 'repeater', 'layout' => 'block', 'min' => 0, 'max' => 10, 'button_label' => 'Add Vaccination',
                'sub_fields' => array(
                    array( 'key' => 'field_bp_in_vax_icon', 'label' => 'Icon Class', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-syringe', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_in_vax_name', 'label' => 'Name', 'name' => 'name', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_in_vax_badge_color', 'label' => 'Badge Colour', 'name' => 'badge_color', 'type' => 'select', 'choices' => array( 'blue' => 'Blue (Essential/Recommended)', 'gray' => 'Grey (Consider/Rural)' ), 'default_value' => 'blue', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_in_vax_badge_text', 'label' => 'Badge Text', 'name' => 'badge_text', 'type' => 'text', 'default_value' => 'Recommended', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_in_vax_short', 'label' => 'Short Description', 'name' => 'short_desc', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_in_vax_desc', 'label' => 'Full Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                ),
            ),
        ),
        'location'   => $in_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_in_malaria',
        'title'      => 'India — Malaria Information',
        'fields'     => array(
            array( 'key' => 'field_bp_in_malaria_image', 'label' => 'Image', 'name' => 'in_malaria_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_bp_in_malaria_badge_text', 'label' => 'Image Badge Text', 'name' => 'in_malaria_badge_text', 'type' => 'text', 'default_value' => 'Expert Advice' ),
            ...
            array(
                ...
                'sub_fields' => array(
                    array( 'key' => 'field_bp_in_risk_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-check-circle', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_in_risk_level', 'label' => 'Risk Level', 'name' => 'risk_level', 'type' => 'select', 'choices' => array( 'low-risk' => 'Low Risk (Green)', 'high-risk' => 'High Risk (Red)' ), 'default_value' => 'low-risk', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_in_risk_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_in_risk_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2, 'wrapper' => array( 'width' => '35' ) ),
                ),
            ),
        ),
        'location'   => $in_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        'key'        => 'group_bp_in_health',
        'title'      => 'India — Health Advice',
        'fields'     => array(
            array( 'key' => 'field_bp_in_health_badge', 'label' => 'Badge Text', 'name' => 'in_health_badge', 'type' => 'text', 'default_value' => 'HEALTH ADVICE' ),
            array( 'key' => 'field_bp_in_health_title', 'label' => 'Title', 'name' => 'in_health_title', 'type' => 'text', 'default_value' => 'Stay healthy in India' ),
            array( 'key' => 'field_bp_in_health_subtitle', 'label' => 'Subtitle', 'name' => 'in_health_subtitle', 'type' => 'text', 'default_value' => 'Essential tips for a safe journey' ),
            array(
                'key' => 'field_bp_in_health_tips', 'label' => 'Health Tips', 'name' => 'in_health_tips', 'type' => 'repeater', 'layout' => 'block', 'min' => 0, 'max' => 4, 'button_label' => 'Add Tip',
                'sub_fields' => array(
                    array( 'key' => 'field_bp_in_tip_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'default_value' => 'fas fa-glass-water', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_in_tip_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_in_tip_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'text', 'wrapper' => array( 'width' => '25' ) ),
                    array( 'key' => 'field_bp_in_tip_image', 'label' => 'Background Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
        ),
        'location'   => $in_location,
    ...
    acf_add_local_field_group( array_merge( $fg_opts, array(
        ...
        'fields'     => array(
            ...
            array( 'key' => 'field_bp_in_cta_check_2', 'label' => 'Check 2', 'name' => 'in_cta_check_2', 'type' => 'text', 'default_value' => 'Expert India Advice' ),
            array( 'key' => 'field_bp_in_cta_check_3', 'label' => 'Check 3', 'name' => 'in_cta_check_3', 'type' => 'text', 'default_value' => 'All Vaccines Available' ),
        ),
        'location'   => $in_location,
        'menu_order' => 1540,
    ) ) );
    ...
    // -------------------------------------------------------------------------
    acf_add_local_field_group( array(
        'key'      => 'group_bp_nhs_hero',
        'title'    => 'NHS Services — Hero & Stats',
        'fields'   => array(
            // --- Badge ---
            array(
                'key'           => 'field_bp_nhs_hero_badge_icon',
                'label'         => 'Badge Icon',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_badge_title',
                'label'         => 'Badge Title',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_badge_subtitle',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_title_accent',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_title_line3',
                'label'         => 'Hero Title Line 3',
                'name'          => 'nhs_hero_title_line3',
                'type'          => 'text',
                'default_value' => 'in Wythenshawe',
                'wrapper'       => array( 'width' => '33' ),
            ),

            // --- Description ---
            array(
                'key'           => 'field_bp_nhs_hero_description',
                'label'         => 'Hero Description',
            ...
            // --- CTA ---
            array(
                'key'           => 'field_bp_nhs_hero_cta_text',
                'label'         => 'Hero CTA Text',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_caption_label',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_caption_title',
                'label'         => 'Image Caption Title',
            ...
            // --- Trust Indicators ---
            array(
                'key'           => 'field_bp_nhs_hero_trust_1_icon',
                'label'         => 'Trust 1 Icon',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_trust_1_text',
                'label'         => 'Trust 1 Text',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_trust_2_icon',
                'label'         => 'Trust 2 Icon',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_trust_2_text',
                'label'         => 'Trust 2 Text',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_trust_3_icon',
                'label'         => 'Trust 3 Icon',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_trust_3_text',
                'label'         => 'Trust 3 Text',
                'name'          => 'nhs_hero_trust_3_text',
                'type'          => 'text',
                'default_value' => '4.9★ Rated',
                'wrapper'       => array( 'width' => '25' ),
            ),

            // --- Rating Badge ---
            array(
                'key'           => 'field_bp_nhs_hero_rating_score',
                'label'         => 'Rating Score',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_rating_count',
                'label'         => 'Rating Count',
            ...
            array(
                'key'           => 'field_bp_nhs_hero_rating_location',
            ...
            array(
                'key'           => 'field_bp_nhs_stat_1_number',
                'label'         => 'Stat 1 Number',
            ...
            array(
                'key'           => 'field_bp_nhs_stat_2_number',
                'label'         => 'Stat 2 Number',
            ...
            array(
                'key'           => 'field_bp_nhs_stat_3_number',
                'label'         => 'Stat 3 Number',
            ...
            array(
                'key'           => 'field_bp_nhs_stat_4_number',
                'label'         => 'Stat 4 Number',
            ...
            array(
                'key'           => 'field_bp_nhs_stat_5_number',
                'label'         => 'Stat 5 Number',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_hero',
        'title'  => 'L1 — Thailand: Hero',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_thai_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'td_hero_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_hero_title_line1',
                'label'         => 'Title Line 1',
            ...
            array(
                'key'           => 'field_bp_travel_thai_hero_highlight',
                'label'         => 'Title Highlight',
            ...
            array(
                'key'           => 'field_bp_travel_thai_hero_desc',
                'label'         => 'Description',
            ...
            array(
                'key'           => 'field_bp_travel_thai_hero_cta_url',
                'label'         => 'CTA URL',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_stats',
        'title'  => 'L1 — Thailand: Stats Bar',
        'fields' => array(
            array(
                'key'          => 'field_bp_travel_thai_stats',
                'label'        => 'Stats',
                'name'         => 'td_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_thai_stat_icon',
                        'label'         => 'Icon',
                        'name'          => 'icon',
                        'type'          => 'text',
                    ...
                    array(
                        'key'           => 'field_bp_travel_thai_stat_number',
                        'label'         => 'Number',
                        'name'          => 'number',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '30' ),
                    ...
                    array(
                        'key'           => 'field_bp_travel_thai_stat_label',
                        'label'         => 'Label',
                        'name'          => 'label',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '40' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_vaccines',
        'title'  => 'L1 — Thailand: Vaccinations',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_thai_vaccines_title',
                'label'         => 'Section Title',
            ...
            array(
                'key'           => 'field_bp_travel_thai_vaccines_desc',
                'label'         => 'Section Description',
            ...
            array(
                'key'          => 'field_bp_travel_thai_vaccinations',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_thai_vax_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_thai_vax_name',
                        'label'   => 'Vaccine Name',
                        'name'    => 'name',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_thai_vax_badge_color',
                        'label'        => 'Badge Colour',
                        'name'         => 'badge_color',
                        'type'         => 'select',
                    ...
                    array(
                        'key'     => 'field_bp_travel_thai_vax_badge_text',
                        'label'   => 'Badge Text',
                        'name'    => 'badge_text',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_thai_vax_short',
                        'label'   => 'Short Description',
                        'name'    => 'short_desc',
                        'type'    => 'text',
                    ),
                    array(
                        'key'     => 'field_bp_travel_thai_vax_desc',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_malaria',
        'title'  => 'L1 — Thailand: Malaria & Dengue',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_thai_malaria_image',
                'label'         => 'Section Image',
            ...
            array(
                'key'           => 'field_bp_travel_thai_malaria_badge_text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_malaria_badge',
                'label'         => 'Section Badge',
            ...
            array(
                'key'           => 'field_bp_travel_thai_malaria_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_thai_malaria_intro',
                'label'         => 'Introduction',
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_thai_risk_level',
                        'label'        => 'Risk Level',
                        'name'         => 'risk_level',
                        'type'         => 'select',
                    ...
                    array(
                        'key'          => 'field_bp_travel_thai_risk_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_thai_risk_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '50' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_thai_risk_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_health',
        'title'  => 'L1 — Thailand: Health Tips',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_thai_health_badge',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_health_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_thai_health_subtitle',
                'label'         => 'Subtitle',
            ...
            array(
                'key'          => 'field_bp_travel_thai_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'td_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_thai_tip_image',
                        'label'         => 'Background Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array(
                        'key'          => 'field_bp_travel_thai_tip_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_thai_tip_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '33' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_thai_tip_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_thai_cta',
        'title'  => 'L1 — Thailand: Final CTA',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_thai_cta_title',
                'label'         => 'Title',
                'name'          => 'td_cta_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_cta_desc',
                'label'         => 'Description',
            ...
            array(
                'key'   => 'field_bp_travel_thai_cta_primary_url',
                'label' => 'Primary CTA URL',
            ...
            array(
                'key'           => 'field_bp_travel_thai_cta_check_1',
                'label'         => 'Check 1',
                'name'          => 'td_cta_check_1',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_cta_check_2',
                'label'         => 'Check 2',
                'name'          => 'td_cta_check_2',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_thai_cta_check_3',
                'label'         => 'Check 3',
                'name'          => 'td_cta_check_3',
                'type'          => 'text',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_hero',
        'title'  => 'L2 — Vietnam: Hero',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_viet_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'td_hero_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_hero_title_line1',
                'label'         => 'Title Line 1',
                'name'          => 'td_hero_title_line1',
                'type'          => 'text',
                'default_value' => 'Travel Vaccinations for',
            ...
            array(
                'key'           => 'field_bp_travel_viet_hero_highlight',
                'label'         => 'Title Highlight',
                'name'          => 'td_hero_title_highlight',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_hero_desc',
                'label'         => 'Description',
                'name'          => 'td_hero_description',
                'type'          => 'textarea',
                'rows'          => 3,
            ...
            array(
                'key'           => 'field_bp_travel_viet_hero_cta_url',
                'label'         => 'CTA URL',
                'name'          => 'td_hero_cta_url',
                'type'          => 'url',
                'wrapper'       => array( 'width' => '50' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_stats',
        'title'  => 'L2 — Vietnam: Stats Bar',
        'fields' => array(
            array(
                'key'          => 'field_bp_travel_viet_stats',
                'label'        => 'Stats',
                'name'         => 'td_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_viet_stat_icon',
                        'label'         => 'Icon',
                        'name'          => 'icon',
                        'type'          => 'text',
                        'instructions'  => 'Font Awesome class, e.g. fas fa-syringe',
                    ...
                    array(
                        'key'           => 'field_bp_travel_viet_stat_number',
                        'label'         => 'Number',
                        'name'          => 'number',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '30' ),
                    ...
                    array(
                        'key'           => 'field_bp_travel_viet_stat_label',
                        'label'         => 'Label',
                        'name'          => 'label',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '40' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_vaccines',
        'title'  => 'L2 — Vietnam: Vaccinations',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_viet_vaccines_title',
                'label'         => 'Section Title',
                'name'          => 'td_vaccines_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_vaccines_desc',
                'label'         => 'Section Description',
                'name'          => 'td_vaccines_description',
                'type'          => 'text',
            ...
            array(
                'key'          => 'field_bp_travel_viet_vaccinations',
                'label'        => 'Vaccination Cards',
                'name'         => 'td_vaccinations',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_viet_vax_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_viet_vax_name',
                        'label'   => 'Vaccine Name',
                        'name'    => 'name',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_viet_vax_badge_color',
                        'label'        => 'Badge Colour',
                        'name'         => 'badge_color',
                        'type'         => 'select',
                        'choices'      => array( 'purple' => 'Purple', 'gray' => 'Gray' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_viet_vax_badge_text',
                        'label'   => 'Badge Text',
                        'name'    => 'badge_text',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_viet_vax_short',
                        'label'   => 'Short Description',
                        'name'    => 'short_desc',
                        'type'    => 'text',
                    ),
                    array(
                        'key'     => 'field_bp_travel_viet_vax_desc',
                        'label'   => 'Full Description',
                        'name'    => 'description',
                        'type'    => 'textarea',
                        'rows'    => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_malaria',
        'title'  => 'L2 — Vietnam: Malaria & Dengue',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_viet_malaria_image',
                'label'         => 'Section Image',
                'name'          => 'td_malaria_image',
                'type'          => 'image',
                'return_format' => 'id',
            ...
            array(
                'key'           => 'field_bp_travel_viet_malaria_badge_text',
                'label'         => 'Image Badge Text',
                'name'          => 'td_malaria_badge_text',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_viet_malaria_badge',
                'label'         => 'Section Badge',
                'name'          => 'td_malaria_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_malaria_title',
                'label'         => 'Title',
                'name'          => 'td_malaria_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_malaria_intro',
                'label'         => 'Introduction',
                'name'          => 'td_malaria_intro',
                'type'          => 'textarea',
                'rows'          => 3,
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_viet_risk_level',
                        'label'        => 'Risk Level',
                        'name'         => 'risk_level',
                        'type'         => 'select',
                        'choices'      => array( 'low-risk' => 'Low Risk', 'high-risk' => 'High Risk' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_viet_risk_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_viet_risk_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '50' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_viet_risk_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_health',
        'title'  => 'L2 — Vietnam: Health Tips',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_viet_health_badge',
                'label'         => 'Badge Text',
                'name'          => 'td_health_badge',
                'type'          => 'text',
                'default_value' => 'HEALTH ADVICE',
            ...
            array(
                'key'           => 'field_bp_travel_viet_health_title',
                'label'         => 'Title',
                'name'          => 'td_health_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_health_subtitle',
                'label'         => 'Subtitle',
                'name'          => 'td_health_subtitle',
                'type'          => 'text',
            ...
            array(
                'key'          => 'field_bp_travel_viet_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'td_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_viet_tip_image',
                        'label'         => 'Background Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array(
                        'key'          => 'field_bp_travel_viet_tip_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_viet_tip_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '33' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_viet_tip_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_viet_cta',
        'title'  => 'L2 — Vietnam: Final CTA',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_viet_cta_title',
                'label'         => 'Title',
                'name'          => 'td_cta_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_viet_cta_desc',
                'label'         => 'Description',
                'name'          => 'td_cta_description',
                'type'          => 'textarea',
                'rows'          => 2,
            ...
            array(
                'key'   => 'field_bp_travel_viet_cta_primary_url',
                'label' => 'Primary CTA URL',
                'name'  => 'td_cta_primary_url',
                'type'  => 'url',
                'wrapper' => array( 'width' => '50' ),
            ...
            array(
                'key'           => 'field_bp_travel_viet_cta_check_1',
                'label'         => 'Check 1',
                'name'          => 'td_cta_check_1',
                'type'          => 'text',
                'default_value' => 'Travel Ready',
            ...
            array(
                'key'           => 'field_bp_travel_viet_cta_check_2',
                'label'         => 'Check 2',
                'name'          => 'td_cta_check_2',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_viet_cta_check_3',
                'label'         => 'Check 3',
                'name'          => 'td_cta_check_3',
                'type'          => 'text',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_hero',
        'title'  => 'L3 — Kenya: Hero',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_ken_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'ke_hero_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_ken_hero_title_line1',
                'label'         => 'Title Line 1',
            ...
            array(
                'key'           => 'field_bp_travel_ken_hero_highlight',
                'label'         => 'Title Highlight',
            ...
            array(
                'key'           => 'field_bp_travel_ken_hero_desc',
                'label'         => 'Description',
            ...
            array(
                'key'           => 'field_bp_travel_ken_hero_cta_url',
                'label'         => 'CTA URL',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_stats',
        'title'  => 'L3 — Kenya: Stats Bar',
        'fields' => array(
            array(
                'key'          => 'field_bp_travel_ken_stats',
                'label'        => 'Stats',
                'name'         => 'ke_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_ken_stat_icon',
                        'label'         => 'Icon',
                        'name'          => 'icon',
                        'type'          => 'text',
                        'instructions'  => 'Font Awesome class, e.g. fas fa-syringe',
                    ...
                    array(
                        'key'           => 'field_bp_travel_ken_stat_number',
                        'label'         => 'Number',
                        'name'          => 'number',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '30' ),
                    ...
                    array(
                        'key'           => 'field_bp_travel_ken_stat_label',
                        'label'         => 'Label',
                        'name'          => 'label',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '40' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_vaccines',
        'title'  => 'L3 — Kenya: Vaccinations',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_ken_vaccines_title',
                'label'         => 'Section Title',
            ...
            array(
                'key'           => 'field_bp_travel_ken_vaccines_desc',
                'label'         => 'Section Description',
            ...
            array(
                'key'          => 'field_bp_travel_ken_vaccinations',
                'label'        => 'Vaccination Cards',
                'name'         => 'ke_vaccinations',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_ken_vax_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_ken_vax_name',
                        'label'   => 'Vaccine Name',
                        'name'    => 'name',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_ken_vax_badge_color',
                        'label'        => 'Badge Colour',
                        'name'         => 'badge_color',
                        'type'         => 'select',
                        'choices'      => array( 'purple' => 'Purple', 'gray' => 'Gray' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_ken_vax_badge_text',
                        'label'   => 'Badge Text',
                        'name'    => 'badge_text',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_ken_vax_short',
                        'label'   => 'Short Description',
                        'name'    => 'short_desc',
                        'type'    => 'text',
                    ),
                    array(
                        'key'     => 'field_bp_travel_ken_vax_desc',
                        'label'   => 'Full Description',
                        'name'    => 'description',
                        'type'    => 'textarea',
                        'rows'    => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_malaria',
        'title'  => 'L3 — Kenya: Malaria',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_ken_malaria_image',
                'label'         => 'Section Image',
            ...
            array(
                'key'           => 'field_bp_travel_ken_malaria_badge_text',
                'label'         => 'Image Badge Text',
            ...
            array(
                'key'           => 'field_bp_travel_ken_malaria_badge',
                'label'         => 'Section Badge',
            ...
            array(
                'key'           => 'field_bp_travel_ken_malaria_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_ken_malaria_intro',
                'label'         => 'Introduction',
            ...
            array(
                'key'          => 'field_bp_travel_ken_malaria_risks',
                'label'        => 'Risk Items',
                'name'         => 'ke_malaria_risks',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_ken_risk_level',
                        'label'        => 'Risk Level',
                        'name'         => 'risk_level',
                        'type'         => 'select',
                        'choices'      => array( 'low-risk' => 'Low Risk', 'high-risk' => 'High Risk' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_ken_risk_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_ken_risk_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '50' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_ken_risk_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_health',
        'title'  => 'L3 — Kenya: Health Tips',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_ken_health_badge',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_travel_ken_health_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_ken_health_subtitle',
                'label'         => 'Subtitle',
            ...
            array(
                'key'          => 'field_bp_travel_ken_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'ke_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_ken_tip_image',
                        'label'         => 'Background Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array(
                        'key'          => 'field_bp_travel_ken_tip_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_ken_tip_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '33' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_ken_tip_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_ken_cta',
        'title'  => 'L3 — Kenya: Final CTA',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_ken_cta_title',
                'label'         => 'Title',
                'name'          => 'ke_cta_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_ken_cta_desc',
                'label'         => 'Description',
            ...
            array(
                'key'   => 'field_bp_travel_ken_cta_primary_url',
                'label' => 'Primary CTA URL',
            ...
            array(
                'key'           => 'field_bp_travel_ken_cta_check_1',
                'label'         => 'Check 1',
                'name'          => 'ke_cta_check_1',
                'type'          => 'text',
                'default_value' => 'Travel Ready',
            ...
            array(
                'key'           => 'field_bp_travel_ken_cta_check_2',
                'label'         => 'Check 2',
                'name'          => 'ke_cta_check_2',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_ken_cta_check_3',
                'label'         => 'Check 3',
                'name'          => 'ke_cta_check_3',
                'type'          => 'text',
                'default_value' => 'All Vaccines',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_hero',
        'title'  => 'L4 — Brazil: Hero',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_braz_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'td_hero_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_hero_title_line1',
                'label'         => 'Title Line 1',
                'name'          => 'td_hero_title_line1',
                'type'          => 'text',
                'default_value' => 'Travel Vaccinations for',
            ...
            array(
                'key'           => 'field_bp_travel_braz_hero_highlight',
                'label'         => 'Title Highlight',
                'name'          => 'td_hero_title_highlight',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_hero_desc',
                'label'         => 'Description',
                'name'          => 'td_hero_description',
                'type'          => 'textarea',
                'rows'          => 3,
            ...
            array(
                'key'           => 'field_bp_travel_braz_hero_cta_url',
                'label'         => 'CTA URL',
                'name'          => 'td_hero_cta_url',
                'type'          => 'url',
                'wrapper'       => array( 'width' => '50' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_stats',
        'title'  => 'L4 — Brazil: Stats Bar',
        'fields' => array(
            array(
                'key'          => 'field_bp_travel_braz_stats',
                'label'        => 'Stats',
                'name'         => 'td_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_braz_stat_icon',
                        'label'         => 'Icon',
                        'name'          => 'icon',
                        'type'          => 'text',
                        'instructions'  => 'Font Awesome class, e.g. fas fa-syringe',
                    ...
                    array(
                        'key'           => 'field_bp_travel_braz_stat_number',
                        'label'         => 'Number',
                        'name'          => 'number',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '30' ),
                    ...
                    array(
                        'key'           => 'field_bp_travel_braz_stat_label',
                        'label'         => 'Label',
                        'name'          => 'label',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '40' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_vaccines',
        'title'  => 'L4 — Brazil: Vaccinations',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_braz_vaccines_title',
                'label'         => 'Section Title',
                'name'          => 'td_vaccines_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_vaccines_desc',
                'label'         => 'Section Description',
                'name'          => 'td_vaccines_description',
                'type'          => 'text',
            ...
            array(
                'key'          => 'field_bp_travel_braz_vaccinations',
                'label'        => 'Vaccination Cards',
                'name'         => 'td_vaccinations',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_braz_vax_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_braz_vax_name',
                        'label'   => 'Vaccine Name',
                        'name'    => 'name',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_braz_vax_badge_color',
                        'label'        => 'Badge Colour',
                        'name'         => 'badge_color',
                        'type'         => 'select',
                        'choices'      => array( 'purple' => 'Purple', 'gray' => 'Gray' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_braz_vax_badge_text',
                        'label'   => 'Badge Text',
                        'name'    => 'badge_text',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_braz_vax_short',
                        'label'   => 'Short Description',
                        'name'    => 'short_desc',
                        'type'    => 'text',
                    ),
                    array(
                        'key'     => 'field_bp_travel_braz_vax_desc',
                        'label'   => 'Full Description',
                        'name'    => 'description',
                        'type'    => 'textarea',
                        'rows'    => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_malaria',
        'title'  => 'L4 — Brazil: Malaria & Dengue',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_braz_malaria_image',
                'label'         => 'Section Image',
                'name'          => 'td_malaria_image',
                'type'          => 'image',
                'return_format' => 'id',
            ...
            array(
                'key'           => 'field_bp_travel_braz_malaria_badge_text',
                'label'         => 'Image Badge Text',
                'name'          => 'td_malaria_badge_text',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_braz_malaria_badge',
                'label'         => 'Section Badge',
                'name'          => 'td_malaria_badge',
                'type'          => 'text',
                'default_value' => 'MOSQUITO RISKS',
            ...
            array(
                'key'           => 'field_bp_travel_braz_malaria_title',
                'label'         => 'Title',
                'name'          => 'td_malaria_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_malaria_intro',
                'label'         => 'Introduction',
                'name'          => 'td_malaria_intro',
                'type'          => 'textarea',
                'rows'          => 3,
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_braz_risk_level',
                        'label'        => 'Risk Level',
                        'name'         => 'risk_level',
                        'type'         => 'select',
                        'choices'      => array( 'low-risk' => 'Low Risk', 'high-risk' => 'High Risk' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_braz_risk_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_braz_risk_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '50' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_braz_risk_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_health',
        'title'  => 'L4 — Brazil: Health Tips',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_braz_health_badge',
                'label'         => 'Badge Text',
                'name'          => 'td_health_badge',
                'type'          => 'text',
                'default_value' => 'HEALTH ADVICE',
            ...
            array(
                'key'           => 'field_bp_travel_braz_health_title',
                'label'         => 'Title',
                'name'          => 'td_health_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_health_subtitle',
                'label'         => 'Subtitle',
                'name'          => 'td_health_subtitle',
                'type'          => 'text',
                'default_value' => 'Essential tips for a safe trip',
            ...
            array(
                'key'          => 'field_bp_travel_braz_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'td_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_braz_tip_image',
                        'label'         => 'Background Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array(
                        'key'          => 'field_bp_travel_braz_tip_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_braz_tip_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '33' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_braz_tip_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_braz_cta',
        'title'  => 'L4 — Brazil: Final CTA',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_braz_cta_title',
                'label'         => 'Title',
                'name'          => 'td_cta_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_braz_cta_desc',
                'label'         => 'Description',
                'name'          => 'td_cta_description',
                'type'          => 'textarea',
                'rows'          => 2,
            ...
            array(
                'key'   => 'field_bp_travel_braz_cta_primary_url',
                'label' => 'Primary CTA URL',
                'name'  => 'td_cta_primary_url',
                'type'  => 'url',
                'wrapper' => array( 'width' => '50' ),
            ...
            array(
                'key'           => 'field_bp_travel_braz_cta_check_1',
                'label'         => 'Check 1',
                'name'          => 'td_cta_check_1',
                'type'          => 'text',
                'default_value' => 'Travel Ready',
            ...
            array(
                'key'           => 'field_bp_travel_braz_cta_check_2',
                'label'         => 'Check 2',
                'name'          => 'td_cta_check_2',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_braz_cta_check_3',
                'label'         => 'Check 3',
                'name'          => 'td_cta_check_3',
                'type'          => 'text',
                'default_value' => 'All Vaccines',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_hero',
        'title'  => 'L5 — Cape Verde: Hero',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_cv_hero_badge',
                'label'         => 'Badge Text',
                'name'          => 'cv_hero_badge',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_cv_hero_title_line1',
                'label'         => 'Title Line 1',
            ...
            array(
                'key'           => 'field_bp_travel_cv_hero_highlight',
                'label'         => 'Title Highlight',
            ...
            array(
                'key'           => 'field_bp_travel_cv_hero_desc',
                'label'         => 'Description',
            ...
            array(
                'key'           => 'field_bp_travel_cv_hero_cta_url',
                'label'         => 'CTA URL',
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_stats',
        'title'  => 'L5 — Cape Verde: Stats Bar',
        'fields' => array(
            array(
                'key'          => 'field_bp_travel_cv_stats',
                'label'        => 'Stats',
                'name'         => 'cv_stats',
                'type'         => 'repeater',
                'layout'       => 'table',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_cv_stat_icon',
                        'label'         => 'Icon',
                        'name'          => 'icon',
                        'type'          => 'text',
                        'instructions'  => 'Font Awesome class, e.g. fas fa-syringe',
                    ...
                    array(
                        'key'           => 'field_bp_travel_cv_stat_number',
                        'label'         => 'Number',
                        'name'          => 'number',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '30' ),
                    ...
                    array(
                        'key'           => 'field_bp_travel_cv_stat_label',
                        'label'         => 'Label',
                        'name'          => 'label',
                        'type'          => 'text',
                        'wrapper'       => array( 'width' => '40' ),
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_vaccines',
        'title'  => 'L5 — Cape Verde: Vaccinations',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_cv_vaccines_title',
                'label'         => 'Section Title',
            ...
            array(
                'key'           => 'field_bp_travel_cv_vaccines_desc',
                'label'         => 'Section Description',
            ...
            array(
                'key'          => 'field_bp_travel_cv_vaccinations',
                'label'        => 'Vaccination Cards',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_cv_vax_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_cv_vax_name',
                        'label'   => 'Vaccine Name',
                        'name'    => 'name',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_cv_vax_badge_color',
                        'label'        => 'Badge Colour',
                        'name'         => 'badge_color',
                        'type'         => 'select',
                        'choices'      => array( 'purple' => 'Purple', 'gray' => 'Gray' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_cv_vax_badge_text',
                        'label'   => 'Badge Text',
                        'name'    => 'badge_text',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '25' ),
                    ...
                    array(
                        'key'     => 'field_bp_travel_cv_vax_short',
                        'label'   => 'Short Description',
                        'name'    => 'short_desc',
                        'type'    => 'text',
                    ),
                    array(
                        'key'     => 'field_bp_travel_cv_vax_desc',
                        'label'   => 'Full Description',
                        'name'    => 'description',
                        'type'    => 'textarea',
                        'rows'    => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_malaria',
        'title'  => 'L5 — Cape Verde: Malaria & Dengue',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_cv_malaria_image',
                'label'         => 'Section Image',
            ...
            array(
                'key'           => 'field_bp_travel_cv_malaria_badge',
                'label'         => 'Section Badge',
            ...
            array(
                'key'           => 'field_bp_travel_cv_malaria_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_cv_malaria_intro',
                'label'         => 'Introduction',
            ...
            array(
                'key'          => 'field_bp_travel_cv_malaria_risks',
                'label'        => 'Risk Items',
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_bp_travel_cv_risk_level',
                        'label'        => 'Risk Level',
                        'name'         => 'risk_level',
                        'type'         => 'select',
                        'choices'      => array( 'low-risk' => 'Low Risk', 'high-risk' => 'High Risk' ),
                    ...
                    array(
                        'key'          => 'field_bp_travel_cv_risk_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_cv_risk_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '50' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_cv_risk_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_health',
        'title'  => 'L5 — Cape Verde: Health Tips',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_cv_health_badge',
                'label'         => 'Badge Text',
            ...
            array(
                'key'           => 'field_bp_travel_cv_health_title',
                'label'         => 'Title',
            ...
            array(
                'key'           => 'field_bp_travel_cv_health_subtitle',
                'label'         => 'Subtitle',
            ...
            array(
                'key'          => 'field_bp_travel_cv_health_tips',
                'label'        => 'Health Tips',
                'name'         => 'cv_health_tips',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array(
                        'key'           => 'field_bp_travel_cv_tip_image',
                        'label'         => 'Background Image',
                        'name'          => 'image',
                        'type'          => 'image',
                        'return_format' => 'id',
                    ...
                    array(
                        'key'          => 'field_bp_travel_cv_tip_icon',
                        'label'        => 'Icon',
                        'name'         => 'icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class',
                    ...
                    array(
                        'key'     => 'field_bp_travel_cv_tip_title',
                        'label'   => 'Title',
                        'name'    => 'title',
                        'type'    => 'text',
                        'wrapper' => array( 'width' => '33' ),
                    ...
                    array(
                        'key'  => 'field_bp_travel_cv_tip_desc',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 2,
    ...
    // =========================================================================
    acf_add_local_field_group( array(
        'key'    => 'group_bp_travel_cv_cta',
        'title'  => 'L5 — Cape Verde: Final CTA',
        'fields' => array(
            array(
                'key'           => 'field_bp_travel_cv_cta_title',
                'label'         => 'Title',
                'name'          => 'cv_cta_title',
                'type'          => 'text',
            ...
            array(
                'key'           => 'field_bp_travel_cv_cta_desc',
                'label'         => 'Description',
            ...
            array(
                'key'   => 'field_bp_travel_cv_cta_primary_url',
                'label' => 'Primary CTA URL',
            ...
            array(
                'key'           => 'field_bp_travel_cv_cta_check_1',
                'label'         => 'Check 1',
                'name'          => 'cv_cta_check_1',
                'type'          => 'text',
                'default_value' => 'Travel Ready',
            ...
            array(
                'key'           => 'field_bp_travel_cv_cta_check_2',
                'label'         => 'Check 2',
                'name'          => 'cv_cta_check_2',
                'type'          => 'text',
                'default_value' => 'Expert Advice',
            ...
            array(
                'key'           => 'field_bp_travel_cv_cta_check_3',
                'label'         => 'Check 3',
                'name'          => 'cv_cta_check_3',
                'type'          => 'text',
                'default_value' => 'All Vaccines',
    ...
    acf_add_local_field_group( array(
        'key'    => 'group_bp_bt_most_requested',
        'title'  => 'Blood Testing — Most Requested',
        'fields' => array(
            array( 'key' => 'field_bp_bt_mr_badge', 'label' => 'Badge Text', 'name' => 'bt_mr_badge', 'type' => 'text', 'default_value' => 'MOST REQUESTED' ),
            array( 'key' => 'field_bp_bt_mr_title', 'label' => 'Section Title', 'name' => 'bt_mr_title', 'type' => 'text', 'default_value' => 'Most Requested Tests' ),
            array( 'key' => 'field_bp_bt_mr_description', 'label' => 'Section Description', 'name' => 'bt_mr_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Our most popular blood test panels — book any of these directly below.' ),
            array( 'key' => 'field_bp_bt_most_requested', 'label' => 'Featured Tests', 'name' => 'bt_most_requested', 'type' => 'relationship', 'post_type' => array( 'blood_test' ), 'filters' => array( 'search' ), 'return_format' => 'id', 'instructions' => 'Pick and order the tests to feature at the top of the page. Drag to reorder. Leave empty to hide the section.' ),
        ),
        'location' => array(
            array(
                array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array( 'key' => 'field_bp_prices_hero_badge', 'label' => 'Hero Badge', 'name' => 'prices_hero_badge', 'type' => 'text', 'default_value' => 'OUR PRICING' ),
            array( 'key' => 'field_bp_prices_hero_title', 'label' => 'Hero Title (Gradient)', 'name' => 'prices_hero_title', 'type' => 'text', 'default_value' => 'Transparent Pricing' ),
            array( 'key' => 'field_bp_prices_hero_title_rest', 'label' => 'Hero Title (Rest)', 'name' => 'prices_hero_title_rest', 'type' => 'text', 'default_value' => 'at Bowland Pharmacy' ),
            array( 'key' => 'field_bp_prices_hero_description', 'label' => 'Hero Description', 'name' => 'prices_hero_description', 'type' => 'textarea', 'rows' => 3 ),

            array(
                'key'          => 'field_bp_prices_weight_loss',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_prices_wl_product_name', 'label' => 'Product Name', 'name' => 'wl_product_name', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_prices_wl_strength', 'label' => 'Strength', 'name' => 'wl_strength', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_prices_wl_price', 'label' => 'Price', 'name' => 'wl_price', 'type' => 'text', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_prices_wl_supply', 'label' => 'Supply', 'name' => 'wl_supply', 'type' => 'text', 'wrapper' => array( 'width' => '15' ), 'instructions' => 'e.g. "per month" or "28-day supply"' ),
                    array( 'key' => 'field_bp_prices_wl_note', 'label' => 'Note (optional)', 'name' => 'wl_note', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                ),
            ),

            array(
                'key'          => 'field_bp_prices_travel',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_prices_travel_category', 'label' => 'Category', 'name' => 'travel_category', 'type' => 'select', 'choices' => array( 'vaccine' => 'Vaccine', 'antimalarial' => 'Antimalarial (Malaria Treatment)' ), 'default_value' => 'vaccine', 'wrapper' => array( 'width' => '20' ), 'instructions' => 'Antimalarials show in the separate "Malaria Treatment" section.' ),
                    array( 'key' => 'field_bp_prices_travel_vaccine_name', 'label' => 'Name', 'name' => 'travel_vaccine_name', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_prices_travel_price_per_dose', 'label' => 'Price per Dose', 'name' => 'travel_price_per_dose', 'type' => 'text', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_prices_travel_course_price', 'label' => 'Full Course Price (optional)', 'name' => 'travel_course_price', 'type' => 'text', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_prices_travel_notes', 'label' => 'Notes (optional)', 'name' => 'travel_notes', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                ),
            ),

            array(
                'key'          => 'field_bp_prices_private',
                ...
                'button_label' => 'Add Service',
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_prices_private_category', 'label' => 'Category', 'name' => 'private_category', 'type' => 'text', 'wrapper' => array( 'width' => '30' ), 'instructions' => 'Rows sharing a category are grouped together in the panel.' ),
                    array( 'key' => 'field_bp_prices_private_service_name', 'label' => 'Service Name', 'name' => 'private_service_name', 'type' => 'text', 'wrapper' => array( 'width' => '35' ) ),
                    array( 'key' => 'field_bp_prices_private_price', 'label' => 'Price', 'name' => 'private_price', 'type' => 'text', 'wrapper' => array( 'width' => '15' ) ),
                    array( 'key' => 'field_bp_prices_private_notes', 'label' => 'Notes (optional)', 'name' => 'private_notes', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                ),
            ),

            array(
                'key'          => 'field_bp_prices_nhs',
                'label'        => 'NHS Services',
                'name'         => 'prices_nhs',
                'type'         => 'repeater',
                'layout'       => 'block',
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_prices_nhs_service_name', 'label' => 'Service Name', 'name' => 'nhs_service_name', 'type' => 'text', 'wrapper' => array( 'width' => '40' ) ),
                    array( 'key' => 'field_bp_prices_nhs_eligibility', 'label' => 'Eligibility', 'name' => 'nhs_eligibility', 'type' => 'text', 'wrapper' => array( 'width' => '60' ) ),
                ),
            ),

            array(
                'key'           => 'field_bp_prices_disclaimer',
                'label'         => 'Disclaimer',
...
add_action( 'acf/init', 'bp_register_acf_field_groups' );
