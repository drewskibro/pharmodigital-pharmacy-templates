                ...
                'sub_fields'   => array(
                    ...
                    array(
                        ...
                        'choices'       => array(
                            'above'       => 'Above the dot',
                            'below'       => 'Below the dot',
                            'below-right' => 'Below, shifted right',
                            'below-left'  => 'Below, shifted left',
                        ),
                        'default_value' => 'above',
                        'instructions'  => 'Where the info popup appears when someone hovers or taps the marker. Pick "below" if the dot sits near the top of the map; use the shifted options when the popup would overlap the pharmacy label.',
                    ),
                ),
            ),
        ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array( 'key' => 'field_bp_prices_travel_vaccine_name', 'label' => 'Vaccine Name', 'name' => 'travel_vaccine_name', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                    array( 'key' => 'field_bp_prices_travel_price_per_dose', 'label' => 'Price per Dose', 'name' => 'travel_price_per_dose', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_prices_travel_course_price', 'label' => 'Full Course Price (optional)', 'name' => 'travel_course_price', 'type' => 'text', 'wrapper' => array( 'width' => '20' ) ),
                    array( 'key' => 'field_bp_prices_travel_notes', 'label' => 'Notes (optional)', 'name' => 'travel_notes', 'type' => 'text', 'wrapper' => array( 'width' => '30' ) ),
                ),
            ),
