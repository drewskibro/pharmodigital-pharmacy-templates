...
$google_count  = bp_option( 'google_review_count', '200+' );
  ...
  <nav class="bowland-nav">
    ...
    <div class="bowland-nav-trust-bar">
      <div class="bowland-container">
        <div class="bowland-trust-items">
          <div class="bowland-trust-item">
          ...
          <div class="bowland-trust-divider"></div>
          <div class="bowland-trust-item">
          ...
          <div class="bowland-trust-divider"></div>
          <div class="bowland-trust-item bowland-trust-item--rating">
    ...
    <div class="bowland-nav-top">
      <div class="bowland-container">
        ...
        <!-- Desktop Top Actions -->
        <div class="bowland-top-actions">
          <a href="tel:<?php echo esc_attr( $phone_link ); ?>" class="bowland-top-link bowland-top-link--phone">
          ...
          <button class="bowland-search-btn" id="bowland-search-btn" aria-label="Search">
            ...
            <span class="bowland-search-btn-text">Search services&hellip;</span>
          </button>
        </div>

        <!-- Mobile Toggle -->
        <button class="bowland-mobile-toggle" id="bowland-mobile-btn" aria-label="Toggle menu" aria-expanded="false">
    ...
    <div class="bowland-nav-bottom">
      <div class="bowland-container">
        <div class="bowland-desktop-menu">

          <?php // ── Home (no dropdown) ────────────────────────────── ?>
          <?php if ( $nav_home_show ) : ?>
          <div class="bowland-menu-item">
            <a href="<?php echo esc_url( $nav_home_url ); ?>" class="bowland-menu-btn"><?php echo esc_html( $nav_home_label ); ?></a>
          </div>
          <?php endif; ?>
          ...
          <div class="bowland-menu-item">
            ...
            <div class="bowland-dropdown">
              ...
              <div class="bowland-dropdown-footer">
                <a href="<?php echo esc_url( $nav_wl_url ); ?>" class="bowland-footer-link">
          ...
          <div class="bowland-menu-item">
            ...
            <div class="bowland-dropdown wide">
              <div class="bowland-dropdown-header teal">
              ...
              <div class="bowland-dropdown-row">
                ...
                <div class="bowland-dropdown-col bg-gray">
                  <div class="bowland-menu-section-title">Popular Destinations</div>
                  <div class="bowland-destinations-grid">
                    ...
                    ?>
                    <a href="<?php echo esc_url( $href ); ?>" class="bowland-destination-link">
                      <?php if ( $flag_url ) : ?>
                      <img src="<?php echo esc_url( $flag_url ); ?>" alt="<?php echo esc_attr( $name ); ?>" class="bowland-destination-flag" loading="lazy">
                      <?php endif; ?>
              ...
              <div class="bowland-dropdown-footer">
                <a href="<?php echo esc_url( $nav_th_url ); ?>" class="bowland-footer-link">
          ...
          <?php if ( $nav_bt_show ) : ?>
          <div class="bowland-menu-item">
            <a href="<?php echo esc_url( $nav_bt_url ); ?>" class="bowland-menu-btn"><?php echo esc_html( $nav_bt_label ); ?></a>
          </div>
          <?php endif; ?>
          ...
          <?php if ( $nav_ec_show ) : ?>
          <div class="bowland-menu-item">
            <a href="<?php echo esc_url( $nav_ec_url ); ?>" class="bowland-menu-btn"><?php echo esc_html( $nav_ec_label ); ?></a>
          </div>
          <?php endif; ?>
          ...
          <div class="bowland-menu-item">
            ...
            <div class="bowland-dropdown">
              ...
              <div class="bowland-dropdown-footer">
                <a href="<?php echo esc_url( $nav_sv_url ); ?>" class="bowland-footer-link">
          ...
          <?php if ( $nav_hh_show ) : ?>
          <div class="bowland-menu-item">
            <a href="<?php echo esc_url( $nav_hh_url ); ?>" class="bowland-menu-btn"><?php echo esc_html( $nav_hh_label ); ?></a>
          </div>
          <?php endif; ?>
          ...
          <?php if ( $nav_ct_show ) : ?>
          <div class="bowland-menu-item">
            <a href="<?php echo esc_url( $nav_ct_url ); ?>" class="bowland-menu-btn"><?php echo esc_html( $nav_ct_label ); ?></a>
          </div>
          <?php endif; ?>
    ...
    <!-- ── MOBILE MENU ── -->
    <div class="bowland-mobile-menu" id="bowland-mobile-menu">

      <div class="bowland-mobile-nav">

        <?php if ( $nav_home_show ) : ?>
        <a href="<?php echo esc_url( $nav_home_url ); ?>" class="bowland-mobile-link"><?php echo esc_html( $nav_home_label ); ?></a>
        <?php endif; ?>

        <?php // ── Weight Loss Accordion ── ?>
        <?php if ( $nav_wl_show ) : ?>
        <div class="bowland-mobile-accordion">
          <button class="bowland-mobile-accordion-btn">
            <?php echo esc_html( $nav_wl_label ); ?>
            <svg class="bowland-mobile-accordion-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
          </button>
          <div class="bowland-mobile-accordion-content">
            <?php foreach ( $wl_links as $link ) :
              $href = ! empty( $link['url'] ) ? $link['url'] : $nav_wl_url;
            ?>
        ...
        <div class="bowland-mobile-accordion">
          ...
          <div class="bowland-mobile-accordion-content">
            ...
            <a href="<?php echo esc_url( $href ); ?>" class="bowland-mobile-sub-link"><?php echo esc_html( $link['label'] ); ?></a>
            <?php endforeach; ?>
            <div class="bowland-mobile-sub-divider">Popular Destinations</div>
            <?php foreach ( $th_dests as $dest ) :
              $href = ! empty( $dest['url'] ) ? $dest['url'] : $nav_th_url;
              $name = ! empty( $dest['name'] ) ? $dest['name'] : '';
            ?>
            <a href="<?php echo esc_url( $href ); ?>" class="bowland-mobile-sub-link"><?php echo esc_html( $name ); ?></a>
            <?php endforeach; ?>
          </div>
        </div>
        <?php endif; ?>
        ...
        <?php if ( $nav_bt_show ) : ?>
        <a href="<?php echo esc_url( $nav_bt_url ); ?>" class="bowland-mobile-link"><?php echo esc_html( $nav_bt_label ); ?></a>
        <?php endif; ?>

        <?php if ( $nav_ec_show ) : ?>
        <a href="<?php echo esc_url( $nav_ec_url ); ?>" class="bowland-mobile-link"><?php echo esc_html( $nav_ec_label ); ?></a>
        <?php endif; ?>
        ...
        <?php if ( $nav_ct_show ) : ?>
        <a href="<?php echo esc_url( $nav_ct_url ); ?>" class="bowland-mobile-link"><?php echo esc_html( $nav_ct_label ); ?></a>
        <?php endif; ?>

      </div>

      <!-- Mobile CTAs -->
      <div class="bowland-mobile-cta">
        <a href="tel:<?php echo esc_attr( $phone_link ); ?>" class="bowland-mobile-cta-phone">
          <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
          <?php echo esc_html( $phone ); ?>
        </a>
