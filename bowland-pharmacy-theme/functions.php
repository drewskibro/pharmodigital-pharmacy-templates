...
function bowland_pharmacy_scripts() {
    ...
    wp_enqueue_script(
        ...
        BOWLAND_PHARMACY_ASSISTANT_URL,
        array(),
        BOWLAND_PHARMACY_ASSISTANT_VERSION,
        true
    );
}
 ...
 */
function bowland_pharmacy_ai_assistant_script_tag( $tag, $handle, $src ) {
    if ( 'bowland-pharmacy-ai-assistant' !== $handle ) {
        return $tag;
    }
    ...
    return sprintf(
        ...
        esc_url( $src ),
        esc_attr( BOWLAND_PHARMACY_ASSISTANT_SRI )
    );
}
...
if ( file_exists( BOWLAND_PHARMACY_DIR . '/inc/seo.php' ) ) {
    require_once BOWLAND_PHARMACY_DIR . '/inc/seo.php';
}
 ...
 */
function bowland_pharmacy_weight_loss_calculator_shortcode( $atts ) {
    $atts = shortcode_atts( array(
        'cta_url'  => '',
...
add_shortcode( 'weight_loss_calculator', 'bowland_pharmacy_weight_loss_calculator_shortcode' );
...
add_shortcode( 'mounjaro_calculator', 'bowland_pharmacy_weight_loss_calculator_shortcode' );
