// ============================================
// MENINGITIS ACWY VACCINATION PAGE JAVASCRIPT
// ============================================
...
function toggleFAQ(button) {
  const item = button.closest('.meningitis-acwy-faq-item');
  const isActive = item.classList.contains('travel-faq-active');

  // Close all FAQs
  document.querySelectorAll('.meningitis-acwy-faq-item').forEach(faq => {
