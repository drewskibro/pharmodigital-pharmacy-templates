...
$default_steps = array(
    ...
    array(
        ...
        'step_title'       => 'Speak to Our Team',
        'step_description' => 'One of our experienced pharmacists will review your consultation and get back to you the same day to talk through your options and answer any questions.',
        'step_time_icon'   => 'fa-clock',
        'step_time'        => 'Same day',
    ),
    array(
        'step_number'      => '3',
        'step_icon'        => 'fa-box',
        'step_title'       => 'We Take Care of the Rest',
        'step_description' => 'Whether you visit us in Wythenshawe or receive your medication delivered to your door, we make sure your care is fast, discreet and exactly right for you.',
