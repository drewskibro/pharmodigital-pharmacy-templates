...
$badge_text      = bp_field( 'healthhub_badge_text', 'Expert Advice' );
$title_start     = bp_field( 'healthhub_title_start', 'Latest from the' );
$title_highlight = bp_field( 'healthhub_title_highlight', 'Health Hub' );
$view_all_url    = bp_field( 'healthhub_view_all_url', home_url( '/health-hub/' ) );
$view_all_text   = bp_field( 'healthhub_view_all_text', 'View all articles' );
$read_article_text = bp_field( 'healthhub_read_article_text', 'Read Article' );
