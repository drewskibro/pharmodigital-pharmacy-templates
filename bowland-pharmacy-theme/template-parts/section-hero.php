...
$hero_image_focus = bp_field( 'hero_image_focus', 'center center' );
            ...
            <div class="hero-content">
                ...
                <div class="hero-actions hero-stagger hero-stagger-6">
                    ...
                    <a href="<?php echo esc_url( home_url( '/ear-wax-removal/' ) ); ?>" class="cta-button secondary-cta">
                        <?php echo esc_html( bp_field( 'hero_cta_ear_text', 'Ear Clinic' ) ); ?>
                        <i class="fas fa-ear-listen"></i>
                    </a>
                    <a href="<?php echo esc_url( home_url( '/blood-testing/' ) ); ?>" class="cta-button secondary-cta">
                        <?php echo esc_html( bp_field( 'hero_cta_blood_text', 'Blood Testing' ) ); ?>
