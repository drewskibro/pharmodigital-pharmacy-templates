...
// --- Testimonial ---
$testimonial_quote  = bp_field( 'hero_testimonial_quote', 'Incredible service from start to finish. Lost 6 stone with their support — couldn\'t recommend more!' );
$testimonial_author = bp_field( 'hero_testimonial_author', 'Sarah M.' );
$testimonial_result = bp_field( 'hero_testimonial_result', '6 Stone Lost' );
...
$hero_image_alt = $hero_image_id
    ...
    : 'Pharmacy services at ' . esc_attr( bp_pharmacy_name() );
