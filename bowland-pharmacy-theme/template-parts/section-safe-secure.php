...
$badge_text      = bp_field( 'safe_badge_text', 'GPhC Registered Pharmacy' );
$title_start     = bp_field( 'safe_title_start', 'Safe and' );
$title_highlight = bp_field( 'safe_title_highlight', 'Secure' );
$description     = bp_field( 'safe_description', 'Your safety is our top priority. We\'re fully regulated and inspected to ensure the highest standards of care.' );
