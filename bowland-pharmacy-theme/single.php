 ...
 *
 * Premium editorial layout with blue/green Bowland palette.
 *
...
if ( empty( $reviewer_avatar ) ) {
    $reviewer_image_id = bp_option( 'pharmacist_image' );
        ...
        <div class="article-fact-check-people">
          ...
          <div class="article-fact-check-person">
            ...
            <div class="article-fact-check-info">
              ...
              <?php endif; ?>
              <?php
              $reviewer_profile_url = bp_option( 'reviewer_profile_url', '' );
        ...
        <div class="rating-badge">
          ...
          <div class="rating-footer">
            <div class="rating-location">
              ...
              <span><?php echo esc_html( bp_option( 'pharmacy_town', 'Wythenshawe, UK' ) ); ?></span>
            </div>
