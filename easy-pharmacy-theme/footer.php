...
$instagram_url = ep_option( 'social_instagram', 'https://instagram.com' );
$twitter_url   = ep_option( 'social_twitter', 'https://twitter.com' );
...
$tagline = ep_option( 'footer_tagline', 'Your trusted partner in health and wellness across Ashford, Chertsey, and beyond.' );
?>
