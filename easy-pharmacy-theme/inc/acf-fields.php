...
function ep_register_acf_field_groups() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'name'          => 'pharmacy_email',
                'type'          => 'email',
                'default_value' => 'bookings@theeasyclinic.co.uk',
            ),
            array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'preview_size'  => 'medium',
                'library'       => 'all',
                'instructions'  => 'Lifestyle photo for this card. Recommended: 600x400px landscape. E.g. pharmacist reviewing a prescription.',
            ),
            array(
                ...
                'preview_size'  => 'medium',
                'library'       => 'all',
                'instructions'  => 'Lifestyle photo for this card. Recommended: 600x400px landscape. E.g. pharmacist in friendly consultation.',
            ),
            array(
                'key'           => 'field_ep_switching_feature_3_image',
                'label'         => 'Feature 3 Image (Zero Treatment Gap)',
                'name'          => 'switching_feature_3_image',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'library'       => 'all',
                'instructions'  => 'Lifestyle photo for this card. Recommended: 600x400px landscape. E.g. patient receiving medication package.',
            ),
            array(
                ...
                'sub_fields'   => array(
                    ...
                    array(
                        'key'          => 'field_ep_switching_feature_icon',
                        'label'        => 'Feature Icon',
                        'name'         => 'feature_icon',
                        'type'         => 'text',
                        'instructions' => 'Font Awesome class, e.g. "fas fa-prescription". Leave blank to use the feature image instead.',
                    ),
                    array(
                        ...
                        'library'       => 'all',
                        'instructions'  => 'Lifestyle photo for this feature card. Recommended: 600x400px. Used when no icon is set.',
                    ),
                ),
            ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_ep_th_hero_title_line1', 'label' => 'Title Line 1 (gradient)', 'name' => 'th_hero_title_line1', 'type' => 'text', 'default_value' => 'Travel Safe.' ),
            array( 'key' => 'field_ep_th_hero_title_line2', 'label' => 'Title Line 2 (accent)', 'name' => 'th_hero_title_line2', 'type' => 'text', 'default_value' => 'Stay Protected.' ),
            array( 'key' => 'field_ep_th_hero_title_line3', 'label' => 'Title Line 3 (gradient)', 'name' => 'th_hero_title_line3', 'type' => 'text', 'default_value' => 'Fly Happy.' ),
            ...
            array( 'key' => 'field_ep_th_hero_image', 'label' => 'Hero Image', 'name' => 'th_hero_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'instructions' => 'Main hero image. Falls back to pharmacist image from Pharmacy Settings.' ),
            array( 'key' => 'field_ep_th_hero_image_alt', 'label' => 'Hero Image Alt Text', 'name' => 'th_hero_image_alt', 'type' => 'text', 'default_value' => 'Travel health consultation at Easy Pharmacy' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'                => array(
            ...
            array(
                ...
                'type'          => 'text',
                'default_value' => 'Or email bookings@theeasyclinic.co.uk to book your appointment. Same-day consultations available.',
            ),
        ),
        'location'              => $sc_location,
        'menu_order'            => 8,
    ...
    acf_add_local_field_group( array(
        ...
        'fields'                => array(
            ...
            array(
                ...
                'type'          => 'textarea',
                'rows'          => 2,
                'default_value' => 'Or email bookings@theeasyclinic.co.uk to book. Same-day appointments available.',
            ),
            array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_ep_mal_cta_supporting', 'label' => 'Supporting Text', 'name' => 'mal_cta_supporting', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Or email bookings@theeasyclinic.co.uk to book your travel health consultation. Ask about our travel health services including altitude sickness prevention and travel vaccinations.' ),
        ),
        'location'              => $mal_location,
        'menu_order'            => 35,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                'key'           => 'field_ep_ews_team_jignasa_image',
                'label'         => 'Team Photo — Jignasa Modhvadia',
                'name'          => 'ews_team_jignasa_image',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'instructions'  => 'Square crop recommended (e.g. 600×600px). Upload a photo of Jignasa Modhvadia.',
            ),
            array(
                'key'           => 'field_ep_ews_team_baljender_image',
                'label'         => 'Team Photo — Baljender Nagi',
                'name'          => 'ews_team_baljender_image',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'instructions'  => 'Square crop recommended (e.g. 600×600px). Upload a photo of Baljender Nagi.',
            ),
        ),
