      ...
      <div class="rabies-protect-image-wrapper">
        <div class="rabies-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(ep_field('vaccine_protect_image_alt', 'Travel health consultation for rabies')); ?>" class="rabies-protect-image" />
          <?php endif; ?>
    ...
    <div class="rabies-about-content-grid">
      <div class="rabies-about-image-wrapper">
        <div class="rabies-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(ep_field('vaccine_about_image_alt', 'Stray dog in travel destination')); ?>" />
          <?php endif; ?>
        </div>
      </div>
