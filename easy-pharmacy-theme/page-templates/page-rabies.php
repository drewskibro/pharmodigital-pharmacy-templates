...
$prefix = 'rabies';
$vaccine_name = ep_field('vaccine_name', 'Rabies');
?>
...
<section class="rabies-hero-section">
  ...
  <div class="section-container">
    <div class="rabies-hero-content">
      ...
      <span class="rabies-hero-label"><?php echo esc_html(ep_field('vaccine_hero_label', 'TRAVEL HEALTH PROTECTION')); ?></span>

      <h1 class="rabies-hero-title"><?php echo esc_html(ep_field('vaccine_hero_title', 'Rabies Vaccination<br>Service in Ashford')); ?></h1>

      <p class="rabies-hero-description">
        <?php echo esc_html(ep_field('vaccine_hero_description', 'Protect yourself against rabies with our expert travel health service. Essential for travel to high-risk areas in Asia, Africa, and South America.')); ?>
      </p>

      <div class="rabies-hero-actions">
        <a href="<?php echo esc_url(ep_field('vaccine_cta_url', '/book-travel-clinic/')); ?>" class="cta-button rabies-btn-primary">
          <?php echo esc_html(ep_field('vaccine_cta_text', 'Book Rabies Vaccination')); ?>
        </a>
        <a href="tel:<?php echo esc_attr(ep_field('vaccine_phone', '01784255222')); ?>" class="cta-button rabies-btn-secondary">
...
<section class="rabies-protect-section">
  <div class="section-container">
    <div class="rabies-protect-header">
      ...
      <h2 class="rabies-protect-title"><?php echo esc_html(ep_field('vaccine_protect_title', 'Understanding Rabies Risk')); ?></h2>
      <p class="rabies-protect-desc"><?php echo esc_html(ep_field('vaccine_protect_desc', 'A serious viral infection spread by infected animals')); ?></p>
    </div>

    <div class="rabies-protect-grid">
      <div class="rabies-protect-image-wrapper">
        <div class="rabies-protect-image-card">
          <img src="<?php echo esc_url(ep_field('vaccine_protect_image', 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=800&h=1000&fit=crop')); ?>" alt="<?php echo esc_attr(ep_field('vaccine_protect_image_alt', 'Travel health consultation for rabies')); ?>" class="rabies-protect-image" />
      ...
      <div class="rabies-protect-content">
        ...
        <h3 class="rabies-protect-subtitle"><?php echo esc_html(ep_field('vaccine_protect_subtitle', 'Why Vaccination is Critical')); ?></h3>
        <p class="rabies-protect-text"><?php echo esc_html(ep_field('vaccine_protect_text', 'Rabies is a viral infection of the brain and nerves. It is almost always fatal once symptoms appear. Vaccination provides vital protection and simplifies treatment if you are bitten or scratched by an animal abroad.')); ?></p>
...
<section class="rabies-about-section">
  <div class="section-container">
    <div class="rabies-about-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html(ep_field('vaccine_about_badge', 'KNOW THE RISKS')); ?></span>
      </div>
      <h2 class="rabies-about-title"><?php echo esc_html(ep_field('vaccine_about_title', 'What is Rabies?')); ?></h2>
      <p class="rabies-about-desc"><?php echo esc_html(ep_field('vaccine_about_desc', 'Understanding transmission and prevention')); ?></p>
    </div>

    <div class="rabies-about-content-grid">
      <div class="rabies-about-image-wrapper">
        <div class="rabies-about-image-card">
          <img src="<?php echo esc_url(ep_field('vaccine_about_image', 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=800&h=1000&fit=crop')); ?>" alt="<?php echo esc_attr(ep_field('vaccine_about_image_alt', 'Stray dog in travel destination')); ?>" />
        </div>
      </div>
    ...
    <div class="rabies-about-callout">
      <div class="badge"><?php echo esc_html(ep_field('vaccine_callout_badge', 'CRITICAL WARNING')); ?></div>
      <h3><?php echo esc_html(ep_field('vaccine_callout_title', '100% Fatal Once Symptoms Appear')); ?></h3>
      <p><?php echo esc_html(ep_field('vaccine_callout_text', 'Rabies is almost always fatal once symptoms develop. Vaccination is your best defence. If you are bitten or scratched by an animal abroad, seek medical help immediately, even if you have been vaccinated.')); ?></p>
    </div>
  </div>
</section>
...
<section class="rabies-needs-section">
  <div class="section-container">
    <div class="rabies-needs-header">
      ...
      <h2 class="rabies-needs-title"><?php echo esc_html(ep_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="rabies-needs-desc"><?php echo esc_html(ep_field('vaccine_needs_desc', 'Recommended for many travellers to risk areas')); ?></p>
    </div>
...
<section class="rabies-risk-section">
  <div class="section-container">
    <div class="rabies-risk-header">
      ...
      <h2 class="rabies-risk-title"><?php echo esc_html(ep_field('vaccine_risk_title', 'Where is Rabies found?')); ?></h2>
      <p class="rabies-risk-desc"><?php echo esc_html(ep_field('vaccine_risk_desc', 'Rabies is present on all continents except Antarctica, but over 95% of human deaths occur in Asia and Africa.')); ?></p>
    </div>
...
<section class="rabies-details-section">
  <div class="section-container">
    <div class="rabies-details-header">
      ...
      <h2 class="rabies-details-title"><?php echo esc_html(ep_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="rabies-details-desc"><?php echo esc_html(ep_field('vaccine_details_desc', 'Simple, straightforward vaccination process at our Ashford clinic')); ?></p>
    </div>
...
<section class="rabies-faq-section">
  <div class="section-container">
    <div class="rabies-faq-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html(ep_field('vaccine_faq_badge', 'RABIES FAQs')); ?></span>
      </div>
      <h2 class="rabies-faq-title"><?php echo esc_html(ep_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<section class="rabies-cta-section">
  ...
  <div class="section-container">
    <div class="rabies-cta-content">
      ...
      <h2 class="rabies-cta-title"><?php echo esc_html(ep_field('vaccine_cta_title', 'Protect your health while travelling')); ?></h2>
      <p class="rabies-cta-desc"><?php echo esc_html(ep_field('vaccine_cta_desc', 'Book your Rabies vaccination with our expert team today. Quick, convenient, and professional service in Ashford.')); ?></p>
