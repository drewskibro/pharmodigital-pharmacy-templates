    ...
    <div class="book-hero-grid">
      ...
      <div class="book-hero-content">
        <div class="section-badge">
          ...
          <span class="section-badge-text"><?php echo esc_html(ep_field('book_hero_badge', 'ONLINE BOOKING AVAILABLE')); ?></span>
        </div>

        <h1 class="book-hero-title">
          <?php echo wp_kses_post(ep_field('book_hero_title', 'Book Your <br /><span class="gradient-text">Appointment</span>')); ?>
        </h1>

        <p class="book-hero-description">
          <?php echo esc_html(ep_field('book_hero_description', 'Choose your service below and find a time that suits you with our expert Ashford team. Same-day appointments often available.')); ?>
        </p>

        <div class="book-hero-actions">
          <button onclick="scrollToBooking()" class="cta-button primary-cta">
            <?php echo esc_html(ep_field('book_hero_cta_text', 'Book Now')); ?>
...
<section class="book-services-section">
  <div class="section-container">
    <div class="book-services-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html(ep_field('book_services_badge', 'PRIORITY SERVICES')); ?></span>
      </div>
      <h2 class="book-services-title"><?php echo esc_html(ep_field('book_services_title', 'Most Popular Services')); ?></h2>
...
<section class="book-services-additional-section">
  <div class="section-container">
    <div class="book-services-header">
      <div class="section-badge">
        <span class="section-badge-text"><?php echo esc_html(ep_field('book_additional_badge', 'ESSENTIAL HEALTHCARE')); ?></span>
      </div>
      <h2 class="book-services-title"><?php echo esc_html(ep_field('book_additional_title', 'Everyday Health Services')); ?></h2>
    </div>
...
<section class="book-amelia-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="book-amelia-header">
      <h2 class="book-amelia-title"><?php echo esc_html(ep_field('book_amelia_title', 'Select Your Appointment Time')); ?></h2>
      <p class="book-amelia-description"><?php echo esc_html(ep_field('book_amelia_description', 'Choose a convenient time with our Ashford healthcare team')); ?></p>
    </div>

    <div class="book-amelia-container">
      <?php
      $amelia_shortcode = ep_field('book_amelia_shortcode', '[ameliabooking]');
      echo do_shortcode($amelia_shortcode);
      ?>
    </div>

    <div class="book-amelia-footer">
      <p>Can't find a suitable time? Call us on <a href="tel:<?php echo esc_attr(ep_phone_link()); ?>"><?php echo esc_html(ep_phone()); ?></a></p>
    </div>
  </div>
</section>
...
<section class="book-testimonials-section">
  <div class="section-container">
    <div class="book-testimonials-header">
      <h2 class="book-testimonials-title"><?php echo esc_html(ep_field('book_testimonials_title', 'What Our Patients Say')); ?></h2>
    ...
    <div class="book-testimonials-grid">
      ...
      <?php endwhile; else : ?>
        ...
        <div class="book-testimonial-card">
          <div class="star-row"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
          <p class="book-testimonial-quote">"I travel 40 miles every month to see the team for my weight loss consultations &ndash; they're that good. Would never go anywhere else. The support has been incredible."</p>
          <div class="book-testimonial-author">
...
<section class="book-faq-section">
  <div class="section-container">
    <div class="book-faq-header">
      <div class="section-badge">
        <span class="section-badge-text"><?php echo esc_html(ep_field('book_faq_badge', 'EVERYTHING YOU NEED TO KNOW')); ?></span>
      </div>
      <h2 class="book-faq-title"><?php echo esc_html(ep_field('book_faq_title', 'Common Questions')); ?></h2>
      <p class="book-faq-description"><?php echo esc_html(ep_field('book_faq_description', 'Clear answers about our services, location, and team to help you book with confidence.')); ?></p>
    </div>
    ...
    <div class="book-faq-list">
      ...
      <?php endwhile; else : ?>
        <div class="book-faq-item">
          <button class="book-faq-btn" onclick="toggleFAQ(this)"><div class="book-faq-left"><span class="book-faq-number">01</span><span class="book-faq-question">Is there free parking at your Ashford clinic?</span></div><div class="book-faq-icon"><i class="fas fa-plus"></i></div></button>
          <div class="book-faq-answer"><p>Yes, absolutely. We have free parking available directly outside our clinic. Our location is easily accessible from all parts of Ashford and Surrey, making your visit stress-free and convenient.</p></div>
        </div>
        <div class="book-faq-item">
        ...
        <div class="book-faq-item">
          ...
          <div class="book-faq-answer"><p>You will see Dilip Modhvadia or one of our expert clinical team members. Dilip is a GPhC Registered Pharmacist with over 30 years of experience serving the Ashford community. You'll see the same friendly face for your follow-ups, ensuring continuity of care.</p></div>
        </div>
        <div class="book-faq-item">
        ...
        <div class="book-faq-item">
          <button class="book-faq-btn" onclick="toggleFAQ(this)"><div class="book-faq-left"><span class="book-faq-number">05</span><span class="book-faq-question">Why do so many Ashford patients choose you?</span></div><div class="book-faq-icon"><i class="fas fa-plus"></i></div></button>
          <div class="book-faq-answer"><p>We combine clinical expertise with genuine warmth. Plus, we're a local independent pharmacy that has been part of the Ashford community for decades — we truly care about your health outcomes. Our patients appreciate the personal care you can't get from large chains.</p></div>
        </div>
        <div class="book-faq-item">
