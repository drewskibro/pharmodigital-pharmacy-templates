...
<div class="yellowfever-breadcrumb">
  <div class="section-container">
    ...
    <a href="<?php echo esc_url( ep_field( 'yf_parent_url', home_url( '/travel-health/' ) ) ); ?>">Travel Health</a>
    <span class="separator">/</span>
...
<section class="yellowfever-hero-section">
  ...
  <div class="section-container">
    <div class="yellowfever-hero-content">
      ...
      <span class="yellowfever-hero-label"><?php echo esc_html( ep_field( 'yf_hero_label', 'OFFICIAL YELLOW FEVER CENTRE' ) ); ?></span>

      <h1 class="yellowfever-hero-title"><?php echo esc_html( ep_field( 'yf_hero_title', 'Yellow Fever Vaccination Service in Ashford' ) ); ?></h1>

      <p class="yellowfever-hero-description">
        <?php echo esc_html( ep_field( 'yf_hero_description', 'We are an official NHS Yellow Fever Vaccination Centre. Get your vaccination and International Certificate of Vaccination (ICVP) at Easy Pharmacy Ashford.' ) ); ?>
      </p>

      <div class="yellowfever-hero-actions">
        <a href="<?php echo esc_url( ep_field( 'yf_hero_cta_url', '' ) ?: ep_booking_url() ); ?>" class="cta-button yellowfever-btn-primary">
          <?php echo esc_html( ep_field( 'yf_hero_cta_text', 'Book Yellow Fever Vaccination' ) ); ?>
        </a>
        <a href="tel:<?php echo esc_attr( ep_phone_link() ); ?>" class="cta-button yellowfever-btn-secondary">
  ...
  <div class="section-container">
    <div class="yellowfever-cert-header">
      <div class="section-badge">
        ...
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_cert_badge', 'OFFICIAL CENTRE' ) ); ?></span>
      </div>
      <h2 class="yellowfever-cert-title"><?php echo esc_html( ep_field( 'yf_cert_title', 'Designated Yellow Fever Vaccination Centre' ) ); ?></h2>
      <p class="yellowfever-cert-desc"><?php echo esc_html( ep_field( 'yf_cert_desc', 'Authorised to administer yellow fever vaccinations and issue international certificates' ) ); ?></p>
    </div>
    ...
    <div class="yellowfever-cert-grid">
      ...
      <div class="yellowfever-cert-image-wrapper">
        <div class="yellowfever-cert-image-card">
          <?php
          $cert_image_id = ep_field( 'yf_cert_image' );
          ...
          <div class="yellowfever-cert-name-tag">
            <span class="name"><?php echo esc_html( ep_field( 'yf_cert_nametag_name', 'Dilip Sherathia' ) ); ?></span>
            <span class="role"><?php echo esc_html( ep_field( 'yf_cert_nametag_role', 'Lead Pharmacist & Yellow Fever Specialist' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="yellowfever-cert-content">
        <div class="yellowfever-cert-badge-box">
          ...
          <span><?php echo esc_html( ep_field( 'yf_cert_highlight', 'NHS Designated Yellow Fever Centre' ) ); ?></span>
        </div>

        <h3 class="yellowfever-cert-subtitle"><?php echo esc_html( ep_field( 'yf_cert_subtitle', 'Why Choose Our Centre' ) ); ?></h3>
        <p class="yellowfever-cert-text"><?php echo esc_html( ep_field( 'yf_cert_text', 'As an officially designated Yellow Fever Vaccination Centre, we are authorised by NaTHNaC to administer the Stamaril vaccine and issue the International Certificate of Vaccination or Prophylaxis (ICVP). Our lead pharmacist has specialist training in travel health.' ) ); ?></p>
        ...
        <div class="yellowfever-cert-actions">
          <a href="<?php echo esc_url( ep_field( 'yf_cert_cta_url', '' ) ?: ep_booking_url() ); ?>" class="cta-button primary-cta">Book Appointment</a>
        ...
        <div class="yellowfever-cert-callout">
          <div class="header">
            <span class="badge"><?php echo esc_html( ep_field( 'yf_cert_callout_badge', 'IMPORTANT' ) ); ?></span>
            <h4><?php echo esc_html( ep_field( 'yf_cert_callout_title', '10-Day Validity Rule' ) ); ?></h4>
          </div>
          <p><?php echo esc_html( ep_field( 'yf_cert_callout_text', 'Your yellow fever certificate becomes valid 10 days after vaccination. Please ensure you are vaccinated at least 10 days before entering a country that requires proof of vaccination.' ) ); ?></p>
          <p class="note"><?php echo esc_html( ep_field( 'yf_cert_callout_note', 'Once valid, the certificate provides lifelong proof of vaccination.' ) ); ?></p>
        </div>
      </div>
    </div>
  </div>
...
<section class="yellowfever-about-section">
  <div class="section-container">
    <div class="yellowfever-about-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_about_badge', 'ABOUT THE DISEASE' ) ); ?></span>
      </div>
      <h2 class="yellowfever-about-title"><?php echo esc_html( ep_field( 'yf_about_title', 'What is Yellow Fever?' ) ); ?></h2>
      <p class="yellowfever-about-desc"><?php echo esc_html( ep_field( 'yf_about_desc', 'A serious viral infection spread by mosquitoes in tropical regions' ) ); ?></p>
    </div>
    ...
    <div class="yellowfever-about-content-grid">
      ...
      <div class="yellowfever-about-image-wrapper">
        <div class="yellowfever-about-image-card">
          <?php
          $about_image_id = ep_field( 'yf_about_image' );
    ...
    <div class="yellowfever-about-callout">
      <div class="badge"><?php echo esc_html( ep_field( 'yf_about_callout_badge', 'SERIOUS RISK' ) ); ?></div>
      <h3><?php echo esc_html( ep_field( 'yf_about_callout_title', 'Up to 50% Fatality Rate in Severe Cases' ) ); ?></h3>
      <p><?php echo esc_html( ep_field( 'yf_about_callout_text', 'Yellow Fever can be fatal. There is no antiviral treatment. Vaccination provides the best protection and is required for entry to many countries. A single dose gives lifelong protection for most travellers.' ) ); ?></p>
    </div>
  </div>
</section>
...
<section class="yellowfever-needs-section">
  <div class="section-container">
    <div class="yellowfever-needs-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_needs_badge', 'WHO NEEDS VACCINATION' ) ); ?></span>
      </div>
      <h2 class="yellowfever-needs-title"><?php echo esc_html( ep_field( 'yf_needs_title', 'Do You Need the Yellow Fever Vaccine?' ) ); ?></h2>
      <p class="yellowfever-needs-desc"><?php echo esc_html( ep_field( 'yf_needs_desc', 'Required or recommended depending on your destination' ) ); ?></p>
    </div>
    ...
    <div class="yellowfever-needs-info">
      ...
      <span><?php echo esc_html( ep_field( 'yf_needs_info', 'Not sure if you need the vaccine? Book a consultation and we\'ll check your destination requirements.' ) ); ?></span>
    </div>
  </div>
</section>
...
<section class="yellowfever-risk-section">
  <div class="section-container">
    <div class="yellowfever-risk-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_risk_badge', 'RISK COUNTRIES' ) ); ?></span>
      </div>
      <h2 class="yellowfever-risk-title"><?php echo esc_html( ep_field( 'yf_risk_title', 'Yellow Fever Risk Countries' ) ); ?></h2>
      <p class="yellowfever-risk-desc"><?php echo esc_html( ep_field( 'yf_risk_desc', 'Yellow Fever is found in tropical regions of Africa and South America. Check if your destination requires vaccination.' ) ); ?></p>
    </div>
    ...
    <div class="yellowfever-risk-callout">
      <div class="content">
        <h3><?php echo esc_html( ep_field( 'yf_risk_callout_title', 'Not Sure About Your Destination?' ) ); ?></h3>
        <p><?php echo esc_html( ep_field( 'yf_risk_callout_text', 'Yellow Fever requirements change regularly. Our pharmacist will check the latest country-by-country requirements and advise whether you need the vaccine for your specific trip.' ) ); ?></p>
        <div class="badges">
    ...
    <div class="yellowfever-risk-footer">
      <div class="info-badge">
        ...
        <?php echo esc_html( ep_field( 'yf_risk_footer_text', "Unsure about your destination? We'll check the latest requirements for you." ) ); ?>
      </div>
      <div class="actions">
        <a href="<?php echo esc_url( ep_field( 'yf_risk_cta_url', '' ) ?: ep_booking_url() ); ?>" class="cta-button yellow-btn">Book Consultation</a>
        <a href="tel:<?php echo esc_attr( ep_phone_link() ); ?>" class="cta-button outline-btn">Call <?php echo esc_html( ep_phone() ); ?></a>
      </div>
    </div>
  </div>
</section>
...
<section class="yellowfever-details-section">
  <div class="section-container">
    <div class="yellowfever-details-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_details_badge', 'YOUR APPOINTMENT' ) ); ?></span>
      </div>
      <h2 class="yellowfever-details-title"><?php echo esc_html( ep_field( 'yf_details_title', 'What to Expect at Your Appointment' ) ); ?></h2>
      <p class="yellowfever-details-desc"><?php echo esc_html( ep_field( 'yf_details_desc', 'Simple, straightforward vaccination process at our Ashford clinic' ) ); ?></p>
    </div>

    <!-- Hero Image -->
    <div class="yellowfever-details-hero-image">
      <?php
      $details_image_id = ep_field( 'yf_details_image' );
...
<section class="yellowfever-faq-section">
  <div class="section-container">
    <div class="yellowfever-faq-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'yf_faq_badge', 'YELLOW FEVER FAQs' ) ); ?></span>
      </div>
      <h2 class="yellowfever-faq-title"><?php echo esc_html( ep_field( 'yf_faq_title', 'Common Questions' ) ); ?></h2>
      <p class="yellowfever-faq-desc"><?php echo esc_html( ep_field( 'yf_faq_desc', 'Everything you need to know about Yellow Fever vaccination' ) ); ?></p>
    </div>
...
<section class="yellowfever-cta-section">
  ...
  <div class="section-container">
    <div class="yellowfever-cta-content">
      ...
      <h2 class="yellowfever-cta-title"><?php echo esc_html( ep_field( 'yf_cta_title', 'Get your Yellow Fever vaccination and certificate' ) ); ?></h2>
      <p class="yellowfever-cta-desc"><?php echo esc_html( ep_field( 'yf_cta_desc', 'Book your Yellow Fever vaccination at our official centre in Ashford. Certificate issued on the day.' ) ); ?></p>

      <div class="yellowfever-cta-actions">
        <a href="<?php echo esc_url( ep_field( 'yf_cta_primary_url', '' ) ?: ep_booking_url() ); ?>" class="cta-button primary-cta white-btn"><?php echo esc_html( ep_field( 'yf_cta_primary_text', 'Book Vaccination' ) ); ?></a>
