    ...
    <div class="kenya-hero-grid">
      ...
      <div class="kenya-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( ep_field( 'ke_hero_badge', 'KENYA TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( ep_field( 'ke_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( ep_field( 'ke_hero_title_highlight', 'Kenya' ) ); ?></span>
        </h1>

        <p class="kenya-hero-description">
          <?php echo esc_html( ep_field( 'ke_hero_description', 'Expert advice and vaccinations for your Kenya safari or holiday. Yellow Fever, Malaria, and more. Get protected with Ashford\'s specialists.' ) ); ?>
        </p>

        <div class="kenya-hero-actions">
          <a href="<?php echo esc_url( ep_field( 'ke_hero_cta_url', ep_booking_url() ) ); ?>" class="cta-button primary-cta kenya-hero-btn-primary">
            <?php echo esc_html( ep_field( 'ke_hero_cta_text', 'Book Kenya Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( ep_phone_link() ); ?>" class="cta-button secondary-cta kenya-hero-btn-secondary">
...
<section class="kenya-vaccines-section">
  <div class="section-container">
    <div class="kenya-vaccines-header">
      <h2 class="kenya-vaccines-title"><?php echo esc_html( ep_field( 'ke_vaccines_title', 'Protect yourself in Kenya' ) ); ?></h2>
      <div class="kenya-vaccines-divider"></div>
      <p class="kenya-vaccines-description"><?php echo esc_html( ep_field( 'ke_vaccines_description', 'These vaccinations are recommended for most travellers to Kenya' ) ); ?></p>
    </div>
    ...
    <div class="kenya-malaria-layout">
      ...
      <div class="kenya-malaria-visual">
        <div class="kenya-malaria-image-card">
          <?php
          $malaria_image_id = ep_field( 'ke_malaria_image' );
          ...
          <div class="kenya-malaria-badge">
            ...
            <span class="kenya-malaria-badge-text"><?php echo esc_html( ep_field( 'ke_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="kenya-malaria-content">
        <div class="section-badge">
          <span class="pulse-dot"><span></span><span></span></span>
          <span class="section-badge-text"><?php echo esc_html( ep_field( 'ke_malaria_badge', 'HIGH RISK AREA' ) ); ?></span>
        </div>

        <h2 class="kenya-malaria-title"><?php echo esc_html( ep_field( 'ke_malaria_title', 'Malaria Risk in Kenya' ) ); ?></h2>
        <p class="kenya-malaria-intro">
          <?php echo esc_html( ep_field( 'ke_malaria_intro', 'Malaria risk is high throughout most of Kenya, including safari parks. Antimalarials are usually recommended.' ) ); ?>
        </p>
        ...
        <div class="kenya-malaria-actions">
          <a href="<?php echo esc_url( ep_field( 'ke_hero_cta_url', ep_booking_url() ) ); ?>" class="cta-button primary-cta">
            Check Your Risk
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
...
<section class="kenya-health-section">
  <div class="section-container">
    <div class="kenya-health-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( ep_field( 'ke_health_badge', 'HEALTH ADVICE' ) ); ?></span>
      </div>
      <h2 class="kenya-health-title"><?php echo esc_html( ep_field( 'ke_health_title', 'Stay healthy in Kenya' ) ); ?></h2>
      <p class="kenya-health-subtitle"><?php echo esc_html( ep_field( 'ke_health_subtitle', 'Essential tips for a safe safari' ) ); ?></p>
    </div>
...
<section class="kenya-cta-section">
  ...
  <div class="section-container">
    <div class="kenya-cta-content">
      <h2 class="kenya-cta-title"><?php echo esc_html( ep_field( 'ke_cta_title', 'Ready for your Kenya safari?' ) ); ?></h2>
      <p class="kenya-cta-description">
        <?php echo esc_html( ep_field( 'ke_cta_description', 'Book your travel health consultation at our Ashford clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
      <div class="kenya-cta-actions">
        <a href="<?php echo esc_url( ep_field( 'ke_cta_primary_url', ep_booking_url() ) ); ?>" class="cta-button primary-cta kenya-cta-button-white">
          <?php echo esc_html( ep_field( 'ke_cta_primary_text', 'Book Kenya Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( ep_phone_link() ); ?>" class="cta-button secondary-cta kenya-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( ep_phone() ); ?>
        </a>
      </div>
      <div class="kenya-cta-checks">
        <div class="kenya-cta-check">
          ...
          <span><?php echo esc_html( ep_field( 'ke_cta_check_1', 'Travel Ready' ) ); ?></span>
        </div>
        <div class="kenya-cta-check">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( ep_field( 'ke_cta_check_2', 'Expert Advice' ) ); ?></span>
        </div>
        <div class="kenya-cta-check">
          <i class="fas fa-shield-virus"></i>
          <span><?php echo esc_html( ep_field( 'ke_cta_check_3', 'All Vaccines' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
