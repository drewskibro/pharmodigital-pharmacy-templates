...
$default_sv_links = array(
    ...
    array( 'label' => 'Register with Us',    'description' => 'Sign up for free prescription management',  'icon' => 'fas fa-user-plus',            'url' => home_url( '/nhs-prescriptions/register/' ) ),
  ...
  <nav class="denton-nav">
    ...
    <div class="denton-nav-top">
      <div class="denton-container">
        ...
        <div class="denton-top-actions">
          ...
          <a href="<?php echo esc_url( home_url( '/nhs-prescriptions/register/' ) ); ?>" class="denton-top-link denton-top-link--nhs">
    ...
    <div class="denton-mobile-menu" id="denton-mobile-menu">
      ...
      <div class="denton-mobile-cta">
        ...
        <a href="<?php echo esc_url( home_url( '/nhs-prescriptions/register/' ) ); ?>" class="denton-mobile-cta-nhs">NHS Nominate</a>
