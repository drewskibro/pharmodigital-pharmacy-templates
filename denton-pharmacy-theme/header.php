...
$patient_portal_register_url = dp_option( 'patient_register_url', 'https://app.deltera.cloud/register?uid=1767525519-9962720033-1165713653-1322157098-6129109416' );
$patient_portal_login_url    = dp_option( 'patient_login_url', 'https://app.deltera.cloud/login' );
...
// ---------------------------------------------------------------------------
if ( ! function_exists( 'dp_nav_url' ) ) {
    function dp_nav_url( $field_name, $fallback_slug ) {
        $url = dp_option( $field_name );
...
// ---------------------------------------------------------------------------
$nav_home_show  = dp_option( 'nav_home_show', '1' );
$nav_home_label = dp_option( 'nav_home_label', 'Home' );
$nav_home_url   = dp_nav_url( 'nav_home_url', '/' );

$nav_wl_show  = dp_option( 'nav_weight_loss_show', '1' );
$nav_wl_label = dp_option( 'nav_weight_loss_label', 'Weight Loss' );
$nav_wl_url   = dp_nav_url( 'nav_weight_loss_url', '/weight-loss/' );
...
$nav_ps_show  = dp_option( 'nav_private_services_show', '1' );
$nav_ps_label = dp_option( 'nav_private_services_label', 'Private Services' );
$nav_ps_url   = dp_nav_url( 'nav_private_services_url', '/weight-loss/' );
...
// ---------------------------------------------------------------------------
$wl_links    = dp_option( 'nav_dd_wl_links' );
$th_services = dp_option( 'nav_dd_th_services' );
$th_dests    = dp_option( 'nav_dd_th_destinations' );
$sv_links    = dp_option( 'nav_dd_services_links' );
$ps_links    = dp_option( 'nav_dd_private_services_links' );
...
$default_wl_links = array(
    ...
    array( 'label' => 'Switching Provider',     'description' => 'Already on treatment? Switch your care to us',     'icon' => 'fas fa-user',         'url' => home_url( '/switch-provider/' ) ),
...
$default_th_services = array(
    ...
    array( 'label' => 'Yellow Fever Centre', 'description' => 'Official certificates for Africa & South America',  'icon' => 'fas fa-sun',             'url' => 'https://stg-dentonpharmacy-staging.kinsta.cloud/yellow-fever-manchester/' ),
...
$default_sv_links = array(
    ...
    array( 'label' => 'Register with Us',    'description' => 'Sign up for free prescription management',  'icon' => 'fas fa-user-plus',            'url' => home_url( '/nominate-denton-pharmacy/' ) ),
...
$ps_vaccines = dp_option( 'nav_dd_private_services_vaccines' );
  ...
  <nav class="denton-nav">
    ...
    <div class="denton-nav-top">
      <div class="denton-container">
        ...
        <div class="denton-top-actions">
          ...
          <a href="<?php echo esc_url( home_url( '/nominate-denton-pharmacy/' ) ); ?>" class="denton-top-link denton-top-link--nhs">
          ...
          <a href="<?php echo esc_url( $patient_portal_register_url ); ?>" class="denton-portal-btn denton-portal-btn--register" target="_blank" rel="noopener noreferrer">
          ...
          <a href="<?php echo esc_url( $patient_portal_login_url ); ?>" class="denton-portal-btn denton-portal-btn--login" target="_blank" rel="noopener noreferrer">
    ...
    <div class="denton-nav-bottom">
      <div class="denton-container">
        <div class="denton-desktop-menu">
            ...
            <div class="denton-dropdown">
              ...
              <div class="denton-dropdown-content">
                <?php foreach ( $wl_links as $link ) :
                  ...
                  $icon = ! empty( $link['icon'] ) ? dp_fa_class( $link['icon'] ) : 'fas fa-check-circle';
                ?>
              ...
              <div class="denton-dropdown-row">
                <div class="denton-dropdown-col">
                  ...
                  <?php foreach ( $th_services as $link ) :
                    ...
                    $icon = ! empty( $link['icon'] ) ? dp_fa_class( $link['icon'] ) : 'fas fa-syringe';
                  ?>
                  <a href="<?php echo esc_url( $href ); ?>" class="denton-dropdown-link">
                    <div class="denton-link-icon"><i class="<?php echo esc_attr( $icon ); ?>"></i></div>
                    <div class="denton-link-text">
            ...
            <div class="denton-dropdown">
              ...
              <div class="denton-dropdown-content">
                <?php foreach ( $sv_links as $link ) :
                  ...
                  $icon = ! empty( $link['icon'] ) ? dp_fa_class( $link['icon'] ) : 'fas fa-stethoscope';
                ?>
                <a href="<?php echo esc_url( $href ); ?>" class="denton-dropdown-link">
                  <div class="denton-link-icon"><i class="<?php echo esc_attr( $icon ); ?>"></i></div>
                  <div class="denton-link-text">
          ...
          <?php if ( $nav_ps_show ) : ?>
          <div class="denton-menu-item denton-ps-menu">
            <button class="denton-menu-btn">
            ...
            <div class="denton-dropdown wide">
              ...
              <div class="denton-dropdown-row">
                ...
                <div class="denton-dropdown-col bg-gray">
                  <div class="denton-menu-section-title">Vaccinations</div>
                  <?php foreach ( $ps_vaccines as $vax ) :
                    $href = ! empty( $vax['url'] ) ? $vax['url'] : $nav_ps_url;
                    $icon = ! empty( $vax['icon'] ) ? dp_fa_class( $vax['icon'] ) : 'fas fa-shield-virus';
                  ?>
                  <a href="<?php echo esc_url( $href ); ?>" class="denton-dropdown-link denton-dropdown-link--compact">
                    <div class="denton-link-icon"><i class="<?php echo esc_attr( $icon ); ?>"></i></div>
                    <div class="denton-link-text">
              ...
              <div class="denton-dropdown-footer">
                <a href="<?php echo esc_url( $nav_pr_url ); ?>" class="denton-footer-link">
                  View all prices
                  <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
                </a>
              </div>
    ...
    <div class="denton-mobile-menu" id="denton-mobile-menu">
      ...
      <div class="denton-mobile-nav">
        ...
        <div class="denton-mobile-accordion">
          ...
          <div class="denton-mobile-accordion-content">
            ...
            <a href="<?php echo esc_url( $href ); ?>" class="denton-mobile-sub-link"><?php echo esc_html( $link['label'] ); ?></a>
            <?php endforeach; ?>
            <div class="denton-mobile-sub-heading">Vaccinations</div>
            <?php foreach ( $ps_vaccines as $vax ) :
              $href = ! empty( $vax['url'] ) ? $vax['url'] : $nav_ps_url;
            ?>
            <a href="<?php echo esc_url( $href ); ?>" class="denton-mobile-sub-link"><?php echo esc_html( $vax['label'] ); ?></a>
            <?php endforeach; ?>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div class="denton-mobile-cta">
        ...
        <a href="<?php echo esc_url( home_url( '/nominate-denton-pharmacy/' ) ); ?>" class="denton-mobile-cta-nhs">NHS Nominate</a>
        <a href="<?php echo esc_url( $patient_portal_register_url ); ?>" class="denton-mobile-cta-portal" target="_blank" rel="noopener noreferrer">Register</a>
        <a href="<?php echo esc_url( $patient_portal_login_url ); ?>" class="denton-mobile-cta-portal" target="_blank" rel="noopener noreferrer">Log In</a>
