...
function dp_register_acf_field_groups() {
    ...
    $nhs_card_defaults = array(
        1 => array(
            'colour' => 'blue',    'icon' => 'prescription',
            'badge'  => 'Free for Eligible',
            'title'  => 'NHS Prescriptions',
            'desc'   => 'Free prescription dispensing for eligible patients. Quick, reliable service with expert advice from our pharmacists.',
            'item_1' => 'Free for eligible patients',
            'item_2' => 'Same-day collection',
            'item_3' => 'Expert pharmacist advice',
            'btn'    => 'Learn More',
            'url'    => home_url( '/nhs-services/' ),
        ),
        2 => array(
            'colour' => 'green',   'icon' => 'delivery',
            'badge'  => 'Free Service',
            'title'  => 'Collection & Delivery',
            'desc'   => 'Free prescription collection from your GP and home delivery service. We make getting your medication convenient.',
            'item_1' => 'Free home delivery',
            'item_2' => 'GP prescription collection',
            'item_3' => 'Local area coverage',
            'btn'    => 'Request Delivery',
            'url'    => home_url( '/nhs-services/' ),
        ),
        3 => array(
            'colour' => 'purple',  'icon' => 'repeat',
            'badge'  => 'Automated',
            'title'  => 'Repeat Prescriptions',
            'desc'   => 'Automatic repeat prescription service with reminders. Never run out of your regular medication again.',
            'item_1' => 'Automatic ordering',
            'item_2' => 'SMS/email reminders',
            'item_3' => 'Easy to manage',
            'btn'    => 'Sign Up Now',
            'url'    => home_url( '/nhs-services/' ),
        ),
        4 => array(
            'colour' => 'orange',  'icon' => 'pharmacyfirst',
            'badge'  => 'NHS Service',
            'title'  => 'Pharmacy First',
            'desc'   => 'Get treatment for common conditions without seeing a GP. Free NHS consultations for minor ailments.',
            'item_1' => 'No GP appointment needed',
            'item_2' => '7 common conditions',
            'item_3' => 'Free consultation',
            'btn'    => 'Book Consultation',
            'url'    => home_url( '/book-appointment/' ),
        ),
        5 => array(
            'colour' => 'pink',    'icon' => 'newmedicine',
            'badge'  => 'Free Support',
            'title'  => 'New Medicine Service',
            'desc'   => 'Extra support when starting new medication. Free follow-up consultations to ensure your treatment works.',
            'item_1' => 'Medication guidance',
            'item_2' => 'Follow-up consultations',
            'item_3' => 'Side effect management',
            'btn'    => 'Get Support',
            'url'    => home_url( '/nhs-services/' ),
        ),
        6 => array(
            'colour' => 'cyan',    'icon' => 'flu',
            'badge'  => 'Seasonal',
            'title'  => 'NHS Flu Vaccinations',
            'desc'   => 'Free flu jabs for eligible patients. Protect yourself and your loved ones this winter season.',
            'item_1' => 'Free for eligible patients',
            'item_2' => 'Walk-in available',
            'item_3' => 'Quick 10-minute service',
            'btn'    => 'Book Flu Jab',
            'url'    => home_url( '/book-appointment/' ),
        ),
    );
    ...
    foreach ( $nhs_card_defaults as $n => $d ) {
        $nhs_fields[] = array(
            'key'        => "field_dp_nhs_card_{$n}",
            'label'      => "Card {$n} — {$d['title']}",
            'name'       => "nhs_card_{$n}",
            'type'       => 'group',
            'layout'     => 'block',
            'sub_fields' => array(
                array(
                    'key'           => "field_dp_nhs_card_{$n}_colour",
                    'label'         => 'Colour',
                    'name'          => 'colour',
                    'type'          => 'select',
                    'choices'       => $nhs_colour_choices,
                    'default_value' => $d['colour'],
                    'wrapper'       => array( 'width' => '50' ),
                ),
                array(
                    'key'           => "field_dp_nhs_card_{$n}_icon",
                    'label'         => 'Icon',
                    'name'          => 'icon',
                    'type'          => 'select',
                    'choices'       => $nhs_icon_choices,
                    'default_value' => $d['icon'],
                    'wrapper'       => array( 'width' => '50' ),
                ),
                array(
                    'key'           => "field_dp_nhs_card_{$n}_badge",
                    'label'         => 'Badge',
                    'name'          => 'badge',
                    'type'          => 'text',
                ...
                array(
                    'key'           => "field_dp_nhs_card_{$n}_title",
                    'label'         => 'Title',
                    'name'          => 'title',
                    'type'          => 'text',
                ...
                array(
                    'key'           => "field_dp_nhs_card_{$n}_desc",
                    'label'         => 'Description',
                    'name'          => 'desc',
                    'type'          => 'textarea',
                    'rows'          => 2,
                ...
                array(
                    'key'           => "field_dp_nhs_card_{$n}_item_1",
                    'label'         => 'Bullet 1',
                    'name'          => 'item_1',
                    'type'          => 'text',
                    'default_value' => $d['item_1'],
                    'wrapper'       => array( 'width' => '33' ),
                ),
                array(
                    'key'           => "field_dp_nhs_card_{$n}_item_2",
                    'label'         => 'Bullet 2',
                    'name'          => 'item_2',
                    'type'          => 'text',
                    'default_value' => $d['item_2'],
                    'wrapper'       => array( 'width' => '33' ),
                ),
                array(
                    'key'           => "field_dp_nhs_card_{$n}_item_3",
                    'label'         => 'Bullet 3',
                    'name'          => 'item_3',
                    'type'          => 'text',
                    'default_value' => $d['item_3'],
                    'wrapper'       => array( 'width' => '34' ),
                ),
                array(
                    'key'           => "field_dp_nhs_card_{$n}_btn",
                    'label'         => 'Button Text',
                    'name'          => 'btn',
                    'type'          => 'text',
                    'default_value' => $d['btn'],
    ...
    // Bottom CTA (appears after the cards on the frontend)
    $nhs_fields[] = array(
