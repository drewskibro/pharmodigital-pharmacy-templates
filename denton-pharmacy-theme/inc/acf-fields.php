...
function dp_register_acf_field_groups() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_dp_wl_calculator_image', 'label' => 'Calculator Image', 'name' => 'wl_calculator_image', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium' ),
            array( 'key' => 'field_dp_wl_calculator_badge_number', 'label' => 'Image Badge Number', 'name' => 'wl_calculator_badge_number', 'type' => 'text', 'default_value' => '10-15%' ),
            array( 'key' => 'field_dp_wl_calculator_badge_label', 'label' => 'Image Badge Label', 'name' => 'wl_calculator_badge_label', 'type' => 'text', 'default_value' => 'Average Weight Loss' ),
            array( 'key' => 'field_dp_wl_calculator_form_title', 'label' => 'Form Title', 'name' => 'wl_calculator_form_title', 'type' => 'text', 'default_value' => 'Weight Loss Estimator' ),
            array( 'key' => 'field_dp_wl_calculator_weight_label', 'label' => 'Weight Label', 'name' => 'wl_calculator_weight_label', 'type' => 'text', 'default_value' => 'Current Weight' ),
            array( 'key' => 'field_dp_wl_calculator_height_label', 'label' => 'Height Label', 'name' => 'wl_calculator_height_label', 'type' => 'text', 'default_value' => 'Height' ),
            array( 'key' => 'field_dp_wl_calculator_submit_text', 'label' => 'Submit Button Text', 'name' => 'wl_calculator_submit_text', 'type' => 'text', 'default_value' => 'Calculate Potential Results' ),
            array( 'key' => 'field_dp_wl_calculator_results_title', 'label' => 'Results Title', 'name' => 'wl_calculator_results_title', 'type' => 'text', 'default_value' => 'Your Estimated Results' ),
            array( 'key' => 'field_dp_wl_calculator_bmi_label', 'label' => 'BMI Label', 'name' => 'wl_calculator_bmi_label', 'type' => 'text', 'default_value' => 'Current BMI' ),
            array( 'key' => 'field_dp_wl_calculator_bmi_placeholder', 'label' => 'BMI Placeholder', 'name' => 'wl_calculator_bmi_placeholder', 'type' => 'text', 'default_value' => 'Enter your details' ),
            array( 'key' => 'field_dp_wl_calculator_projection_title', 'label' => 'Projection Title', 'name' => 'wl_calculator_projection_title', 'type' => 'text', 'default_value' => 'Projected Weight Loss' ),
            array( 'key' => 'field_dp_wl_calculator_projection_detail', 'label' => 'Projection Detail', 'name' => 'wl_calculator_projection_detail', 'type' => 'text', 'default_value' => 'Based on 10-15% body weight reduction over 12 months' ),
            array( 'key' => 'field_dp_wl_calculator_timeline_1', 'label' => 'Timeline Label 1', 'name' => 'wl_calculator_timeline_1', 'type' => 'text', 'default_value' => 'Month 3' ),
            array( 'key' => 'field_dp_wl_calculator_timeline_2', 'label' => 'Timeline Label 2', 'name' => 'wl_calculator_timeline_2', 'type' => 'text', 'default_value' => 'Month 6' ),
            array( 'key' => 'field_dp_wl_calculator_timeline_3', 'label' => 'Timeline Label 3', 'name' => 'wl_calculator_timeline_3', 'type' => 'text', 'default_value' => 'Month 12' ),
            array( 'key' => 'field_dp_wl_calculator_cta_text', 'label' => 'CTA Button Text', 'name' => 'wl_calculator_cta_text', 'type' => 'text', 'default_value' => 'Book Your Consultation' ),
            array( 'key' => 'field_dp_wl_calculator_disclaimer', 'label' => 'Disclaimer Text', 'name' => 'wl_calculator_disclaimer', 'type' => 'text', 'default_value' => 'Results are estimates based on clinical trial data. Individual results may vary.' ),
        ),
        'location'              => $wl_location,
        'menu_order'            => 406,
        'position'              => 'normal',
