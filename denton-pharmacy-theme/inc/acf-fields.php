...
function dp_register_acf_field_groups() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'type'          => 'textarea',
                'rows'          => 2,
                'default_value' => 'Speak with Ahmed and our Denton team directly whenever you need clinical or personal support. The website assistant only provides general information and booking routes.',
            ),
            // Feature 3
            array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_dp_wl_hero_description', 'label' => 'Description', 'name' => 'wl_hero_description', 'type' => 'textarea', 'rows' => 3, 'default_value' => 'Prescription weight management with expert guidance and face-to-face support right here in Denton. No remote consultations — real care from someone who knows your name.' ),
            ...
            array(
                'key'           => 'field_dp_wl_hero_mobile_image',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_dp_wl_stat_1_number', 'label' => 'Stat 1 — Number', 'name' => 'wl_stat_1_number', 'type' => 'text', 'default_value' => '4.9', 'wrapper' => array( 'width' => '50' ) ),
            ...
            array( 'key' => 'field_dp_wl_stat_4_number', 'label' => 'Stat 4 — Number', 'name' => 'wl_stat_4_number', 'type' => 'text', 'default_value' => '15+', 'wrapper' => array( 'width' => '50' ) ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            array( 'key' => 'field_dp_wl_social_number', 'label' => 'Stat Number', 'name' => 'wl_social_number', 'type' => 'text', 'default_value' => '4.9' ),
            ...
            array( 'key' => 'field_dp_wl_social_subtext', 'label' => 'Subtext', 'name' => 'wl_social_subtext', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Real people, real care. Every patient gets a face-to-face consultation and monthly reviews with their own pharmacist.' ),
        ),
        'location'              => $wl_location,
        'menu_order'            => 401,
        'position'              => 'normal',
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_dp_wl_results_title', 'label' => 'Title', 'name' => 'wl_results_title', 'type' => 'text', 'default_value' => 'Real results in Denton' ),
            array( 'key' => 'field_dp_wl_results_description', 'label' => 'Description', 'name' => 'wl_results_description', 'type' => 'textarea', 'rows' => 2, 'default_value' => 'Denton patients get a personalised programme, monthly face-to-face reviews and support from their own pharmacist throughout.' ),
            array( 'key' => 'field_dp_wl_results_card1_number', 'label' => 'Card 1 — Number', 'name' => 'wl_results_card1_number', 'type' => 'text', 'default_value' => '4.9/5' ),
            ...
            array( 'key' => 'field_dp_wl_results_featured_number', 'label' => 'Featured Card — Number', 'name' => 'wl_results_featured_number', 'type' => 'text', 'default_value' => 'Monthly' ),
            array( 'key' => 'field_dp_wl_results_featured_label', 'label' => 'Featured Card — Label', 'name' => 'wl_results_featured_label', 'type' => 'text', 'default_value' => 'Face-to-face reviews' ),
            array( 'key' => 'field_dp_wl_results_featured_sublabel', 'label' => 'Featured Card — Sublabel', 'name' => 'wl_results_featured_sublabel', 'type' => 'text', 'default_value' => 'With your own pharmacist' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_dp_wl_cta_bar_subtitle', 'label' => 'Subtitle', 'name' => 'wl_cta_bar_subtitle', 'type' => 'text', 'default_value' => 'Book your in-store consultation today' ),
        ),
        'location'              => $wl_location,
        'menu_order'            => 403,
        'position'              => 'normal',
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    ...
                    array( 'key' => 'field_dp_th_vax_link', 'label' => 'Link URL', 'name' => 'link', 'type' => 'url', 'instructions' => 'Optional. If set, the card links to this page.', 'wrapper' => array( 'width' => '100' ) ),
                ),
            ),
        ),
        'location'              => $th_location,
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array( 'key' => 'field_dp_book_ps_btn_link', 'label' => 'Button', 'name' => 'button_link', 'type' => 'link', 'return_format' => 'array', 'instructions' => 'The card button: set the link text and the page it points to. Leave blank to scroll to the booking form on this page (button reads "Book Consultation").' ),
                ),
            ),
        ),
        'location'              => $book_location,
