...
document.addEventListener('DOMContentLoaded', function () {
  var nav = document.querySelector('.denton-nav');
  var mobileBtn = document.getElementById('denton-mobile-btn');
  var mobileMenu = document.getElementById('denton-mobile-menu');
  ...
  var searchBtn = document.getElementById('denton-search-btn');
  if (searchBtn) {
    ...
    overlayEl.innerHTML =
      ...
      '<div class="denton-search-inner">' +
        ...
        '<form class="denton-search-input-row" action="/" method="get">' +
          '<input type="text" class="denton-search-input" id="denton-search-input" name="s" placeholder="e.g. weight loss, travel vaccines\u2026" autocomplete="off" spellcheck="false" />' +
          '<button type="submit" class="denton-search-submit" aria-label="Submit search">' +
    ...
    var searchClose = document.getElementById('denton-search-close');
    var searchInput = document.getElementById('denton-search-input');
    var searchForm = overlayEl.querySelector('.denton-search-input-row');
  ...
  // ── Accordion Sections ──
  var accordionBtns = document.querySelectorAll('.denton-mobile-accordion-btn');
  accordionBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var accordion = btn.closest('.denton-mobile-accordion');
      var isOpen = accordion.classList.contains('open');

      // Close all open accordions
      document.querySelectorAll('.denton-mobile-accordion.open').forEach(function (a) {
