...
$vaccine_name = dp_field('vaccine_name', 'Hepatitis A & B');
?>
...
<section class="hepatitis-hero-section"<?php if ( $hero_image_url ) : ?> style="background-image: url('<?php echo esc_url( $hero_image_url ); ?>');"<?php endif; ?>>
  ...
  <div class="section-container">
    <div class="hepatitis-hero-content">
      ...
      <span class="hepatitis-hero-label"><?php echo esc_html(dp_field('vaccine_hero_label', 'TRAVEL HEALTH PROTECTION')); ?></span>

      <h1 class="hepatitis-hero-title"><?php echo esc_html(dp_field('vaccine_hero_title', 'Hepatitis A & B Vaccination Service in Denton')); ?></h1>

      <p class="hepatitis-hero-description">
        <?php echo esc_html(dp_field('vaccine_hero_description', 'Protect yourself against Hepatitis A and B with our expert travel health service. Essential for travellers to areas with poor sanitation or where Hepatitis is endemic.')); ?>
      </p>

      <div class="hepatitis-hero-actions">
        <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button hepatitis-btn-primary">
          <?php echo esc_html(dp_field('vaccine_cta_text', 'Book Hepatitis Vaccination')); ?>
        </a>
        <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>" class="cta-button hepatitis-btn-secondary">
...
<section class="hepatitis-protect-section">
  <div class="section-container">
    <div class="hepatitis-protect-header">
      ...
      <p class="hepatitis-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'Flexible vaccination schedules to suit your travel plans')); ?></p>
    </div>
    ...
    <div class="hepatitis-protect-grid">
      <div class="hepatitis-protect-image-wrapper">
        <div class="hepatitis-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_protect_image_alt', 'Pharmacist explaining vaccination options')); ?>" class="hepatitis-protect-image" />
          <?php endif; ?>
          <div class="hepatitis-protect-name-tag">
            <span class="name"><?php echo esc_html(dp_field('vaccine_protect_nametag_name', 'Ahmed Al-Liabi')); ?></span>
      ...
      <div class="hepatitis-protect-content">
        <div class="hepatitis-protect-badge-box">
          ...
          <span><?php echo esc_html(dp_field('vaccine_protect_highlight', 'Combined Protection Available')); ?></span>
        </div>

        <h3 class="hepatitis-protect-subtitle"><?php echo esc_html(dp_field('vaccine_protect_subtitle', 'Separate or Combined Vaccinations')); ?></h3>
        <p class="hepatitis-protect-text"><?php echo esc_html(dp_field('vaccine_protect_text', 'Hepatitis A and B are viral infections that affect the liver. Depending on your destination and risk factors, you may need protection against one or both. We offer individual vaccines as well as a combined option (Twinrix) for convenience.')); ?></p>
...
<section class="hepatitis-about-section">
  <div class="section-container">
    <div class="hepatitis-about-header">
      ...
      <p class="hepatitis-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'Understanding the risks and transmission methods')); ?></p>
    </div>
    ...
    <div class="hepatitis-about-content-grid">
      <div class="hepatitis-about-image-wrapper">
        <div class="hepatitis-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_about_image_alt', 'Travel food safety')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="hepatitis-about-callout">
      <div class="badge"><?php echo esc_html(dp_field('vaccine_callout_badge', 'CRITICAL INSIGHT')); ?></div>
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', 'Hepatitis B is Highly Infectious')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'Hepatitis B is 50-100 times more infectious than HIV. It can survive outside the body for at least 7 days. Vaccination provides the most reliable defence against this silent but serious virus.')); ?></p>
    </div>
  </div>
</section>
...
<section class="hepatitis-needs-section">
  <div class="section-container">
    <div class="hepatitis-needs-header">
      ...
      <p class="hepatitis-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Recommended for many travellers and at-risk groups')); ?></p>
    </div>
...
<section class="hepatitis-details-section">
  <div class="section-container">
    <div class="hepatitis-details-header">
      ...
      <p class="hepatitis-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'Simple, straightforward vaccination process at our Denton clinic')); ?></p>
    </div>
...
<section class="hepatitis-risk-section">
  <div class="section-container">
    <div class="hepatitis-risk-header">
      ...
      <p class="hepatitis-risk-desc"><?php echo esc_html(dp_field('vaccine_risk_desc', 'Risk varies by region, but vaccination is often recommended for travel outside Western Europe, North America, and Australia.')); ?></p>
    </div>
...
<section class="hepatitis-cta-section">
  ...
  <div class="section-container">
    <div class="hepatitis-cta-content">
      ...
      <h2 class="hepatitis-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect your health while travelling')); ?></h2>
      <p class="hepatitis-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your Hepatitis vaccination with our expert team today. Quick, convenient, and professional service in Denton.')); ?></p>
