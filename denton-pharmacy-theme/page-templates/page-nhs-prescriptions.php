...
// --- Hero ---
$hero_badge         = dp_field( 'np_hero_badge' );
$hero_title_accent  = dp_field( 'np_hero_title_accent' );
$hero_title_rest    = dp_field( 'np_hero_title_rest' );
$hero_description   = dp_field( 'np_hero_description' );
$hero_cta_primary   = dp_field( 'np_hero_cta_primary' );
$hero_cta_secondary = dp_field( 'np_hero_cta_secondary' );
...
$card_label  = dp_field( 'np_hero_card_label' );
$card_price  = dp_field( 'np_hero_card_price' );
$card_sub    = dp_field( 'np_hero_card_sub' );
$card_checks = array();
            ...
            <div class="npres-hero-visual">
                <div class="npres-trust-card">
                    ...
                    <div class="npres-trust-card-inner">
                        ...
                        <?php endif; ?>
                        <div class="npres-trust-card-footer">
...
<?php
// --- FAQ ---
$faq_badge = dp_field( 'np_faq_badge' );
$faq_title = dp_field( 'np_faq_title' );
...
<?php
// --- Final CTA ---
$cta_title       = dp_field( 'np_cta_title' );
$cta_description = dp_field( 'np_cta_description' );
$cta_primary     = dp_field( 'np_cta_primary' );
$cta_secondary   = dp_field( 'np_cta_secondary' );
