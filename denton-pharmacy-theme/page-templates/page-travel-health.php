...
$th_cta_url       = dp_field( 'th_hero_cta_url' ) ?: '#travel-health-calendar';
      ...
      ?>
        <div class="travel-stat-item">
          ...
          <div class="travel-stat-content">
            <p class="travel-stat-number"><?php echo esc_html( dp_field( $stat['number'], $stat['def_number'] ) ); ?></p>
            <p class="travel-stat-label"><?php echo esc_html( dp_field( $stat['label'], $stat['def_label'] ) ); ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
    ...
    <div class="travel-destinations-grid">
      ...
      <?php endwhile; else : ?>
        ...
        $destinations = array(
          ...
          array( 'name' => 'Cape Verde', 'image' => home_url( '/wp-content/uploads/2026/03/capeverde-sun-wind.jpg' ), 'url' => '/travel-cape-verde/' ),
        );
    ...
    <div class="travel-cta-content">
      <div class="travel-cta-badges">
        <div class="travel-cta-badge">
          ...
          <span><?php echo esc_html( dp_field( 'th_cta_badge_1', 'Yellow Fever Centre' ) ); ?></span>
        </div>
        <div class="travel-cta-badge">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( dp_field( 'th_cta_badge_2', 'Expert Advice' ) ); ?></span>
        </div>
        <div class="travel-cta-badge">
          <i class="fas fa-calendar-check"></i>
          <span><?php echo esc_html( dp_field( 'th_cta_badge_3', 'Same Day Service' ) ); ?></span>
        </div>
      </div>
      <h2 class="travel-cta-title"><?php echo esc_html( dp_field( 'th_cta_title', 'Ready to protect your travels?' ) ); ?></h2>
      <p class="travel-cta-description">
        <?php echo esc_html( dp_field( 'th_cta_description', 'Don\'t let health worries spoil your adventure. Book your comprehensive travel health consultation with Denton Pharmacy today.' ) ); ?>
      </p>
      <div class="travel-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'th_cta_primary_url', '' ) ?: '#travel-health-calendar' ); ?>" class="cta-button primary-cta travel-cta-button-white">
          <?php echo esc_html( dp_field( 'th_cta_primary_text', 'Book Travel Health Appointment' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta travel-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
      </div>
      <div class="travel-cta-checks">
        <div class="travel-cta-check">
          ...
          <span><?php echo esc_html( dp_field( 'th_cta_check_1', 'Flexible appointments' ) ); ?></span>
        </div>
        <div class="travel-cta-check">
          <i class="fas fa-check"></i>
          <span><?php echo esc_html( dp_field( 'th_cta_check_2', 'Expert advice' ) ); ?></span>
        </div>
        <div class="travel-cta-check">
          <i class="fas fa-check"></i>
          <span><?php echo esc_html( dp_field( 'th_cta_check_3', 'Official certificates' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
...
<section id="travel-health-calendar" class="travel-booking-section">
  <div class="section-container">
    <div class="travel-booking-header">
      ...
      <p class="travel-booking-subtitle">Select a time below and book your travel clinic appointment directly.</p>
    </div>
