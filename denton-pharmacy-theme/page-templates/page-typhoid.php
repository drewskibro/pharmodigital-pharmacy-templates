...
<section class="typhoid-hero-section"<?php if ( $hero_image_url ) : ?> style="background-image: url('<?php echo esc_url( $hero_image_url ); ?>');"<?php endif; ?>>
  ...
  <div class="section-container">
    <div class="typhoid-hero-content">
      ...
      <span class="typhoid-hero-label"><?php echo esc_html(dp_field('vaccine_hero_label', 'TRAVEL HEALTH PROTECTION')); ?></span>

      <h1 class="typhoid-hero-title"><?php echo esc_html(dp_field('vaccine_hero_title', 'Typhoid Vaccination Service in Denton')); ?></h1>

      <p class="typhoid-hero-description">
        <?php echo esc_html(dp_field('vaccine_hero_description', 'Protect yourself against typhoid fever with our expert travel health service. Available as a single injection or oral capsules.')); ?>
      </p>

      <div class="typhoid-hero-actions">
        <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button typhoid-btn-primary">
          <?php echo esc_html(dp_field('vaccine_cta_text', 'Book Typhoid Vaccination')); ?>
        </a>
        <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>" class="cta-button typhoid-btn-secondary">
...
<section class="typhoid-protect-section">
  <div class="section-container">
    <div class="typhoid-protect-header">
      ...
      <p class="typhoid-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'Choose the vaccination method that suits you best')); ?></p>
    </div>
    ...
    <div class="typhoid-protect-grid">
      <div class="typhoid-protect-image-wrapper">
        <div class="typhoid-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_protect_image_alt', 'Travel health consultation')); ?>" class="typhoid-protect-image" />
          <?php endif; ?>
          <div class="typhoid-protect-name-tag">
            <span class="name"><?php echo esc_html(dp_field('vaccine_protect_nametag_name', 'Expert Advice')); ?></span>
      ...
      <div class="typhoid-protect-content">
        ...
        <p class="typhoid-protect-text"><?php echo esc_html(dp_field('vaccine_protect_text', 'Typhoid fever is a serious bacterial infection spread through contaminated food and water. We offer both the single-dose injection and the oral capsule course, giving you flexibility in how you get protected.')); ?></p>
...
<section class="typhoid-about-section">
  <div class="section-container">
    <div class="typhoid-about-header">
      ...
      <p class="typhoid-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'A bacterial infection that can be serious if not treated')); ?></p>
    </div>
    ...
    <div class="typhoid-about-content-grid">
      <div class="typhoid-about-image-wrapper">
        <div class="typhoid-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_about_image_alt', 'Street food market in Asia')); ?>" />
          <?php endif; ?>
        </div>
      </div>
...
<section class="typhoid-needs-section">
  <div class="section-container">
    <div class="typhoid-needs-header">
      ...
      <p class="typhoid-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Vaccination is recommended for travellers visiting high-risk areas')); ?></p>
    </div>
...
<section class="typhoid-risk-section">
  <div class="section-container">
    <div class="typhoid-risk-header">
      ...
      <p class="typhoid-risk-desc"><?php echo esc_html(dp_field('vaccine_risk_desc', 'Typhoid is found worldwide but is most common in areas with poor sanitation and hygiene.')); ?></p>
    </div>
...
<section class="typhoid-cta-section">
  ...
  <div class="section-container">
    <div class="typhoid-cta-content">
      ...
      <h2 class="typhoid-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect your health while travelling')); ?></h2>
      <p class="typhoid-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your typhoid vaccination with our expert team today. Quick, convenient, and professional service in Denton.')); ?></p>
