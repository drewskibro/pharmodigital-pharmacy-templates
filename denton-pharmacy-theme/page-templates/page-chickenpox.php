    ...
    <div class="chickenpox-hero-grid">
      ...
      <div class="chickenpox-hero-content">
        ...
        <p class="chickenpox-hero-description">
          <?php echo esc_html(dp_field('vaccine_hero_description', 'Protect your family against chickenpox with our private vaccination service in Denton, Manchester. A safe, two-dose course that is around 90% effective — for children from 12 months and for adults who have never had chickenpox.')); ?>
        </p>
...
<section class="chickenpox-protect-section">
  <div class="section-container">
    <div class="chickenpox-protect-header">
      ...
      <h2 class="chickenpox-protect-title"><?php echo esc_html(dp_field('vaccine_protect_title', 'The Chickenpox Vaccine')); ?></h2>
      <p class="chickenpox-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'A simple way to avoid an unpleasant and sometimes serious illness')); ?></p>
    </div>
    ...
    <div class="chickenpox-protect-grid">
      ...
      <div class="chickenpox-protect-content">
        <div class="chickenpox-protect-badge-box">
          ...
          <span><?php echo esc_html(dp_field('vaccine_protect_highlight', 'Around 90% Effective After Two Doses')); ?></span>
        </div>
...
<section class="chickenpox-about-section">
  <div class="section-container">
    <div class="chickenpox-about-header">
      ...
      <h2 class="chickenpox-about-title"><?php echo esc_html(dp_field('vaccine_about_title', 'What is Chickenpox?')); ?></h2>
      <p class="chickenpox-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'A common childhood infection that can be serious for some')); ?></p>
    </div>
    ...
    <div class="chickenpox-about-callout">
      ...
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', 'One Infection, Lifelong Visitor')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'After chickenpox, the virus stays dormant in the body and can reappear later in life as shingles. Vaccination helps you avoid the original illness and its complications altogether.')); ?></p>
    </div>
  </div>
</section>
...
<section class="chickenpox-needs-section">
  <div class="section-container">
    <div class="chickenpox-needs-header">
      ...
      <h2 class="chickenpox-needs-title"><?php echo esc_html(dp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="chickenpox-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Recommended for anyone who has not had chickenpox')); ?></p>
    </div>
...
<section class="chickenpox-details-section">
  <div class="section-container">
    <div class="chickenpox-details-header">
      ...
      <h2 class="chickenpox-details-title"><?php echo esc_html(dp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="chickenpox-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'A simple, friendly visit to our Denton clinic')); ?></p>
    </div>
...
<section class="chickenpox-faq-section">
  <div class="section-container">
    <div class="chickenpox-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_faq_badge', 'CHICKENPOX FAQs')); ?></span>
      </div>
      <h2 class="chickenpox-faq-title"><?php echo esc_html(dp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<?php
$acuity_url = dp_field( 'vaccine_acuity_url', 'https://app.acuityscheduling.com/schedule.php?owner=29286426&appointmentType=47109538&calendarID=10903457&ref=embedded_csp' );
?>
<section class="chickenpox-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="chickenpox-booking-header">
      <h2 class="chickenpox-booking-title"><?php echo esc_html(dp_field('vaccine_booking_title', 'Book Your Chickenpox Vaccination')); ?></h2>
      <p class="chickenpox-booking-desc"><?php echo esc_html(dp_field('vaccine_booking_desc', 'Choose a time that suits you at our Denton clinic')); ?></p>
    </div>

    <div class="chickenpox-booking-embed">
      <?php if ( $acuity_url ) : ?>
        <iframe src="<?php echo esc_url( $acuity_url ); ?>" title="Book your Chickenpox vaccination appointment in Denton" width="100%" height="800" frameborder="0" allow="payment"></iframe>
...
<section class="chickenpox-cta-section">
  ...
  <div class="section-container">
    <div class="chickenpox-cta-content">
      ...
      <h2 class="chickenpox-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect your family against chickenpox')); ?></h2>
      <p class="chickenpox-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your chickenpox vaccination with our friendly team in Denton today. Quick, convenient and professional.')); ?></p>
