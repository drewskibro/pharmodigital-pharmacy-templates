          ...
          <div class="meningitis-b-trust-card-inner">
            ...
            <div class="meningitis-b-trust-card-prices">
              <div class="meningitis-b-trust-price-col">
                <span class="meningitis-b-trust-price-tag meningitis-b-trust-price-tag--nhs"><?php echo esc_html(dp_field('vaccine_hero_nhs_tag', 'NHS')); ?></span>
                <span class="meningitis-b-trust-card-amount"><?php echo esc_html(dp_field('vaccine_hero_nhs_amount', 'Free')); ?></span>
                <span class="meningitis-b-trust-card-sub"><?php echo esc_html(dp_field('vaccine_hero_nhs_unit', 'if eligible')); ?></span>
              </div>
              <div class="meningitis-b-trust-price-sep"></div>
              <div class="meningitis-b-trust-price-col">
                <span class="meningitis-b-trust-price-tag"><?php echo esc_html(dp_field('vaccine_hero_private_tag', 'Private')); ?></span>
                <span class="meningitis-b-trust-card-amount"><?php echo esc_html(dp_field('vaccine_price_amount', '£125')); ?></span>
            ...
            <a href="#pathways" class="meningitis-b-trust-card-eligibility">
              ...
              <span><?php echo esc_html(dp_field('vaccine_hero_eligibility_link', 'Check if you qualify for free NHS vaccination')); ?></span>
            </a>
    ...
    <div class="meningitis-b-pathways-grid">
      ...
      <div class="meningitis-b-pathway-card meningitis-b-pathway-card--private">
        ...
        <div class="meningitis-b-pathway-price">
          <span class="meningitis-b-pathway-price-amount"><?php echo esc_html( dp_field( 'vaccine_price_amount', '£125' ) ); ?></span>
    ...
    <div class="meningitis-b-pricing-grid">
      <div class="meningitis-b-pricing-card featured">
        ...
        <div class="meningitis-b-pricing-amount">
          <span class="price"><?php echo esc_html(dp_field('vaccine_price_amount', '£125')); ?></span>
