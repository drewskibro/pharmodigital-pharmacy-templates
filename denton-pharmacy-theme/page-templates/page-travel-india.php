    ...
    <div class="india-hero-grid">
      ...
      <div class="india-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( dp_field( 'in_hero_badge', 'INDIA TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( dp_field( 'in_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( dp_field( 'in_hero_title_highlight', 'India' ) ); ?></span>
        </h1>
        ...
        <div class="india-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'in_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta india-hero-btn-primary">
            <?php echo esc_html( dp_field( 'in_hero_cta_text', 'Book India Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta india-hero-btn-secondary">
...
<section class="india-vaccines-section">
  <div class="section-container">
    <div class="india-vaccines-header">
      <h2 class="india-vaccines-title"><?php echo esc_html( dp_field( 'in_vaccines_title', 'Protect yourself in India' ) ); ?></h2>
      <div class="india-vaccines-divider"></div>
      <p class="india-vaccines-description"><?php echo esc_html( dp_field( 'in_vaccines_description', 'These vaccinations are recommended for most travellers to India' ) ); ?></p>
    </div>
    ...
    <div class="india-malaria-layout">
      ...
      <div class="india-malaria-visual">
        <div class="india-malaria-image-card">
          ...
          <div class="india-malaria-badge">
            ...
            <span class="india-malaria-badge-text"><?php echo esc_html( dp_field( 'in_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="india-malaria-content">
        <div class="section-badge">
          <span class="pulse-dot"><span></span><span></span></span>
          <span class="section-badge-text"><?php echo esc_html( dp_field( 'in_malaria_badge', 'MOSQUITO-BORNE DISEASES' ) ); ?></span>
        </div>

        <h2 class="india-malaria-title"><?php echo esc_html( dp_field( 'in_malaria_title', 'Malaria & Dengue Risks in India' ) ); ?></h2>
        <p class="india-malaria-intro">
          <?php echo esc_html( dp_field( 'in_malaria_intro', 'Malaria risk varies across India. Dengue fever is also a significant risk nationwide. Our pharmacists will check your specific itinerary and advise on prevention.' ) ); ?>
        </p>
...
<section class="india-health-section">
  <div class="section-container">
    <div class="india-health-header">
      <div class="section-badge">
        <span class="pulse-dot"><span></span><span></span></span>
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'in_health_badge', 'HEALTH ADVICE' ) ); ?></span>
      </div>
      <h2 class="india-health-title"><?php echo esc_html( dp_field( 'in_health_title', 'Stay healthy in India' ) ); ?></h2>
      <p class="india-health-subtitle"><?php echo esc_html( dp_field( 'in_health_subtitle', 'Essential tips for a safe journey' ) ); ?></p>
    </div>
    ...
    <div class="india-cta-content">
      ...
      <div class="india-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'in_cta_primary_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta india-cta-button-white">
          <?php echo esc_html( dp_field( 'in_cta_primary_text', 'Book India Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta india-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
      </div>
      <div class="india-cta-checks">
        <div class="india-cta-check">
          ...
          <span><?php echo esc_html( dp_field( 'in_cta_check_1', 'Travel Ready' ) ); ?></span>
        </div>
        <div class="india-cta-check">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( dp_field( 'in_cta_check_2', 'Expert India Advice' ) ); ?></span>
        </div>
        <div class="india-cta-check">
          <i class="fas fa-shield-virus"></i>
          <span><?php echo esc_html( dp_field( 'in_cta_check_3', 'All Vaccines Available' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
