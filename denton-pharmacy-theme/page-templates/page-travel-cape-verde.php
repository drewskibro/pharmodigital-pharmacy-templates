    ...
    <div class="capeverde-hero-grid">
      ...
      <div class="capeverde-hero-content">
        ...
        <p class="capeverde-hero-description">
          <?php echo esc_html( dp_field( 'cv_hero_description', 'Expert advice and vaccinations for your Cape Verde holiday. Get protected before you travel with Denton\'s trusted travel health specialists.' ) ); ?>
        </p>
    ...
    <div class="capeverde-malaria-layout">
      ...
      <div class="capeverde-malaria-content">
        ...
        <div class="capeverde-malaria-actions">
          <a href="<?php echo esc_url( dp_field( 'cv_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta">
            Check Your Risk
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
  ...
  <div class="section-container">
    <div class="capeverde-cta-content">
      ...
      <p class="capeverde-cta-description">
        <?php echo esc_html( dp_field( 'cv_cta_description', 'Book your travel health consultation at our Denton clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
