    ...
    <div class="capeverde-hero-grid">
      ...
      <div class="capeverde-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( dp_field( 'cv_hero_badge', 'CAPE VERDE TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( dp_field( 'cv_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( dp_field( 'cv_hero_title_highlight', 'Cape Verde' ) ); ?></span>
        </h1>

        <p class="capeverde-hero-description">
          <?php echo esc_html( dp_field( 'cv_hero_description', 'Expert advice and vaccinations for your Cape Verde holiday. Get protected before you travel with ' . dp_pharmacy_name() . '\'s trusted travel health specialists.' ) ); ?>
        </p>

        <div class="capeverde-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'cv_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta capeverde-hero-btn-primary">
            <?php echo esc_html( dp_field( 'cv_hero_cta_text', 'Book Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta capeverde-hero-btn-secondary">
...
<section class="capeverde-vaccines-section">
  <div class="section-container">
    <div class="capeverde-vaccines-header">
      <h2 class="capeverde-vaccines-title"><?php echo esc_html( dp_field( 'cv_vaccines_title', 'Protect yourself in Cape Verde' ) ); ?></h2>
      <div class="capeverde-vaccines-divider"></div>
      <p class="capeverde-vaccines-description"><?php echo esc_html( dp_field( 'cv_vaccines_description', 'These vaccinations are recommended for most travellers to Cape Verde' ) ); ?></p>
    </div>
    ...
    <div class="capeverde-malaria-layout">
      ...
      <div class="capeverde-malaria-visual">
        <div class="capeverde-malaria-image-card">
          <?php
          $malaria_image_id = dp_field( 'cv_malaria_image' );
          ...
          <div class="capeverde-malaria-badge">
            ...
            <span class="capeverde-malaria-badge-text"><?php echo esc_html( dp_field( 'cv_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="capeverde-malaria-content">
        <div class="section-badge">
          <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          <span class="section-badge-text"><?php echo esc_html( dp_field( 'cv_malaria_badge', 'MOSQUITO RISKS' ) ); ?></span>
        </div>

        <h2 class="capeverde-malaria-title"><?php echo esc_html( dp_field( 'cv_malaria_title', 'Malaria & Dengue in Cape Verde' ) ); ?></h2>
        <p class="capeverde-malaria-intro">
          <?php echo esc_html( dp_field( 'cv_malaria_intro', 'Malaria risk is generally low but present on Santiago island. Dengue fever and Zika virus are also risks. Bite avoidance is essential.' ) ); ?>
        </p>
        ...
        <div class="capeverde-malaria-actions">
          <a href="<?php echo esc_url( dp_field( 'cv_malaria_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta">
            <?php echo esc_html( dp_field( 'cv_malaria_cta_text', 'Check Your Risk' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
      </div>
...
<section class="capeverde-health-section">
  <div class="section-container">
    <div class="capeverde-health-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'cv_health_badge', 'HEALTH ADVICE' ) ); ?></span>
      </div>
      <h2 class="capeverde-health-title"><?php echo esc_html( dp_field( 'cv_health_title', 'Stay healthy in Cape Verde' ) ); ?></h2>
      <p class="capeverde-health-subtitle"><?php echo esc_html( dp_field( 'cv_health_subtitle', 'Essential tips for a safe trip' ) ); ?></p>
    </div>
...
<section class="capeverde-cta-section">
  ...
  <div class="section-container">
    <div class="capeverde-cta-content">
      <h2 class="capeverde-cta-title"><?php echo esc_html( dp_field( 'cv_cta_title', 'Ready for Cape Verde?' ) ); ?></h2>
      <p class="capeverde-cta-description">
        <?php echo esc_html( dp_field( 'cv_cta_description', 'Book your travel health consultation at our ' . dp_option( 'pharmacy_town', 'Denton' ) . ' clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
      <div class="capeverde-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'cv_cta_primary_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta capeverde-cta-button-white">
          <?php echo esc_html( dp_field( 'cv_cta_primary_text', 'Book Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta capeverde-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
      </div>
      <div class="capeverde-cta-checks">
        <div class="capeverde-cta-check">
          ...
          <span><?php echo esc_html( dp_field( 'cv_cta_check_1', 'Travel Ready' ) ); ?></span>
        </div>
        <div class="capeverde-cta-check">
          <i class="fas fa-user-doctor"></i>
          <span><?php echo esc_html( dp_field( 'cv_cta_check_2', 'Expert Advice' ) ); ?></span>
        </div>
        <div class="capeverde-cta-check">
          <i class="fas fa-shield-virus"></i>
          <span><?php echo esc_html( dp_field( 'cv_cta_check_3', 'All Vaccines' ) ); ?></span>
        </div>
      </div>
    </div>
  </div>
