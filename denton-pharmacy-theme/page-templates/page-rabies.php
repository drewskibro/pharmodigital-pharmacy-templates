...
<section class="rabies-hero-section"<?php if ( $hero_image_url ) : ?> style="background-image: url('<?php echo esc_url( $hero_image_url ); ?>');"<?php endif; ?>>
  ...
  <div class="section-container">
    <div class="rabies-hero-content">
      ...
      <span class="rabies-hero-label"><?php echo esc_html(dp_field('vaccine_hero_label', 'TRAVEL HEALTH PROTECTION')); ?></span>

      <h1 class="rabies-hero-title"><?php echo esc_html(dp_field('vaccine_hero_title', 'Rabies Vaccination<br>Service in Denton')); ?></h1>

      <p class="rabies-hero-description">
        <?php echo esc_html(dp_field('vaccine_hero_description', 'Protect yourself against rabies with our expert travel health service. Essential for travel to high-risk areas in Asia, Africa, and South America.')); ?>
      </p>

      <div class="rabies-hero-actions">
        <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button rabies-btn-primary">
          <?php echo esc_html(dp_field('vaccine_cta_text', 'Book Rabies Vaccination')); ?>
        </a>
        <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>" class="cta-button rabies-btn-secondary">
...
<section class="rabies-protect-section">
  <div class="section-container">
    <div class="rabies-protect-header">
      ...
      <h2 class="rabies-protect-title"><?php echo esc_html(dp_field('vaccine_protect_title', 'Understanding Rabies Risk')); ?></h2>
      <p class="rabies-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'A serious viral infection spread by infected animals')); ?></p>
    </div>
    ...
    <div class="rabies-protect-grid">
      <div class="rabies-protect-image-wrapper">
        <div class="rabies-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_protect_image_alt', 'Travel health consultation for rabies')); ?>" class="rabies-protect-image" />
          <?php endif; ?>
          <div class="rabies-protect-name-tag">
            <span class="name"><?php echo esc_html(dp_field('vaccine_protect_nametag_name', 'Expert Care')); ?></span>
            <span class="role"><?php echo esc_html(dp_field('vaccine_protect_nametag_role', 'Travel Health Team')); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="rabies-protect-content">
        <div class="rabies-protect-badge-box">
          ...
          <span><?php echo esc_html(dp_field('vaccine_protect_highlight', 'Recommended for High-Risk Areas')); ?></span>
        </div>

        <h3 class="rabies-protect-subtitle"><?php echo esc_html(dp_field('vaccine_protect_subtitle', 'Why Vaccination is Critical')); ?></h3>
        <p class="rabies-protect-text"><?php echo esc_html(dp_field('vaccine_protect_text', 'Rabies is a viral infection of the brain and nerves. It is almost always fatal once symptoms appear. Vaccination provides vital protection and simplifies treatment if you are bitten or scratched by an animal abroad.')); ?></p>
        ...
        <div class="rabies-protect-actions">
          <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button primary-cta">Book Appointment</a>
...
<section class="rabies-about-section">
  <div class="section-container">
    <div class="rabies-about-header">
      ...
      <p class="rabies-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'Understanding transmission and prevention')); ?></p>
    </div>
    ...
    <div class="rabies-about-content-grid">
      <div class="rabies-about-image-wrapper">
        <div class="rabies-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_about_image_alt', 'Stray dog in travel destination')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="rabies-about-callout">
      <div class="badge"><?php echo esc_html(dp_field('vaccine_callout_badge', 'CRITICAL WARNING')); ?></div>
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', '100% Fatal Once Symptoms Appear')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'Rabies is almost always fatal once symptoms develop. Vaccination is your best defence. If you are bitten or scratched by an animal abroad, seek medical help immediately, even if you have been vaccinated.')); ?></p>
    </div>
  </div>
</section>
...
<section class="rabies-needs-section">
  <div class="section-container">
    <div class="rabies-needs-header">
      ...
      <h2 class="rabies-needs-title"><?php echo esc_html(dp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="rabies-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Recommended for many travellers to risk areas')); ?></p>
    </div>
...
<section class="rabies-risk-section">
  <div class="section-container">
    <div class="rabies-risk-header">
      ...
      <h2 class="rabies-risk-title"><?php echo esc_html(dp_field('vaccine_risk_title', 'Where is Rabies found?')); ?></h2>
      <p class="rabies-risk-desc"><?php echo esc_html(dp_field('vaccine_risk_desc', 'Rabies is present on all continents except Antarctica, but over 95% of human deaths occur in Asia and Africa.')); ?></p>
    </div>
      ...
      ?>
        <div class="rabies-risk-column">
          ...
          <div class="rabies-risk-card <?php echo esc_attr(get_sub_field('level')); ?>">
            <div class="card-icon"><i class="<?php echo esc_attr( dp_fa_class( get_sub_field('icon') ) ); ?>"></i></div>
            <h3><?php echo esc_html(get_sub_field('title')); ?></h3>
    ...
    <div class="rabies-risk-footer">
      <div class="info-badge">
        ...
        <?php echo esc_html(dp_field('vaccine_risk_footer', "Unsure about your destination? We'll check the latest risk data for you.")); ?>
      </div>
      <div class="actions">
        <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button primary-cta">Book Consultation</a>
      </div>
    </div>
  </div>
</section>
...
<section class="rabies-details-section">
  <div class="section-container">
    <div class="rabies-details-header">
      ...
      <p class="rabies-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'Simple, straightforward vaccination process at our Denton clinic')); ?></p>
    </div>
...
<section class="rabies-cta-section">
  ...
  <div class="section-container">
    <div class="rabies-cta-content">
      ...
      <h2 class="rabies-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect your health while travelling')); ?></h2>
      <p class="rabies-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your Rabies vaccination with our expert team today. Quick, convenient, and professional service in Denton.')); ?></p>

      <div class="rabies-cta-actions">
        <a href="<?php echo esc_url(dp_field('vaccine_cta_url', '/book-appointment/')); ?>" class="cta-button primary-cta white-btn">Book Vaccination</a>
