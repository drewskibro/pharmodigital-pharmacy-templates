    ...
    <div class="thailand-hero-grid">
      ...
      <div class="thailand-hero-content">
        ...
        <p class="thailand-hero-description">
          <?php echo esc_html( dp_field( 'td_hero_description', 'Expert advice and vaccinations for your Thailand adventure. Get protected before you travel with Denton\'s trusted travel health specialists.' ) ); ?>
        </p>
  ...
  <div class="section-container">
    <div class="thailand-cta-content">
      ...
      <p class="thailand-cta-description">
        <?php echo esc_html( dp_field( 'td_cta_description', 'Book your Thailand travel health consultation at our Denton clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
