    ...
    <div class="brazil-hero-grid">
      ...
      <div class="brazil-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( dp_field( 'td_hero_badge', 'BRAZIL TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( dp_field( 'td_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( dp_field( 'td_hero_title_highlight', 'Brazil' ) ); ?></span>
        </h1>

        <p class="brazil-hero-description">
          <?php echo esc_html( dp_field( 'td_hero_description', 'Expert advice and vaccinations for your trip to Brazil. Yellow Fever certificate required, Malaria prevention, and more.' ) ); ?>
        </p>

        <div class="brazil-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'td_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta brazil-hero-btn-primary">
            <?php echo esc_html( dp_field( 'td_hero_cta_text', 'Book Brazil Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta brazil-hero-btn-secondary">
...
<section class="brazil-vaccines-section">
  <div class="section-container">
    <div class="brazil-vaccines-header">
      <h2 class="brazil-vaccines-title"><?php echo esc_html( dp_field( 'td_vaccines_title', 'Protect yourself in Brazil' ) ); ?></h2>
      <div class="brazil-vaccines-divider"></div>
      <p class="brazil-vaccines-description"><?php echo esc_html( dp_field( 'td_vaccines_description', 'These vaccinations are recommended for most travellers to Brazil' ) ); ?></p>
    </div>
    ...
    <div class="brazil-malaria-layout">
      ...
      <div class="brazil-malaria-visual">
        <div class="brazil-malaria-image-card">
          ...
          <div class="brazil-malaria-badge">
            ...
            <span class="brazil-malaria-badge-text"><?php echo esc_html( dp_field( 'td_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="brazil-malaria-content">
        <div class="section-badge">
          <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          <span class="section-badge-text"><?php echo esc_html( dp_field( 'td_malaria_badge', 'RISK VARIES BY REGION' ) ); ?></span>
        </div>

        <h2 class="brazil-malaria-title"><?php echo esc_html( dp_field( 'td_malaria_title', 'Malaria Risk in Brazil' ) ); ?></h2>
        <p class="brazil-malaria-intro">
          <?php echo esc_html( dp_field( 'td_malaria_intro', 'Malaria risk exists in the Amazon region and some rural areas of Brazil. Major cities like Rio and Sao Paulo are generally malaria-free.' ) ); ?>
        </p>
...
<section class="brazil-health-section">
  <div class="section-container">
    <div class="brazil-health-header">
      ...
      <h2 class="brazil-health-title"><?php echo esc_html( dp_field( 'td_health_title', 'Stay healthy in Brazil' ) ); ?></h2>
      <p class="brazil-health-subtitle"><?php echo esc_html( dp_field( 'td_health_subtitle', 'Essential tips for a safe trip' ) ); ?></p>
    </div>
...
<section class="brazil-cta-section">
  ...
  <div class="section-container">
    <div class="brazil-cta-content">
      <h2 class="brazil-cta-title"><?php echo esc_html( dp_field( 'td_cta_title', 'Ready for your trip to Brazil?' ) ); ?></h2>
      <p class="brazil-cta-description">
        <?php
        $braz_cta_default = 'Book your Brazil travel health consultation at our ' . dp_option( 'pharmacy_town', 'Denton' ) . ' clinic. Get expert advice and all recommended vaccinations in one visit.';
        echo esc_html( dp_field( 'td_cta_description', $braz_cta_default ) );
        ?>
      </p>
      <div class="brazil-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'td_cta_primary_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta brazil-cta-button-white">
          <?php echo esc_html( dp_field( 'td_cta_primary_text', 'Book Brazil Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta brazil-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
      </div>
      <div class="brazil-cta-checks">
        ...
        <div class="brazil-cta-check">
          ...
          <span><?php echo esc_html( dp_field( 'td_cta_check_2', 'Expert Brazil Advice' ) ); ?></span>
        </div>
        <div class="brazil-cta-check">
