  ...
  <div class="section-container">
    <div class="brazil-cta-content">
      ...
      <p class="brazil-cta-description">
        <?php echo esc_html( dp_field( 'td_cta_description', 'Book your Brazil travel health consultation at our Denton clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
