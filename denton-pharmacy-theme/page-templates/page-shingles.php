...
$prefix = 'shingles';
$vaccine_name = dp_field('vaccine_name', 'Shingles');
?>
    ...
    <div class="shingles-hero-grid">
      ...
      <div class="shingles-hero-content">
        ...
        <h1 class="shingles-hero-title">
          <span class="gradient-text"><?php echo esc_html(dp_field('vaccine_hero_title_highlight', 'Shingles Vaccination')); ?></span>
        ...
        <div class="shingles-hero-actions">
          <a href="#booking-widget" onclick="scrollToBooking(); return false;" class="cta-button primary-cta">
            <?php echo esc_html(dp_field('vaccine_cta_text', 'Book Shingles Vaccination')); ?>
        ...
        <div class="shingles-trust-card">
          ...
          <div class="shingles-trust-card-inner">
            <div class="shingles-trust-card-header">
              ...
              <span class="shingles-trust-card-label"><?php echo esc_html(dp_field('vaccine_price_name', 'Shingrix Vaccine')); ?></span>
            </div>
...
<section class="shingles-protect-section">
  <div class="section-container">
    <div class="shingles-protect-header">
      ...
      <h2 class="shingles-protect-title"><?php echo esc_html(dp_field('vaccine_protect_title', 'The Shingles Vaccine')); ?></h2>
      <p class="shingles-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'Strong protection against a painful condition that becomes more likely with age')); ?></p>
    </div>
...
<section class="shingles-about-section">
  <div class="section-container">
    <div class="shingles-about-header">
      ...
      <h2 class="shingles-about-title"><?php echo esc_html(dp_field('vaccine_about_title', 'What is Shingles?')); ?></h2>
      <p class="shingles-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'A painful reactivation of the chickenpox virus')); ?></p>
    </div>
    ...
    <div class="shingles-about-callout">
      ...
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', 'Had Chickenpox? You Carry the Virus')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'Almost everyone who had chickenpox as a child carries the dormant virus and can develop shingles later in life. Vaccination with Shingrix dramatically reduces that risk and the chance of long-term nerve pain.')); ?></p>
    </div>
  </div>
</section>
...
<section class="shingles-needs-section">
  <div class="section-container">
    <div class="shingles-needs-header">
      ...
      <h2 class="shingles-needs-title"><?php echo esc_html(dp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="shingles-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Recommended for older adults and those at higher risk')); ?></p>
    </div>
...
<section class="shingles-pricing-section" id="pricing">
  <div class="section-container">
    <div class="shingles-pricing-header">
      ...
      <h2 class="shingles-pricing-title"><?php echo esc_html(dp_field('vaccine_pricing_title', 'Shingles Vaccination Pricing')); ?></h2>
      <p class="shingles-pricing-desc"><?php echo esc_html(dp_field('vaccine_pricing_desc', 'Clear pricing per dose — no hidden extras')); ?></p>
    </div>
...
<section class="shingles-details-section">
  <div class="section-container">
    <div class="shingles-details-header">
      ...
      <h2 class="shingles-details-title"><?php echo esc_html(dp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="shingles-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'A simple, friendly visit to our Denton clinic')); ?></p>
    </div>
...
<section class="shingles-faq-section">
  <div class="section-container">
    <div class="shingles-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_faq_badge', 'SHINGLES FAQs')); ?></span>
      </div>
      <h2 class="shingles-faq-title"><?php echo esc_html(dp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<?php
$acuity_url = dp_field( 'vaccine_acuity_url', 'https://app.acuityscheduling.com/schedule.php?owner=29286426&appointmentType=47536588&calendarID=10903457&ref=embedded_csp' );
?>
<section class="shingles-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="shingles-booking-header">
      <h2 class="shingles-booking-title"><?php echo esc_html(dp_field('vaccine_booking_title', 'Book Your Shingles Vaccination')); ?></h2>
      <p class="shingles-booking-desc"><?php echo esc_html(dp_field('vaccine_booking_desc', 'Choose a time that suits you at our Denton clinic')); ?></p>
    </div>

    <div class="shingles-booking-embed">
      <?php if ( $acuity_url ) : ?>
        <iframe src="<?php echo esc_url( $acuity_url ); ?>" title="Book your Shingles vaccination appointment in Denton" width="100%" height="800" frameborder="0" allow="payment"></iframe>
...
<section class="shingles-cta-section">
  ...
  <div class="section-container">
    <div class="shingles-cta-content">
      ...
      <h2 class="shingles-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect yourself against shingles')); ?></h2>
      <p class="shingles-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your shingles vaccination with our friendly team in Denton today. Quick, convenient and professional.')); ?></p>
