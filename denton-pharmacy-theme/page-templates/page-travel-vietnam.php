    ...
    <div class="vietnam-hero-grid">
      ...
      <div class="vietnam-hero-content">
        <div class="hero-badge">
          ...
          <span class="hero-badge-text"><?php echo esc_html( dp_field( 'td_hero_badge', 'VIETNAM TRAVEL HEALTH' ) ); ?></span>
        </div>

        <h1 class="hero-title" style="color: white;">
          <?php echo esc_html( dp_field( 'td_hero_title_line1', 'Travel Vaccinations for' ) ); ?><br />
          <span class="gradient-text" style="background: linear-gradient(135deg, #ffffff 0%, #e0e7ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo esc_html( dp_field( 'td_hero_title_highlight', 'Vietnam' ) ); ?></span>
        </h1>

        <p class="vietnam-hero-description">
          <?php echo esc_html( dp_field( 'td_hero_description', 'Expert advice and vaccinations for your Vietnam adventure. Japanese Encephalitis, Malaria prevention, and more.' ) ); ?>
        </p>

        <div class="vietnam-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'td_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta vietnam-hero-btn-primary">
            <?php echo esc_html( dp_field( 'td_hero_cta_text', 'Book Vietnam Consultation' ) ); ?>
            <i class="fas fa-arrow-right"></i>
          </a>
          <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta vietnam-hero-btn-secondary">
...
<section class="vietnam-vaccines-section">
  <div class="section-container">
    <div class="vietnam-vaccines-header">
      <h2 class="vietnam-vaccines-title"><?php echo esc_html( dp_field( 'td_vaccines_title', 'Protect yourself in Vietnam' ) ); ?></h2>
      <div class="vietnam-vaccines-divider"></div>
      <p class="vietnam-vaccines-description"><?php echo esc_html( dp_field( 'td_vaccines_description', 'These vaccinations are recommended for most travellers to Vietnam' ) ); ?></p>
    </div>
  ...
  <div class="section-container">
    <div class="vietnam-malaria-layout">
      ...
      <div class="vietnam-malaria-visual">
        <div class="vietnam-malaria-image-card">
          ...
          <div class="vietnam-malaria-badge">
            ...
            <span class="vietnam-malaria-badge-text"><?php echo esc_html( dp_field( 'td_malaria_badge_text', 'Expert Advice' ) ); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="vietnam-malaria-content">
        ...
        <h2 class="vietnam-malaria-title"><?php echo esc_html( dp_field( 'td_malaria_title', 'Malaria Risk in Vietnam' ) ); ?></h2>
        <p class="vietnam-malaria-intro">
          <?php echo esc_html( dp_field( 'td_malaria_intro', 'Malaria risk exists in rural and forested areas of Vietnam. Major cities and tourist resorts are generally low risk.' ) ); ?>
        </p>
...
<section class="vietnam-health-section">
  <div class="section-container">
    <div class="vietnam-health-header">
      ...
      <h2 class="vietnam-health-title"><?php echo esc_html( dp_field( 'td_health_title', 'Stay healthy in Vietnam' ) ); ?></h2>
      <p class="vietnam-health-subtitle"><?php echo esc_html( dp_field( 'td_health_subtitle', 'Essential tips for a safe adventure' ) ); ?></p>
    </div>
    ...
    <div class="vietnam-cta-content">
      ...
      <div class="vietnam-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'td_cta_primary_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta vietnam-cta-button-white">
          <?php echo esc_html( dp_field( 'td_cta_primary_text', 'Book Vietnam Consultation' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta vietnam-cta-button-outlined">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
      </div>
      <div class="vietnam-cta-checks">
        ...
        <div class="vietnam-cta-check">
          ...
          <span><?php echo esc_html( dp_field( 'td_cta_check_2', 'Expert Vietnam Advice' ) ); ?></span>
        </div>
        <div class="vietnam-cta-check">
