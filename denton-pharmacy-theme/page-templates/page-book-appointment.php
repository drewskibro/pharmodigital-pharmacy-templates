    ...
    <div class="book-hero-grid">
      ...
      <div class="book-hero-content">
        <div class="section-badge">
          ...
          <span class="section-badge-text"><?php echo esc_html(dp_field('book_hero_badge', 'ONLINE BOOKING AVAILABLE')); ?></span>
        </div>

        <h1 class="book-hero-title">
          <?php echo wp_kses_post(dp_field('book_hero_title', 'Book Your <br /><span class="gradient-text">Appointment</span>')); ?>
        </h1>

        <p class="book-hero-description">
          <?php echo esc_html(dp_field('book_hero_description', 'Choose your service below and find a time that suits you with our expert Denton team. Same-day appointments often available.')); ?>
        </p>

        <div class="book-hero-actions">
          <button onclick="scrollToBooking()" class="cta-button primary-cta">
            <?php echo esc_html(dp_field('book_hero_cta_text', 'Book Now')); ?>
      ...
      <div class="book-hero-visual">
        <div class="book-hero-image-card">
          <div class="book-hero-image-inner">
            <?php
            $hero_image_id = dp_field('book_hero_image');
            if ( ! $hero_image_id ) {
                $hero_image_id = dp_option('pharmacist_photo');
            }
            $hero_image_url = $hero_image_id ? wp_get_attachment_image_url($hero_image_id, 'large') : '';
            ?>
            <?php if ($hero_image_url) : ?>
              <img src="<?php echo esc_url($hero_image_url); ?>" alt="<?php echo esc_attr(dp_pharmacy_name()); ?> Pharmacist" class="book-hero-image" />
            <?php endif; ?>
  ...
  <div class="section-container">
    ...
    <div class="book-services-grid">
      <?php if (have_rows('book_priority_services')) : while (have_rows('book_priority_services')) : the_row();
        ...
        $button_label = get_sub_field('button_text') ?: 'Book Consultation';
      ?>
        <div class="book-service-card<?php echo $badge_text ? ' featured' : ''; ?>">
          ...
          <?php if ($button_url) : ?>
          <a href="<?php echo esc_url($button_url); ?>" class="cta-button primary-cta book-service-btn">
...
<section class="book-services-additional-section">
  <div class="section-container">
    <div class="book-services-header">
      <div class="section-badge">
        <span class="section-badge-text"><?php echo esc_html(dp_field('book_additional_badge', 'ESSENTIAL HEALTHCARE')); ?></span>
      </div>
      <h2 class="book-services-title"><?php echo esc_html(dp_field('book_additional_title', 'Everyday Health Services')); ?></h2>
    </div>
...
<section class="book-testimonials-section">
  <div class="section-container">
    <div class="book-testimonials-header">
      <h2 class="book-testimonials-title"><?php echo esc_html(dp_field('book_testimonials_title', 'What Our Patients Say')); ?></h2>
...
<section class="book-faq-section">
  <div class="section-container">
    <div class="book-faq-header">
      <div class="section-badge">
        <span class="section-badge-text"><?php echo esc_html(dp_field('book_faq_badge', 'EVERYTHING YOU NEED TO KNOW')); ?></span>
      </div>
      <h2 class="book-faq-title"><?php echo esc_html(dp_field('book_faq_title', 'Common Questions')); ?></h2>
      <p class="book-faq-description"><?php echo esc_html(dp_field('book_faq_description', 'Clear answers about our services, location, and team to help you book with confidence.')); ?></p>
    </div>
