  ...
  <div class="section-container">
    <div class="contact-form-header">
      <div class="section-badge">
        ...
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'contact_hero_badge', 'GET IN TOUCH' ) ); ?></span>
      </div>
      <h1 class="contact-form-title"><?php echo esc_html( dp_field( 'contact_hero_title_line1', 'Contact' ) ); ?> <span class="gradient-text"><?php echo esc_html( dp_field( 'contact_hero_title_highlight', dp_pharmacy_name() ) ); ?></span></h1>
      <p class="contact-form-subtitle"><?php echo esc_html( dp_field( 'contact_hero_description', 'Have a question about our services? Need to book an appointment or get advice? We\'re here to help. Reach out to our friendly team and we\'ll get back to you as soon as possible.' ) ); ?></p>
    </div>
    ...
    <div class="contact-form-grid">
      ...
      <div class="contact-form-wrapper">
        <form id="dp-contact-form" class="contact-form" novalidate>
          <?php wp_nonce_field( 'dp_contact_form_nonce', 'dp_contact_nonce' ); ?>
      ...
      <!-- Map — compact homepage-style map (pin + parking callouts + hours), no photo -->
  ...
  <div class="section-container">
    <div class="contact-cta-content">
      <div class="contact-cta-badges">
        <span class="contact-cta-badge"><?php echo esc_html( dp_field( 'contact_cta_badge_1', 'GPhC Registered' ) ); ?></span>
        <span class="contact-cta-badge"><?php echo esc_html( dp_field( 'contact_cta_badge_2', 'Same-Day Appointments' ) ); ?></span>
      ...
      <div class="contact-cta-actions">
        <a href="<?php echo esc_url( dp_field( 'contact_cta_url', $booking_url ) ); ?>" class="cta-button primary-cta contact-cta-button-white">
          <i class="fas fa-calendar-check"></i>
          <?php echo esc_html( dp_field( 'contact_cta_button_text', 'Book Consultation' ) ); ?>
        </a>
