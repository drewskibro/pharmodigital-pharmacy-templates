...
$prefix = 'corporate';
$vaccine_name = dp_field('vaccine_name', 'Corporate Vaccinations');
?>
    ...
    <div class="corporate-hero-grid">
      ...
      <div class="corporate-hero-content">
        <div class="section-badge">
          ...
          <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_hero_label', 'CORPORATE & WORKPLACE HEALTH')); ?></span>
        </div>

        <h1 class="corporate-hero-title">
          <span class="gradient-text"><?php echo esc_html(dp_field('vaccine_hero_title_highlight', 'Corporate Vaccinations')); ?></span>
          <?php echo esc_html(dp_field('vaccine_hero_title_rest', 'in Denton, Manchester')); ?>
        </h1>

        <p class="corporate-hero-description">
          <?php echo esc_html(dp_field('vaccine_hero_description', 'Workplace vaccination programmes for businesses across Denton and Greater Manchester. Tailored, flexible solutions for teams of any size — on-site at your workplace or here at our Denton clinic.')); ?>
        </p>

        <div class="corporate-hero-actions">
          <a href="#booking-widget" onclick="scrollToBooking(); return false;" class="cta-button primary-cta">
            <?php echo esc_html(dp_field('vaccine_cta_text', 'Request a Quote')); ?>
      ...
      <div class="corporate-hero-visual">
        <div class="corporate-hero-float-badge">
          <span class="corporate-hero-float-number"><?php echo esc_html(dp_field('vaccine_float_number', '50+')); ?></span>
          <span class="corporate-hero-float-label"><?php echo esc_html(dp_field('vaccine_float_label', 'vaccines available')); ?></span>
        </div>
        <div class="corporate-trust-card">
          ...
          <div class="corporate-trust-card-inner">
            <div class="corporate-trust-card-header">
              ...
              <span class="corporate-trust-card-label"><?php echo esc_html(dp_field('vaccine_price_name', 'Workplace Programmes')); ?></span>
            </div>
            <div class="corporate-trust-card-price">
              <span class="corporate-trust-card-amount corporate-trust-card-amount--text"><?php echo esc_html(dp_field('vaccine_price_amount', 'Bespoke')); ?></span>
              <span class="corporate-trust-card-sub"><?php echo esc_html(dp_field('vaccine_price_unit', 'contact us for a quote')); ?></span>
            </div>
...
<section class="corporate-protect-section">
  <div class="section-container">
    <div class="corporate-protect-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_protect_badge', 'WHY CHOOSE US')); ?></span>
      </div>
      <h2 class="corporate-protect-title"><?php echo esc_html(dp_field('vaccine_protect_title', 'Workplace Vaccination Made Simple')); ?></h2>
      <p class="corporate-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'Protect your team and reduce absenteeism, with minimal disruption')); ?></p>
    </div>
    ...
    <div class="corporate-protect-grid">
      <div class="corporate-protect-image-wrapper">
        <div class="corporate-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_protect_image_alt', 'A workplace team in Denton, Manchester')); ?>" class="corporate-protect-image" />
          <?php endif; ?>
          <div class="corporate-protect-name-tag">
            ...
            <span class="role"><?php echo esc_html(dp_field('vaccine_protect_nametag_role', 'Corporate Health Team')); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="corporate-protect-content">
        <div class="corporate-protect-badge-box">
          ...
          <span><?php echo esc_html(dp_field('vaccine_protect_highlight', 'Flexible Around Your Business')); ?></span>
        </div>

        <h3 class="corporate-protect-subtitle"><?php echo esc_html(dp_field('vaccine_protect_subtitle', 'Three Ways to Vaccinate Your Team')); ?></h3>
        <p class="corporate-protect-text"><?php echo esc_html(dp_field('vaccine_protect_text', 'Our GPhC-registered clinical team delivers tailored vaccination programmes for businesses of any size. We work around your operations to keep disruption to a minimum, and provide full record-keeping for HR and compliance.')); ?></p>
        ...
        <ul class="corporate-protect-features">
          ...
          <li class="corporate-protect-feature">
            ...
            <div class="text"><strong>At Our Clinic</strong><p>Employees attend our Denton pharmacy at flexible times — no on-site space needed.</p></div>
          </li>
          <li class="corporate-protect-feature">
...
<section class="corporate-about-section">
  <div class="section-container">
    <div class="corporate-about-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_about_badge', 'WHAT WE OFFER')); ?></span>
      </div>
      <h2 class="corporate-about-title"><?php echo esc_html(dp_field('vaccine_about_title', 'Vaccines & Services for Your Team')); ?></h2>
      <p class="corporate-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'From seasonal flu to travel health — all in one place')); ?></p>
    </div>
    ...
    <div class="corporate-about-content-grid">
      <div class="corporate-about-image-wrapper">
        <div class="corporate-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_about_image_alt', 'Business team — workplace vaccination programmes')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="corporate-about-callout">
      <div class="badge"><?php echo esc_html(dp_field('vaccine_callout_badge', 'THE BUSINESS CASE')); ?></div>
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', 'Fewer Sick Days, Healthier Teams')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'Preventive vaccination reduces absenteeism and keeps your business running smoothly. We offer transparent, upfront pricing with no hidden charges, plus full vaccination records for HR and compliance.')); ?></p>
    </div>
  </div>
</section>
...
<section class="corporate-needs-section">
  <div class="section-container">
    <div class="corporate-needs-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_needs_badge', 'HOW IT WORKS')); ?></span>
      </div>
      <h2 class="corporate-needs-title"><?php echo esc_html(dp_field('vaccine_needs_title', 'Choose how we deliver it')); ?></h2>
      <p class="corporate-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Two flexible options to suit your business')); ?></p>
    </div>
    ...
    <div class="corporate-needs-grid">
      ...
      <div class="nhs-card nhs-card-orange">
        ...
        <div class="nhs-card-content">
          ...
          <h3 class="nhs-card-title">At Our Denton Clinic</h3>
...
<section class="corporate-pricing-section" id="pricing">
  <div class="section-container">
    <div class="corporate-pricing-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_pricing_badge', 'PRICING')); ?></span>
      </div>
      <h2 class="corporate-pricing-title"><?php echo esc_html(dp_field('vaccine_pricing_title', 'Bespoke Pricing for Your Business')); ?></h2>
      <p class="corporate-pricing-desc"><?php echo esc_html(dp_field('vaccine_pricing_desc', 'Transparent, upfront quotes — no hidden charges')); ?></p>
    </div>

    <div class="corporate-pricing-grid">
      <div class="corporate-pricing-card featured">
        <div class="corporate-pricing-ribbon">Tailored</div>
        <h3 class="corporate-pricing-name"><?php echo esc_html(dp_field('vaccine_price_name', 'Corporate Programme')); ?></h3>
        <div class="corporate-pricing-amount">
          <span class="price corporate-pricing-amount--text"><?php echo esc_html(dp_field('vaccine_price_amount', 'Contact us for a quote')); ?></span>
        </div>
    ...
    <p class="corporate-pricing-note"><?php echo esc_html(dp_field('vaccine_price_note', 'Pricing is tailored to your team size, the vaccines needed and your preferred delivery method. Bulk discounts apply for 10+ employees. Contact us for a fast, no-obligation quote.')); ?></p>
  </div>
</section>
...
<section class="corporate-details-section">
  <div class="section-container">
    <div class="corporate-details-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_details_badge', 'SIMPLE PROCESS')); ?></span>
      </div>
      <h2 class="corporate-details-title"><?php echo esc_html(dp_field('vaccine_details_title', 'How it works')); ?></h2>
      <p class="corporate-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'From first call to fully vaccinated team')); ?></p>
    </div>
...
<section class="corporate-faq-section">
  <div class="section-container">
    <div class="corporate-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_faq_badge', 'CORPORATE FAQs')); ?></span>
      </div>
      <h2 class="corporate-faq-title"><?php echo esc_html(dp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>

    <div class="corporate-faq-list">
      <div class="corporate-faq-item"><button class="corporate-faq-btn" onclick="toggleFAQ(this)"><span class="num">01</span><span class="text">Do you come to our workplace?</span><i class="fas fa-plus icon"></i></button><div class="corporate-faq-content"><p>Yes. A qualified nurse can run an on-site clinic at your premises. Alternatively, your team can attend our Denton pharmacy at flexible times.</p></div></div>
...
<section class="corporate-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="corporate-booking-header">
      <h2 class="corporate-booking-title"><?php echo esc_html(dp_field('vaccine_booking_title', 'Request a Corporate Quote')); ?></h2>
      <p class="corporate-booking-desc"><?php echo esc_html(dp_field('vaccine_booking_desc', 'Tell us your team size, the vaccines you need and whether you\'d prefer on-site or in-clinic — we\'ll send a tailored, no-obligation quote.')); ?></p>
    </div>

    <div class="corporate-quote-box">
      <div class="corporate-quote-actions">
        <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>" class="cta-button primary-cta">
          <i class="fas fa-phone"></i> <?php echo esc_html(dp_field('vaccine_phone_display', 'Call 0161 336 2548')); ?>
        </a>
...
<section class="corporate-cta-section">
  ...
  <div class="section-container">
    <div class="corporate-cta-content">
      ...
      <h2 class="corporate-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect your workforce')); ?></h2>
      <p class="corporate-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Get a tailored quote for your workplace vaccination programme in Denton today. Flexible, professional and fully documented.')); ?></p>
