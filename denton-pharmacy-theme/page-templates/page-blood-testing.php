    ...
    <div class="bloodtest-hero-grid">
      ...
      <div class="bloodtest-hero-content">
        ...
        <div class="bloodtest-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'bt_hero_cta_url', '' ) ?: dp_booking_url() ); ?>" class="cta-button primary-cta">
        ...
        ?>
          <div class="bloodtest-process-card">
            ...
            <?php if ( ! empty( $step['link'] ) ) : ?>
              <a href="<?php echo esc_url( dp_booking_url() ); ?>" class="bloodtest-process-card-link">Book a slot <i class="fas fa-arrow-right"></i></a>
            <?php endif; ?>
          </div>
        <?php endforeach; ?>
      <?php endif; ?>
  ...
  <div class="section-container">
    <div class="bloodtest-cta-content">
      ...
      <div class="bloodtest-cta-actions">
        ...
        <a href="<?php echo esc_url( dp_field( 'bt_cta_primary_url', '' ) ?: dp_booking_url() ); ?>" class="cta-button secondary-cta bloodtest-cta-button-outline">
