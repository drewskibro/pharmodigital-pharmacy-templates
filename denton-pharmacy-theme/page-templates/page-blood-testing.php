    ...
    <div class="bloodtest-hero-grid">
      ...
      <div class="bloodtest-hero-content">
        <div class="section-badge">
          ...
          <span class="section-badge-text"><?php echo esc_html( dp_field( 'bt_hero_badge', 'PRIVATE BLOOD TESTING SERVICE' ) ); ?></span>
        </div>

        <h1 class="bloodtest-hero-title">
          <span class="gradient-text"><?php echo esc_html( dp_field( 'bt_hero_title_highlight', 'Private Blood Testing' ) ); ?></span>
          <?php echo esc_html( dp_field( 'bt_hero_title_rest', 'in Denton' ) ); ?>
        </h1>

        <p class="bloodtest-hero-description">
          <?php echo esc_html( dp_field( 'bt_hero_description', 'Comprehensive blood testing at Denton Pharmacy, Manchester. From general health checks to specific diagnostic panels — get fast, accurate results without a GP referral. Walk in or book your appointment today.' ) ); ?>
        </p>

        <div class="bloodtest-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'bt_hero_cta_url', '' ) ?: '#blood-testing-calendar' ); ?>" class="cta-button primary-cta">
            <?php echo esc_html( dp_field( 'bt_hero_cta_text', 'Book Blood Test' ) ); ?>
      ...
      <div class="bloodtest-hero-visual">
        ...
        <div class="bloodtest-hero-float-badge">
          <span class="bloodtest-hero-float-number"><?php echo esc_html( dp_field( 'bt_float_number', '20+' ) ); ?></span>
        ...
        <div class="bloodtest-trust-card">
          ...
          <div class="bloodtest-trust-card-inner">
            <div class="bloodtest-trust-card-header">
              ...
              <span class="bloodtest-trust-card-label"><?php echo esc_html( dp_field( 'bt_price_label', 'Private Blood Testing' ) ); ?></span>
            </div>
            <div class="bloodtest-trust-card-price">
              <span class="bloodtest-trust-card-amount"><?php echo esc_html( dp_field( 'bt_price_amount', 'FROM £39' ) ); ?></span>
              <span class="bloodtest-trust-card-sub"><?php echo esc_html( dp_field( 'bt_price_sub', 'per test panel' ) ); ?></span>
            </div>
            <div class="bloodtest-trust-card-divider"></div>
            <ul class="bloodtest-trust-card-list">
              <li><i class="fas fa-check"></i> <span><?php echo esc_html( dp_field( 'bt_trust_1', 'Fast Results' ) ); ?></span></li>
              <li><i class="fas fa-check"></i> <span><?php echo esc_html( dp_field( 'bt_trust_2', 'No GP Referral Needed' ) ); ?></span></li>
              <li><i class="fas fa-check"></i> <span><?php echo esc_html( dp_field( 'bt_trust_3', 'Professional Phlebotomy' ) ); ?></span></li>
            </ul>
      ...
      ?>
        ...
        <div class="bloodtest-stat-item">
          ...
          <div class="bloodtest-stat-content">
            <p class="bloodtest-stat-number"><?php echo esc_html( dp_field( $stat['number'], $stat['def_number'] ) ); ?></p>
            <p class="bloodtest-stat-label"><?php echo esc_html( dp_field( $stat['label'], $stat['def_label'] ) ); ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
  ...
  <div class="section-container">
    <div class="bt-featured-header">
      <div class="section-badge">
        ...
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'bt_mr_badge', 'MOST REQUESTED' ) ); ?></span>
      </div>
      <h2 class="bt-featured-title"><?php echo esc_html( dp_field( 'bt_mr_title', 'Most Requested Tests' ) ); ?></h2>
      <p class="bt-featured-description"><?php echo esc_html( dp_field( 'bt_mr_description', 'Our most popular blood test panels — book any of these directly below.' ) ); ?></p>
    </div>
...
<section class="bloodtest-tests-section">
  <div class="section-container">
    <div class="bloodtest-tests-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'bt_tests_badge', 'OUR BLOOD TESTS' ) ); ?></span>
      </div>
      <h2 class="bloodtest-tests-title"><?php echo esc_html( dp_field( 'bt_tests_title', 'Available Blood Test Panels' ) ); ?></h2>
...
<section class="bloodtest-process-section bloodtest-reveal">
  <div class="section-container">
    <div class="bloodtest-process-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'bt_process_badge', 'HOW IT WORKS' ) ); ?></span>
      </div>
      <h2 class="bloodtest-process-title"><?php echo esc_html( dp_field( 'bt_process_title', 'Three Simple Steps to Your Results' ) ); ?></h2>
      <p class="bloodtest-process-description"><?php echo esc_html( dp_field( 'bt_process_description', 'No GP referral needed — just walk in or book online' ) ); ?></p>
    </div>
    ...
    <div class="bloodtest-eligibility-box">
      ...
      <div class="bloodtest-eligibility-content">
        <h3 class="bloodtest-eligibility-title"><?php echo esc_html( dp_field( 'bt_eligibility_title', 'Who Is Blood Testing For?' ) ); ?></h3>
        <p class="bloodtest-eligibility-text"><?php echo esc_html( dp_field( 'bt_eligibility_text', 'Our blood testing service is available to anyone aged 18 and over. Whether you want a routine health check, need to monitor an existing condition, or want peace of mind — no GP referral is needed. Simply walk in or book online. If results require further investigation, our pharmacist can advise on next steps or refer you to your GP.' ) ); ?></p>
      </div>
    </div>
  </div>
</section>
...
<section class="bloodtest-faq-section bloodtest-reveal">
  <div class="section-container">
    <div class="bloodtest-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html( dp_field( 'bt_faq_badge', 'FREQUENTLY ASKED QUESTIONS' ) ); ?></span>
      </div>
      <h2 class="bloodtest-faq-title"><?php echo esc_html( dp_field( 'bt_faq_title', 'Blood Testing — Your Questions Answered' ) ); ?></h2>
    </div>
    ...
    <div class="bloodtest-cta-content">
      <div class="bloodtest-cta-badges">
        <div class="bloodtest-cta-badge">
          <span><?php echo esc_html( dp_field( 'bt_cta_badge_1', 'Professional Phlebotomy' ) ); ?></span>
        </div>
        <div class="bloodtest-cta-badge">
          <span><?php echo esc_html( dp_field( 'bt_cta_badge_2', 'Confidential Results' ) ); ?></span>
        </div>
        <div class="bloodtest-cta-badge">
          <span><?php echo esc_html( dp_field( 'bt_cta_badge_3', 'No Referral' ) ); ?></span>
        </div>
      </div>
      <h2 class="bloodtest-cta-title"><?php echo esc_html( dp_field( 'bt_cta_title', 'Book Your Blood Test in Denton Today' ) ); ?></h2>
      <p class="bloodtest-cta-description">
        <?php echo esc_html( dp_field( 'bt_cta_description', 'Take control of your health with fast, accurate blood testing at Denton Pharmacy. No GP referral needed — walk in or book your appointment.' ) ); ?>
      </p>
      <div class="bloodtest-cta-actions">
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button primary-cta bloodtest-cta-button-white">
          <i class="fas fa-phone"></i>
          Call <?php echo esc_html( dp_phone() ); ?>
        </a>
        <a href="<?php echo esc_url( dp_field( 'bt_cta_primary_url', '' ) ?: '#blood-testing-calendar' ); ?>" class="cta-button secondary-cta bloodtest-cta-button-outline">
          <?php echo esc_html( dp_field( 'bt_cta_button_text', 'Book Online' ) ); ?>
          <i class="fas fa-arrow-right"></i>
        </a>
      </div>
      <div class="bloodtest-cta-trust-checks">
        <span class="bloodtest-cta-check"><i class="fas fa-check"></i> <?php echo esc_html( dp_field( 'bt_cta_check_1', 'No referral needed' ) ); ?></span>
        <span class="bloodtest-cta-check"><i class="fas fa-check"></i> <?php echo esc_html( dp_field( 'bt_cta_check_2', 'Results in 2-5 days' ) ); ?></span>
        <span class="bloodtest-cta-check"><i class="fas fa-check"></i> <?php echo esc_html( dp_field( 'bt_cta_check_3', 'GPhC registered' ) ); ?></span>
      </div>
    </div>
  </div>
</section>
