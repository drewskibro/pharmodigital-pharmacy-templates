...
<!-- ============================================
     ...
     ============================================ -->
<?php
$wl_hero_mobile_bg_id = dp_field( 'wl_hero_mobile_image' );
if ( ! $wl_hero_mobile_bg_id ) {
    $wl_hero_mobile_bg_id = dp_field( 'wl_hero_image_1' );
}
    ...
    <div class="wl-hero-grid">
      ...
      <div class="wl-hero-content">
        ...
        <p class="wl-hero-description">
          <?php echo esc_html( dp_field( 'wl_hero_description', 'Prescription weight management with expert guidance and face-to-face support right here in Denton. No remote consultations — real care from someone who knows your name.' ) ); ?>
        </p>

        <div class="wl-hero-actions">
          <a href="<?php echo esc_url( dp_field( 'wl_hero_cta_url', '' ) ?: '#weight-loss-calendar' ); ?>" class="cta-button primary-cta">
    ...
    <div class="wl-stats-bar">
      ...
      <div class="wl-stat-item">
        ...
        <div class="wl-stat-content">
          <span class="wl-stat-number"><?php echo esc_html( dp_field( 'wl_stat_1_number', dp_option( 'google_rating', '4.9' ) ) ); ?></span>
      ...
      <div class="wl-stat-item">
        ...
        <div class="wl-stat-content">
          <span class="wl-stat-number"><?php echo esc_html( dp_field( 'wl_stat_2_number', dp_option( 'google_review_count', '140+' ) ) ); ?></span>
...
<section class="wl-results-section wl-reveal">
  <div class="section-container">
    <div class="wl-results-header">
      ...
      <h2 class="wl-results-title"><?php echo esc_html( dp_field( 'wl_results_title', 'Real results in Denton' ) ); ?></h2>
      <p class="wl-results-description"><?php echo esc_html( dp_field( 'wl_results_description', 'Denton patients get a personalised programme, monthly face-to-face reviews and support from their own pharmacist throughout.' ) ); ?></p>
    </div>
    ...
    <div class="wl-results-grid">
      ...
      <div class="wl-results-card wl-results-card-featured">
        ...
        <p class="wl-results-featured-number"><?php echo esc_html( dp_field( 'wl_results_featured_number', 'Monthly' ) ); ?></p>
        <p class="wl-results-featured-label"><?php echo esc_html( dp_field( 'wl_results_featured_label', 'Face-to-face reviews' ) ); ?></p>
        <p class="wl-results-featured-sublabel"><?php echo esc_html( dp_field( 'wl_results_featured_sublabel', 'With your own pharmacist' ) ); ?></p>
      </div>
...
<section class="wl-features-section wl-reveal">
  <div class="section-container">
    ...
    <div class="wl-features-bottom">
      <?php
      $wl_rating       = dp_option( 'google_rating', '4.9' );
      $wl_review_count = dp_option( 'google_review_count', '140+' );
      $wl_location     = dp_option( 'pharmacy_location_label', 'Denton' );
      $wl_reviews_url  = dp_option( 'google_review_url', '#' );
      ?>
      <div class="wl-features-rating-strip">
        ...
        <span class="wl-features-rating-meta"><?php echo esc_html( $wl_review_count ); ?> <?php echo esc_html( dp_field( 'wl_features_reviews_label', 'reviews' ) ); ?> · <?php echo esc_html( $wl_location ); ?></span>
        <a href="<?php echo esc_url( $wl_reviews_url ); ?>" class="wl-features-rating-link" target="_blank" rel="noopener"><?php echo esc_html( dp_field( 'wl_features_view_reviews_text', 'View Reviews' ) ); ?> <i class="fas fa-arrow-right"></i></a>
      </div>

      <div class="wl-features-actions">
        <a href="<?php echo esc_url( dp_field( 'wl_hero_cta_url', '' ) ?: '#weight-loss-calendar' ); ?>" class="cta-button primary-cta">
          <?php echo esc_html( dp_field( 'wl_features_cta_primary_text', 'Start Your Journey' ) ); ?> <i class="fas fa-arrow-right"></i>
        </a>
        <a href="tel:<?php echo esc_attr( dp_phone_link() ); ?>" class="cta-button secondary-cta">
          <i class="fas fa-phone"></i> <?php echo esc_html( dp_field( 'wl_features_cta_secondary_text', 'Call Us' ) ); ?>
        </a>
      </div>
      ...
      <div class="wl-features-credentials">
        ...
        ?>
          <div class="wl-features-credential"><i class="<?php echo esc_attr( dp_fa_class( $cred['cred_icon'] ) ); ?>"></i><span><?php echo esc_html( $cred['cred_text'] ); ?></span></div>
        <?php endforeach; ?>
      </div>
    </div>
  </div>
  ...
  <div class="section-container">
    ...
    $default_steps = array(
        ...
        array(
            ...
            'description' => 'If treatment is clinically suitable for you, your pharmacist will prescribe it and explain how to take it. You\'ll receive clear instructions and guidance on what to expect from your Denton weight loss programme.',
            'icon'        => 'fas fa-pills',
  ...
  <div class="section-container">
    ...
    <div class="wl-testimonials-header">
      ...
      <div class="wl-testimonials-disclaimer">
        <i class="fas fa-info-circle"></i>
        <p><strong><?php echo esc_html( dp_field( 'wl_testimonials_transparency_label', 'Transparency Note:' ) ); ?></strong> <?php echo esc_html( dp_field( 'wl_testimonials_disclaimer', 'The results below are from real Denton Pharmacy patients. Individual results may vary.' ) ); ?></p>
      </div>
    </div>
    ...
    $wl_default_testimonials = array(
        array(
            'name'      => 'Sarah M.',
            'service'   => 'Weight Loss',
            'weight'    => 'Long-term support',
            'quote'     => 'Thank you so much for your weight loss service. I\'ve tried <span class="wl-testimonial-highlight">everything over the years</span>. With your help, I\'ve finally managed to <span class="wl-testimonial-highlight">lose weight and keep it off</span>.',
            'checklist' => array( 'Face-to-Face Support', 'Monthly Reviews' ),
        ),
        array(
            'name'      => 'James K.',
            'service'   => 'Weight Loss',
            'weight'    => 'Monthly check-ins',
      ...
      ?>
        <div class="<?php echo esc_attr( $card_class ); ?>">
          ...
          <div class="wl-testimonial-verified">
            ...
            <span><?php echo esc_html( $is_large ? dp_field( 'wl_testimonials_verified_label', 'Verified Patient' ) : dp_field( 'wl_testimonials_verified_label_short', 'Verified' ) ); ?></span>
          </div>
          ...
          <div class="wl-testimonial-card-body">
            ...
            <div class="wl-testimonial-author-row">
              ...
              <div class="wl-testimonial-author-info">
                ...
                <p class="wl-testimonial-author-status"><?php echo esc_html( dp_field( 'wl_testimonials_verified_label', 'Verified Patient' ) ); ?></p>
              </div>
            </div>
      ...
      <div class="wl-testimonial-card wl-testimonial-card-cta">
        ...
        <div class="wl-testimonial-cta-body">
          <div class="wl-testimonial-cta-content">
            <h3 class="wl-testimonial-cta-title"><?php echo esc_html( dp_field( 'wl_testimonials_cta_title', 'Trusted by 1,000+ Denton Patients' ) ); ?></h3>
          ...
          <div class="wl-testimonial-cta-rating">
            <div class="wl-testimonial-cta-rating-card">
              <span class="wl-testimonial-cta-score"><?php echo esc_html( dp_option( 'google_rating', '4.9' ) ); ?></span>
              <div class="star-row star-row-small">
                <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
              </div>
              <span class="wl-testimonial-cta-label"><?php echo esc_html( dp_field( 'wl_testimonials_cta_rating_label', 'Google Rating' ) ); ?></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="wl-final-cta-content">
      <div class="wl-final-cta-badges">
        ...
        $wl_default_badges = array(
            ...
            array( 'badge_icon' => 'fa-users', 'badge_text' => dp_field( 'wl_results_card3_number', '1,000+' ) . ' Patients Helped' ),
        );
        $wl_cta_badges = array();
        ...
        ?>
          <div class="wl-final-cta-badge"><i class="<?php echo esc_attr( dp_fa_class( $badge['badge_icon'] ) ); ?>"></i><span><?php echo esc_html( $badge['badge_text'] ); ?></span></div>
        <?php endforeach; ?>
      </div>

      <h2 class="wl-final-cta-title"><?php echo esc_html( dp_field( 'wl_final_cta_title', 'Book your weight loss consultation' ) ); ?></h2>
      <p class="wl-final-cta-description"><?php echo esc_html( dp_field( 'wl_final_cta_description', 'Join 1,000+ patients who have transformed their lives with medical weight loss. Book your face-to-face consultation with our pharmacist today.' ) ); ?></p>

      <div class="wl-final-cta-actions">
        <a href="#weight-loss-calendar" class="cta-button primary-cta wl-final-cta-button-white">
          <?php echo esc_html( dp_field( 'wl_final_cta_button_text', 'Book Your Consultation' ) ); ?> <i class="fas fa-arrow-right"></i>
        </a>
...
<!-- N13. Booking Calendar (Acuity) -->
<section id="weight-loss-calendar" class="wl-booking-section wl-reveal">
  <div class="section-container">
