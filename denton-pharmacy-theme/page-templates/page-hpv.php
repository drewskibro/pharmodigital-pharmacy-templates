...
$prefix = 'hpv';
$vaccine_name = dp_field('vaccine_name', 'HPV');
?>
    ...
    <div class="hpv-hero-grid">
      ...
      <div class="hpv-hero-content">
        ...
        <h1 class="hpv-hero-title">
          <span class="gradient-text"><?php echo esc_html(dp_field('vaccine_hero_title_highlight', 'HPV Vaccination')); ?></span>
          <?php echo esc_html(dp_field('vaccine_hero_title_rest', 'in Denton, Manchester')); ?>
        </h1>

        <p class="hpv-hero-description">
          <?php echo esc_html(dp_field('vaccine_hero_description', 'Protect against HPV-related cancers with our private vaccination service in Denton, Manchester. Gardasil 9 guards against nine strains of the virus — for girls and boys, women and men aged 9 to 45.')); ?>
        </p>

        <div class="hpv-hero-actions">
          <a href="#booking-widget" onclick="scrollToBooking(); return false;" class="cta-button primary-cta">
            <?php echo esc_html(dp_field('vaccine_cta_text', 'Book HPV Vaccination')); ?>
      ...
      <div class="hpv-hero-visual">
        <div class="hpv-hero-float-badge">
          <span class="hpv-hero-float-number"><?php echo esc_html(dp_field('vaccine_float_number', '9')); ?></span>
          <span class="hpv-hero-float-label"><?php echo esc_html(dp_field('vaccine_float_label', 'strains covered')); ?></span>
        </div>
        <div class="hpv-trust-card">
          ...
          <div class="hpv-trust-card-inner">
            <div class="hpv-trust-card-header">
              ...
              <span class="hpv-trust-card-label"><?php echo esc_html(dp_field('vaccine_price_name', 'Gardasil 9 Vaccine')); ?></span>
            </div>
            <div class="hpv-trust-card-price">
              <span class="hpv-trust-card-amount hpv-trust-card-amount--text"><?php echo esc_html(dp_field('vaccine_price_amount', 'Contact us')); ?></span>
              <span class="hpv-trust-card-sub"><?php echo esc_html(dp_field('vaccine_price_unit', 'for current pricing')); ?></span>
            </div>
...
<section class="hpv-protect-section">
  <div class="section-container">
    <div class="hpv-protect-header">
      ...
      <h2 class="hpv-protect-title"><?php echo esc_html(dp_field('vaccine_protect_title', 'The HPV Vaccine')); ?></h2>
      <p class="hpv-protect-desc"><?php echo esc_html(dp_field('vaccine_protect_desc', 'Cancer protection that works best when given early')); ?></p>
    </div>
    ...
    <div class="hpv-protect-grid">
      <div class="hpv-protect-image-wrapper">
        <div class="hpv-protect-image-card">
          ...
          if ($protect_image_url) : ?>
            <img src="<?php echo esc_url($protect_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_protect_image_alt', 'HPV vaccination at our Denton clinic')); ?>" class="hpv-protect-image" />
          <?php endif; ?>
      ...
      <div class="hpv-protect-content">
        <div class="hpv-protect-badge-box">
          ...
          <span><?php echo esc_html(dp_field('vaccine_protect_highlight', 'Protects Against HPV-Related Cancers')); ?></span>
        </div>

        <h3 class="hpv-protect-subtitle"><?php echo esc_html(dp_field('vaccine_protect_subtitle', 'Gardasil 9 — Broad Protection')); ?></h3>
        <p class="hpv-protect-text"><?php echo esc_html(dp_field('vaccine_protect_text', 'HPV is a group of very common viruses. Some strains can cause cervical, genital and throat (oropharyngeal) cancers, as well as genital warts. The Gardasil 9 vaccine protects against nine strains and is most effective when given before any exposure — but it still offers benefits for those already sexually active.')); ?></p>
...
<section class="hpv-about-section">
  <div class="section-container">
    <div class="hpv-about-header">
      ...
      <h2 class="hpv-about-title"><?php echo esc_html(dp_field('vaccine_about_title', 'What is HPV?')); ?></h2>
      <p class="hpv-about-desc"><?php echo esc_html(dp_field('vaccine_about_desc', 'A very common virus with serious potential consequences')); ?></p>
    </div>
    ...
    <div class="hpv-about-content-grid">
      <div class="hpv-about-image-wrapper">
        <div class="hpv-about-image-card">
          ...
          if ($about_image_url) : ?>
            <img src="<?php echo esc_url($about_image_url); ?>" alt="<?php echo esc_attr(dp_field('vaccine_about_image_alt', 'Young adults — the HPV vaccine works best when given early')); ?>" />
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="hpv-about-callout">
      ...
      <h3><?php echo esc_html(dp_field('vaccine_callout_title', 'Vaccination Plus Screening')); ?></h3>
      <p><?php echo esc_html(dp_field('vaccine_callout_text', 'The HPV vaccine works best alongside regular cervical screening for women and safe-sex practices. Together they offer the strongest protection against HPV and the cancers it can cause.')); ?></p>
    </div>
  </div>
</section>
...
<section class="hpv-needs-section">
  <div class="section-container">
    <div class="hpv-needs-header">
      ...
      <h2 class="hpv-needs-title"><?php echo esc_html(dp_field('vaccine_needs_title', 'Should you get vaccinated?')); ?></h2>
      <p class="hpv-needs-desc"><?php echo esc_html(dp_field('vaccine_needs_desc', 'Recommended for young people, and beneficial up to 45')); ?></p>
    </div>
...
<section class="hpv-pricing-section" id="pricing">
  <div class="section-container">
    <div class="hpv-pricing-header">
      ...
      <h2 class="hpv-pricing-title"><?php echo esc_html(dp_field('vaccine_pricing_title', 'HPV Vaccination Pricing')); ?></h2>
      <p class="hpv-pricing-desc"><?php echo esc_html(dp_field('vaccine_pricing_desc', 'Cost depends on your age and number of doses')); ?></p>
    </div>

    <div class="hpv-pricing-grid">
      <div class="hpv-pricing-card featured">
        <div class="hpv-pricing-ribbon">Gardasil 9</div>
        <h3 class="hpv-pricing-name"><?php echo esc_html(dp_field('vaccine_price_name', 'HPV Vaccine')); ?></h3>
        <div class="hpv-pricing-amount">
          <span class="price hpv-pricing-amount--text"><?php echo esc_html(dp_field('vaccine_price_amount', 'Contact us')); ?></span>
          <span class="per"><?php echo esc_html(dp_field('vaccine_price_unit', 'for current pricing')); ?></span>
        </div>
        ...
        <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>" class="cta-button primary-cta">Call for Pricing</a>
      </div>
    </div>
...
<section class="hpv-details-section">
  <div class="section-container">
    <div class="hpv-details-header">
      ...
      <h2 class="hpv-details-title"><?php echo esc_html(dp_field('vaccine_details_title', 'What to expect at your appointment')); ?></h2>
      <p class="hpv-details-desc"><?php echo esc_html(dp_field('vaccine_details_desc', 'A quick, friendly visit to our Denton clinic')); ?></p>
    </div>
...
<section class="hpv-faq-section">
  <div class="section-container">
    <div class="hpv-faq-header">
      <div class="section-badge">
        <svg class="section-badge-icon" width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="section-badge-text"><?php echo esc_html(dp_field('vaccine_faq_badge', 'HPV FAQs')); ?></span>
      </div>
      <h2 class="hpv-faq-title"><?php echo esc_html(dp_field('vaccine_faq_title', 'Common Questions')); ?></h2>
    </div>
...
<!-- ============================================
     ...
     ============================================
     owner=29286426 · appointmentType=47536556 (HPV Vaccine) · calendarID=10903457 (Denton; Bowland 8436365)
     Override per-page via ACF field 'vaccine_acuity_url'. -->
<?php
$acuity_url = dp_field( 'vaccine_acuity_url', 'https://app.acuityscheduling.com/schedule.php?owner=29286426&appointmentType=47536556&calendarID=10903457&ref=embedded_csp' );
?>
<section class="hpv-booking-section" id="booking-widget">
  ...
  <div class="section-container">
    <div class="hpv-booking-header">
      <h2 class="hpv-booking-title"><?php echo esc_html(dp_field('vaccine_booking_title', 'Book Your HPV Vaccination')); ?></h2>
      <p class="hpv-booking-desc"><?php echo esc_html(dp_field('vaccine_booking_desc', 'Choose a time that suits you at our Denton clinic')); ?></p>
    </div>

    <div class="hpv-booking-embed">
      <?php if ( $acuity_url ) : ?>
        <iframe src="<?php echo esc_url( $acuity_url ); ?>" title="Book your HPV vaccination appointment in Denton" width="100%" height="800" frameborder="0" allow="payment"></iframe>
    ...
    <div class="hpv-booking-footer">
      <p>Questions about pricing or doses? Call us on <a href="tel:<?php echo esc_attr(dp_field('vaccine_phone', '01613362548')); ?>"><?php echo esc_html(dp_field('vaccine_phone_display', '0161 336 2548')); ?></a></p>
    </div>
  </div>
</section>
...
<section class="hpv-cta-section">
  ...
  <div class="section-container">
    <div class="hpv-cta-content">
      ...
      <h2 class="hpv-cta-title"><?php echo esc_html(dp_field('vaccine_cta_title', 'Protect against HPV-related cancers')); ?></h2>
      <p class="hpv-cta-desc"><?php echo esc_html(dp_field('vaccine_cta_desc', 'Book your HPV vaccination with our friendly team in Denton today. Quick, convenient and professional.')); ?></p>
