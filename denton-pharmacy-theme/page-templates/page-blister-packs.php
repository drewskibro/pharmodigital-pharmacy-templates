...
// --- Hero ---
$hero_badge         = dp_field( 'bp_hero_badge' );
$hero_title_accent  = dp_field( 'bp_hero_title_accent' );
$hero_title_rest    = dp_field( 'bp_hero_title_rest' );
$hero_description   = dp_field( 'bp_hero_description' );
$hero_cta_primary   = dp_field( 'bp_hero_cta_primary' );
$hero_cta_secondary = dp_field( 'bp_hero_cta_secondary' );
...
$card_label  = dp_field( 'bp_hero_card_label' );
$card_price  = dp_field( 'bp_hero_card_price' );
$card_sub    = dp_field( 'bp_hero_card_sub' );
$card_checks = array();
            ...
            <div class="bpack-hero-content">
                ...
                <div class="bpack-hero-trust">
                    ...
                    <div class="bpack-hero-trust-item">
                        <i class="<?php echo esc_attr( dp_fa_class( $pill['icon'] ?: 'fa-check-circle' ) ); ?>"></i>
...
<?php
// --- Eligibility Grid ---
$elig_badge = dp_field( 'bp_elig_badge' );
$elig_title = dp_field( 'bp_elig_title' );
$elig_desc  = dp_field( 'bp_elig_description' );
    ...
    <div class="section-container">
        ...
        <div class="bpack-conditions-grid">
            ...
            <div class="bpack-condition-card">
                <div class="bpack-condition-icon"><i class="<?php echo esc_attr( dp_fa_class( $item['icon'] ?: 'fa-check' ) ); ?>"></i></div>
...
<?php
// --- Process Steps ---
$proc_badge = dp_field( 'bp_process_badge' );
$proc_title = dp_field( 'bp_process_title' );
$proc_desc  = dp_field( 'bp_process_description' );
        ...
        <div class="bpack-process-steps">
            ...
            <div class="bpack-process-card">
                ...
                <div class="bpack-process-card-icon">
                    <i class="<?php echo esc_attr( dp_fa_class( $step['icon'] ?: 'fa-check' ) ); ?>"></i>
                </div>
...
<?php
// --- FAQ ---
$faq_badge = dp_field( 'bp_faq_badge' );
$faq_title = dp_field( 'bp_faq_title' );
...
<?php
// --- Final CTA ---
$cta_title       = dp_field( 'bp_cta_title' );
$cta_description = dp_field( 'bp_cta_description' );
$cta_primary     = dp_field( 'bp_cta_primary' );
$cta_secondary   = dp_field( 'bp_cta_secondary' );
