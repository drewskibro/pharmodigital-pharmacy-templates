    ...
    <div class="kenya-hero-grid">
      ...
      <div class="kenya-hero-content">
        ...
        <p class="kenya-hero-description">
          <?php echo esc_html( dp_field( 'ke_hero_description', 'Expert advice and vaccinations for your Kenya safari or holiday. Yellow Fever, Malaria, and more. Get protected with Denton\'s specialists.' ) ); ?>
        </p>
    ...
    <div class="kenya-malaria-layout">
      ...
      <div class="kenya-malaria-content">
        ...
        <div class="kenya-malaria-actions">
          <a href="<?php echo esc_url( dp_field( 'ke_hero_cta_url', dp_booking_url() ) ); ?>" class="cta-button primary-cta">
            Check Your Risk
            <i class="fas fa-arrow-right"></i>
          </a>
        </div>
  ...
  <div class="section-container">
    <div class="kenya-cta-content">
      ...
      <p class="kenya-cta-description">
        <?php echo esc_html( dp_field( 'ke_cta_description', 'Book your travel health consultation at our Denton clinic. Get expert advice and all recommended vaccinations in one visit.' ) ); ?>
      </p>
