 ...
 * ACF-overridable via dp_field where simple) so the page renders without
...
// --- Hero ---
$hero_badge        = dp_field( 'contra_hero_badge', 'NHS CONTRACEPTION SERVICE' );
$hero_title_accent = dp_field( 'contra_hero_title_accent', 'Contraception' );
$hero_title_rest   = dp_field( 'contra_hero_title_rest', 'from your local pharmacy' );
$hero_description  = dp_field( 'contra_hero_description', 'Start or continue your oral contraceptive pill directly with our pharmacist — no GP appointment needed. Free, confidential consultations at ' . dp_pharmacy_name() . '.' );
...
<section id="contraception-calendar" class="bpack-booking-section">
  <div class="section-container">
    <div class="bpack-booking-header">
      ...
      <p class="bpack-booking-subtitle">Choose a time below for a free, confidential consultation at <?php echo esc_html( dp_pharmacy_name() ); ?>.</p>
    </div>
    <div class="booking-calendar-wrapper">
      <iframe
        src="https://app.acuityscheduling.com/schedule.php?owner=29286426&amp;calendarID=10903457&amp;appointmentType[]=56219953&amp;appointmentType[]=58202762&amp;appointmentType[]=56219983&amp;ref=embedded_csp"
