...
define( 'DENTON_PHARMACY_ASSISTANT_URL', 'https://tlfyevjyogfinulsmljv.supabase.co/functions/v1/pharmacy_chat_widget_v4' );
define( 'DENTON_PHARMACY_ASSISTANT_VERSION', '3.0.0' );
define( 'DENTON_PHARMACY_ASSISTANT_SRI', 'sha384-gw//27s2rEJTjFkAS70WLtj8BnfoB1diovOf92E2Wl4dIcZBOofgotRJmrsibRLL' );
...
function denton_pharmacy_setup() {
    ...
    add_image_size( 'treatment-card', 800, 1000, true );
...
function denton_pharmacy_scripts() {
    ...
    if ( is_page_template( 'page-templates/page-team.php' ) ) {
        wp_enqueue_style( 'denton-team', DENTON_PHARMACY_URI . '/assets/css/team.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/team.css' ) );
    ...
    if ( is_page_template( array( 'page-templates/page-privacy-policy.php', 'page-templates/page-cookie-policy.php', 'page-templates/page-terms-conditions.php', 'page-templates/page-returns-policy.php' ) ) ) {
    ...
    if ( is_page_template( 'page-templates/page-nhs-prescriptions-register.php' ) ) {
        ...
        wp_localize_script( 'denton-npreg-js', 'dpNpregAjax', array(
            'ajaxurl' => admin_url( 'admin-ajax.php' ),
        ) );
    }
    ...
    if ( is_page_template( 'page-templates/page-chickenpox.php' ) ) {
        wp_enqueue_style( 'denton-chickenpox', DENTON_PHARMACY_URI . '/assets/css/chickenpox.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/chickenpox.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-chikungunya.php' ) ) {
        wp_enqueue_style( 'denton-chikungunya', DENTON_PHARMACY_URI . '/assets/css/chikungunya.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/chikungunya.css' ) );
        wp_enqueue_script( 'denton-chikungunya-js', DENTON_PHARMACY_URI . '/assets/js/chikungunya.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/chikungunya.js' ), true );
    }

    if ( is_page_template( 'page-templates/page-dengue.php' ) ) {
        wp_enqueue_style( 'denton-dengue', DENTON_PHARMACY_URI . '/assets/css/dengue.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/dengue.css' ) );
        wp_enqueue_script( 'denton-dengue-js', DENTON_PHARMACY_URI . '/assets/js/dengue.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/dengue.js' ), true );
    }

    if ( is_page_template( 'page-templates/page-dtp.php' ) ) {
        wp_enqueue_style( 'denton-dtp', DENTON_PHARMACY_URI . '/assets/css/dtp.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/dtp.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-hepatitisb.php' ) ) {
        wp_enqueue_style( 'denton-hepatitisb', DENTON_PHARMACY_URI . '/assets/css/hepatitisb.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/hepatitisb.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-malaria.php' ) ) {
        wp_enqueue_style( 'denton-malaria', DENTON_PHARMACY_URI . '/assets/css/malaria.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/malaria.css' ) );
        wp_enqueue_script( 'denton-malaria-js', DENTON_PHARMACY_URI . '/assets/js/malaria.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/malaria.js' ), true );
    }

    if ( is_page_template( 'page-templates/page-pneumonia.php' ) ) {
        wp_enqueue_style( 'denton-pneumonia', DENTON_PHARMACY_URI . '/assets/css/pneumonia.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/pneumonia.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-whoopingcough.php' ) ) {
        wp_enqueue_style( 'denton-whoopingcough', DENTON_PHARMACY_URI . '/assets/css/whoopingcough.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/whoopingcough.css' ) );
        wp_enqueue_script( 'denton-whoopingcough-js', DENTON_PHARMACY_URI . '/assets/js/whoopingcough.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/whoopingcough.js' ), true );
    }
    ...
    if ( is_page_template( 'page-templates/page-meningitis-b.php' ) ) {
        wp_enqueue_style( 'denton-meningitis-b', DENTON_PHARMACY_URI . '/assets/css/meningitis-b.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/meningitis-b.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-mmr.php' ) ) {
        wp_enqueue_style( 'denton-mmr', DENTON_PHARMACY_URI . '/assets/css/mmr.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/mmr.css' ) );
        wp_enqueue_script( 'denton-mmr-js', DENTON_PHARMACY_URI . '/assets/js/mmr.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/mmr.js' ), true );
    }

    if ( is_page_template( 'page-templates/page-hepatitis-b-occupational.php' ) ) {
        wp_enqueue_style( 'denton-hepb-occ', DENTON_PHARMACY_URI . '/assets/css/hepatitis-b-occupational.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/hepatitis-b-occupational.css' ) );
    ...
    if ( is_page_template( 'page-templates/page-corporate.php' ) ) {
        wp_enqueue_style( 'denton-corporate', DENTON_PHARMACY_URI . '/assets/css/corporate.css', array( 'denton-globals' ), filemtime( DENTON_PHARMACY_DIR . '/assets/css/corporate.css' ) );
        wp_enqueue_script( 'denton-corporate-js', DENTON_PHARMACY_URI . '/assets/js/corporate.js', array(), filemtime( DENTON_PHARMACY_DIR . '/assets/js/corporate.js' ), true );
    }
 ...
 *
 * Mirrors dp_contact_form_handler: nonce + honeypot, sanitises everything,
 ...
 */
function dp_npreg_form_handler() {
    if ( ! isset( $_POST['dp_npreg_nonce'] ) || ! wp_verify_nonce( $_POST['dp_npreg_nonce'], 'dp_npreg_form_nonce' ) ) {
        wp_send_json_error( array( 'message' => 'Security check failed. Please refresh the page and try again.' ) );
    }
    ...
    $to           = dp_option( 'pharmacy_email', 'info@dentonpharmacy.co.uk' );
    $subject_line = '[' . dp_pharmacy_name() . '] New NHS Prescription Registration from ' . $name;

    $body  = "New NHS prescription registration via " . home_url( '/nominate-denton-pharmacy/' ) . "\n";
    $body .= str_repeat( '=', 60 ) . "\n\n";
    ...
    if ( $sent ) {
        wp_send_json_success( array(
            'message' => 'Thank you for registering with ' . dp_pharmacy_name() . '. We will be in touch within 1 working day to confirm your registration.',
        ) );
    } else {
        wp_send_json_error( array(
            'message' => 'Sorry, there was an error sending your registration. Please call us on ' . dp_phone() . ' instead.',
        ) );
    }
}
add_action( 'wp_ajax_dp_npreg_form', 'dp_npreg_form_handler' );
add_action( 'wp_ajax_nopriv_dp_npreg_form', 'dp_npreg_form_handler' );
