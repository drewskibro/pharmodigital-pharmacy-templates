...
$badge_text        = dp_field( 'testimonials_badge_text', 'Real Transformations' );
$title_start       = dp_field( 'testimonials_title_start', 'Real Results.' );
                        ...
                        <?php if ( ! empty( $testimonial['highlights'] ) ) : ?>
                            ...
                            <div class="testimonial-highlights">
                                <?php foreach ( $testimonial['highlights'] as $highlight ) :
                                    $icon_class = dp_fa_class( $highlight['icon'] );
                                ?>
