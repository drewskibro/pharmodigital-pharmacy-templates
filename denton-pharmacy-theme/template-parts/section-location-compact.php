    ...
    <div class="location-map-wrapper location-compact-map">
        ...
        >
            <a
                ...
                href="<?php echo esc_url( $pharmacy_directions ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Get directions to <?php echo esc_attr( dp_pharmacy_name() ); ?> on Google Maps"
            >
